...
{% set override_docker_ver='1.12.3-0~jessie' %}
{% set override_deb='docker-engine_1.12.3-0~jessie_amd64.deb' %}
{% set override_deb_url='http://apt.dockerproject.org/repo/pool/main/d/docker-engine/docker-engine_1.12.3-0~jessie_amd64.deb' %}
{% set override_deb_sha1='7c7eb45542b67a9cfb33c292ba245710efb5d773' %}
