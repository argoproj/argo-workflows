...
func TestSwagger(t *testing.T) {
	...
	t.Run("io.argoproj.workflow.v1alpha1.CreateCronWorkflowRequest", func(t *testing.T) {
		require.Contains(t, definitions, "io.argoproj.workflow.v1alpha1.CreateCronWorkflowRequest")
	})
	t.Run("io.argoproj.workflow.v1alpha1.WorkflowCreateRequest", func(t *testing.T) {
		require.Contains(t, definitions, "io.argoproj.workflow.v1alpha1.WorkflowCreateRequest")
	})
	t.Run("io.argoproj.workflow.v1alpha1.ClusterWorkflowTemplateCreateRequest", func(t *testing.T) {
		require.Contains(t, definitions, "io.argoproj.workflow.v1alpha1.ClusterWorkflowTemplateCreateRequest")
	})
	t.Run("io.argoproj.workflow.v1alpha1.WorkflowTemplateCreateRequest", func(t *testing.T) {
		require.Contains(t, definitions, "io.argoproj.workflow.v1alpha1.WorkflowTemplateCreateRequest")
	})
	t.Run("io.argoproj.workflow.v1alpha1.InfoResponse", func(t *testing.T) {
		require.Contains(t, definitions, "io.argoproj.workflow.v1alpha1.InfoResponse")
	})
	t.Run("io.argoproj.workflow.v1alpha1.ScriptTemplate", func(t *testing.T) {
		...
		require.NotContains(t, definition["required"], "name")
	})
	t.Run("io.argoproj.workflow.v1alpha1.CronWorkflow", func(t *testing.T) {
		...
		require.NotContains(t, definition["required"], "status")
	})
	...
	t.Run("io.argoproj.workflow.v1alpha1.Parameter", func(t *testing.T) {
		...
		require.Equal(t, "string", properties["default"].(obj)["type"])
		require.Equal(t, "string", properties["value"].(obj)["type"])
	})
	t.Run("io.argoproj.workflow.v1alpha1.Histogram", func(t *testing.T) {
		...
		require.Equal(t, "array", buckets["type"])
		require.Equal(t, obj{"$ref": "#/definitions/io.argoproj.workflow.v1alpha1.Amount"}, buckets["items"])
	})
	...
	t.Run("io.argoproj.workflow.v1alpha1.Item", func(t *testing.T) {
		...
		require.Empty(t, definition["type"])
	})
	t.Run("io.argoproj.workflow.v1alpha1.ParallelSteps", func(t *testing.T) {
		...
		require.Equal(t, "array", definition["type"])
		require.Equal(t, obj{"$ref": "#/definitions/io.argoproj.workflow.v1alpha1.WorkflowStep"}, definition["items"])
	})
	...
	t.Run("io.k8s.api.core.v1.Volume", func(t *testing.T) {
		...
		properties := definition["properties"]
		require.Contains(t, properties, "name")
		require.NotContains(t, properties, "volumeSource")
	})
}
