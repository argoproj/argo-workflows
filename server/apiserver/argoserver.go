...
import (
	...
	clusterwftemplatepkg "github.com/argoproj/argo-server/v3/pkg/apiclient/clusterworkflowtemplate"
	...
	"github.com/argoproj/argo-server/v3/server/artifacts"
	"github.com/argoproj/argo-server/v3/server/auth"
	"github.com/argoproj/argo-server/v3/server/auth/sso"
	"github.com/argoproj/argo-server/v3/server/auth/webhook"
	"github.com/argoproj/argo-server/v3/server/clusterworkflowtemplate"
	"github.com/argoproj/argo-server/v3/server/cronworkflow"
	"github.com/argoproj/argo-server/v3/server/event"
	"github.com/argoproj/argo-server/v3/server/info"
	"github.com/argoproj/argo-server/v3/server/static"
	"github.com/argoproj/argo-server/v3/server/workflow"
	"github.com/argoproj/argo-server/v3/server/workflowarchive"
	"github.com/argoproj/argo-server/v3/server/workflowtemplate"
)
