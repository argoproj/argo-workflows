...
func (as *argoServer) newHTTPServer(ctx context.Context, port int, artifactServer *artifacts.ArtifactServer) *http.Server {
	...
	mux.HandleFunc("/artifact-descriptions/", artifactServer.GetArtifactDescription)
	mux.HandleFunc("/artifact-downloads/", artifactServer.DownloadArtifact)
	mux.HandleFunc("/artifacts/", artifactServer.DownloadArtifact)
	mux.HandleFunc("/input-artifacts/", artifactServer.DownloadArtifact)
	mux.HandleFunc("/artifacts-by-uid/", artifactServer.DownloadArtifact)
	mux.HandleFunc("/input-artifacts-by-uid/", artifactServer.DownloadArtifact)
