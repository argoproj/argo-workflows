...
func Test_archivedWorkflowServer(t *testing.T) {
	...
	repo.On("ListWorkflows", "", labels.Requirements(nil), 1, 0).Return(wfv1.Workflows{{}}, nil)
	repo.On("ListWorkflows", "", labels.Requirements(nil), 1, 1).Return(wfv1.Workflows{}, nil)
