...
func newSso(
	...
	lf := logging.Fields{"redirectUrl": config.RedirectURL, "issuer": c.Issuer, "issuerAlias": "DISABLED", "clientId": c.ClientID, "scopes": config.Scopes, "insecureSkipVerify": c.InsecureSkipVerify, "filterGroupsRegex": c.FilterGroupsRegex, "rootCA": c.RootCA, "pkceEnabled": c.EnablePKCEAuthentication}
	if c.IssuerAlias != "" {
	...
	return &sso{
		...
		pkceEnabled:       c.EnablePKCEAuthentication,
		logger:            logger,
	}, nil
}
