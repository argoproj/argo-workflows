...
func TestInterceptor(t *testing.T) {
	...
	t.Run("ExistingAuthorization", func(t *testing.T) {
		...
		require.Equal(t, []string{"existing"}, r.Header["Authorization"])
	})
	...
	t.Run("NoNamespace", func(t *testing.T) {
		...
		require.Equal(t, `{"message": "failed to process webhook request"}`, w.Body.String())
	})
	...
	t.Run("Bitbucket", func(t *testing.T) {
		...
		require.Equal(t, []string{"Bearer my-bitbucket-token"}, r.Header["Authorization"])
	})
	t.Run("Bitbucketserver", func(t *testing.T) {
		...
		require.Equal(t, []string{"Bearer my-bitbucketserver-token"}, r.Header["Authorization"])
	})
	t.Run("Github", func(t *testing.T) {
		...
		require.Equal(t, []string{"Bearer my-github-token"}, r.Header["Authorization"])
	})
	t.Run("Gitlab", func(t *testing.T) {
		...
		require.Equal(t, []string{"Bearer my-gitlab-token"}, r.Header["Authorization"])
	})
}
