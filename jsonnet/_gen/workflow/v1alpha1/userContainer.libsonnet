{
  ...
  '#':: d.pkg(name='userContainer', url='', help='UserContainer is a container specified by a user.'),
  ...
  '#withMirrorVolumeMounts':: d.fn(help='MirrorVolumeMounts will mount the same volumes specified in the main container to the container (including artifacts), at the same mountPaths. This enables dind daemon to partially see the same filesystem as the main container in order to use features such as docker volume binding', args=[d.arg(name='mirrorVolumeMounts', type=d.T.boolean)]),
  withMirrorVolumeMounts(mirrorVolumeMounts): { mirrorVolumeMounts: mirrorVolumeMounts },
