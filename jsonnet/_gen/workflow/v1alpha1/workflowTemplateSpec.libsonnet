{
  ...
  '#':: d.pkg(name='workflowTemplateSpec', url='', help='WorkflowTemplateSpec is a spec of WorkflowTemplate.'),
  ...
  podDisruptionBudget: {
    ...
    maxUnavailable: {
      ...
      withIntVal(intVal): { podDisruptionBudget+: { maxUnavailable+: { intVal: intVal } } },
      '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
      withStrVal(strVal): { podDisruptionBudget+: { maxUnavailable+: { strVal: strVal } } },
      '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { podDisruptionBudget+: { maxUnavailable+: { type: type } } },
    },
    '#minAvailable':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
    minAvailable: {
      '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
      withIntVal(intVal): { podDisruptionBudget+: { minAvailable+: { intVal: intVal } } },
      '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
      withStrVal(strVal): { podDisruptionBudget+: { minAvailable+: { strVal: strVal } } },
      '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
      withType(type): { podDisruptionBudget+: { minAvailable+: { type: type } } },
    },
    ...
    selector: {
      ...
      withMatchExpressions(matchExpressions): { podDisruptionBudget+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } },
      '#withMatchExpressionsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
      withMatchExpressionsMixin(matchExpressions): { podDisruptionBudget+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } },
      '#withMatchLabels':: d.fn(help='', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabels(matchLabels): { podDisruptionBudget+: { selector+: { matchLabels: matchLabels } } },
      '#withMatchLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
      withMatchLabelsMixin(matchLabels): { podDisruptionBudget+: { selector+: { matchLabels+: matchLabels } } },
    },
  },
  ...
  podGC: {
    ...
    withStrategy(strategy): { podGC+: { strategy: strategy } },
  },
  ...
  ttlStrategy: {
    ...
    withSecondsAfterCompletion(secondsAfterCompletion): { ttlStrategy+: { secondsAfterCompletion: secondsAfterCompletion } },
    ...
    withSecondsAfterFailure(secondsAfterFailure): { ttlStrategy+: { secondsAfterFailure: secondsAfterFailure } },
    ...
    withSecondsAfterSuccess(secondsAfterSuccess): { ttlStrategy+: { secondsAfterSuccess: secondsAfterSuccess } },
  },
  ...
  volumeClaimGC: {
    ...
    withStrategy(strategy): { volumeClaimGC+: { strategy: strategy } },
  },
  ...
  withPodPriority(podPriority): { podPriority: podPriority },
  ...
  withPodPriorityClassName(podPriorityClassName): { podPriorityClassName: podPriorityClassName },
  ...
  withShutdown(shutdown): { shutdown: shutdown },
  ...
  withTemplates(templates): { templates: if std.isArray(v=templates) then templates else [templates] },
  ...
  withTemplatesMixin(templates): { templates+: if std.isArray(v=templates) then templates else [templates] },
  ...
  workflowTemplateRef: {
    ...
    withClusterScope(clusterScope): { workflowTemplateRef+: { clusterScope: clusterScope } },
    '#withName':: d.fn(help='Name is the resource name of the workflow template.', args=[d.arg(name='name', type=d.T.string)]),
    withName(name): { workflowTemplateRef+: { name: name } },
  },
  '#mixin': 'ignore',
  mixin: self,
}
