{
  ...
  '#':: d.pkg(name='dagTask', url='', help='DAGTask represents a node in the graph during DAG execution'),
  ...
  '#withDependencies':: d.fn(help='Dependencies are name of other targets which this depends on', args=[d.arg(name='dependencies', type=d.T.array)]),
  withDependencies(dependencies): { dependencies: if std.isArray(v=dependencies) then dependencies else [dependencies] },
  '#withDependenciesMixin':: d.fn(help='Dependencies are name of other targets which this depends on\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='dependencies', type=d.T.array)]),
  withDependenciesMixin(dependencies): { dependencies+: if std.isArray(v=dependencies) then dependencies else [dependencies] },
  '#withDepends':: d.fn(help='Depends are name of other targets which this depends on', args=[d.arg(name='depends', type=d.T.string)]),
  withDepends(depends): { depends: depends },
  '#withName':: d.fn(help='Name is the name of the target', args=[d.arg(name='name', type=d.T.string)]),
  ...
  '#withTemplate':: d.fn(help='Name of template to execute', args=[d.arg(name='template', type=d.T.string)]),
  withTemplate(template): { template: template },
  '#withWhen':: d.fn(help='When is an expression in which the task should conditionally execute', args=[d.arg(name='when', type=d.T.string)]),
  withWhen(when): { when: when },
  '#withWithItems':: d.fn(help='WithItems expands a task into multiple parallel tasks from the items in the list', args=[d.arg(name='withItems', type=d.T.array)]),
  withWithItems(withItems): { withItems: if std.isArray(v=withItems) then withItems else [withItems] },
  '#withWithItemsMixin':: d.fn(help='WithItems expands a task into multiple parallel tasks from the items in the list\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='withItems', type=d.T.array)]),
  withWithItemsMixin(withItems): { withItems+: if std.isArray(v=withItems) then withItems else [withItems] },
  '#withWithParam':: d.fn(help='WithParam expands a task into multiple parallel tasks from the value in the parameter, which is expected to be a JSON list.', args=[d.arg(name='withParam', type=d.T.string)]),
