{
  ...
  workflowMetadata: {
    ...
    creationTimestamp: {
      ...
      withNanos(nanos): { workflowMetadata+: { creationTimestamp+: { nanos: nanos } } },
      ...
      withSeconds(seconds): { workflowMetadata+: { creationTimestamp+: { seconds: seconds } } },
    },
    '#deletionTimestamp':: d.obj(help='Time is a wrapper around time.Time which supports correct\nmarshaling to YAML and JSON.  Wrappers are provided for many\nof the factory methods that the time package offers.\n\n+protobuf.options.marshal=false\n+protobuf.as=Timestamp\n+protobuf.options.(gogoproto.goproto_stringer)=false'),
    deletionTimestamp: {
      '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
      withNanos(nanos): { workflowMetadata+: { deletionTimestamp+: { nanos: nanos } } },
      '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
      withSeconds(seconds): { workflowMetadata+: { deletionTimestamp+: { seconds: seconds } } },
    },
  ...
  workflowSpec: {
    ...
    podDisruptionBudget: {
      ...
      maxUnavailable: {
        ...
        withIntVal(intVal): { workflowSpec+: { podDisruptionBudget+: { maxUnavailable+: { intVal: intVal } } } },
        '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
        withStrVal(strVal): { workflowSpec+: { podDisruptionBudget+: { maxUnavailable+: { strVal: strVal } } } },
        '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { workflowSpec+: { podDisruptionBudget+: { maxUnavailable+: { type: type } } } },
      },
      '#minAvailable':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
      minAvailable: {
        '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
        withIntVal(intVal): { workflowSpec+: { podDisruptionBudget+: { minAvailable+: { intVal: intVal } } } },
        '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
        withStrVal(strVal): { workflowSpec+: { podDisruptionBudget+: { minAvailable+: { strVal: strVal } } } },
        '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { workflowSpec+: { podDisruptionBudget+: { minAvailable+: { type: type } } } },
      },
    ...
    retryStrategy: {
      ...
      backoff: {
        ...
        factor: {
          '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
          withIntVal(intVal): { workflowSpec+: { retryStrategy+: { backoff+: { factor+: { intVal: intVal } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { workflowSpec+: { retryStrategy+: { backoff+: { factor+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { workflowSpec+: { retryStrategy+: { backoff+: { factor+: { type: type } } } } },
        },
      ...
      limit: {
        '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
        withIntVal(intVal): { workflowSpec+: { retryStrategy+: { limit+: { intVal: intVal } } } },
        '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
        withStrVal(strVal): { workflowSpec+: { retryStrategy+: { limit+: { strVal: strVal } } } },
        '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
        withType(type): { workflowSpec+: { retryStrategy+: { limit+: { type: type } } } },
      },
      ...
      semaphore: {
        ...
        configMapKeyRef: {
          ...
          localObjectReference: {
            '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
            withName(name): { workflowSpec+: { synchronization+: { semaphore+: { configMapKeyRef+: { localObjectReference+: { name: name } } } } } },
          },
    ...
    withTtlSecondsAfterFinished(ttlSecondsAfterFinished): { workflowSpec+: { ttlSecondsAfterFinished: ttlSecondsAfterFinished } },
