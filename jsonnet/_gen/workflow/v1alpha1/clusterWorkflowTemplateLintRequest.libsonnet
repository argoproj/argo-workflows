{
  ...
  '#':: d.pkg(name='clusterWorkflowTemplateLintRequest', url='', help=''),
  ...
  '#template':: d.obj(help='ClusterWorkflowTemplate is the definition of a workflow template resource in cluster scope'),
  template: {
    ...
    metadata: {
      ...
      creationTimestamp: {
        ...
        withNanos(nanos): { template+: { metadata+: { creationTimestamp+: { nanos: nanos } } } },
        ...
        withSeconds(seconds): { template+: { metadata+: { creationTimestamp+: { seconds: seconds } } } },
      },
      '#deletionTimestamp':: d.obj(help='Time is a wrapper around time.Time which supports correct\nmarshaling to YAML and JSON.  Wrappers are provided for many\nof the factory methods that the time package offers.\n\n+protobuf.options.marshal=false\n+protobuf.as=Timestamp\n+protobuf.options.(gogoproto.goproto_stringer)=false'),
      deletionTimestamp: {
        '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
        withNanos(nanos): { template+: { metadata+: { deletionTimestamp+: { nanos: nanos } } } },
        '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
        withSeconds(seconds): { template+: { metadata+: { deletionTimestamp+: { seconds: seconds } } } },
      },
    ...
    spec: {
      ...
      arguments: {
        ...
        withArtifacts(artifacts): { template+: { spec+: { arguments+: { artifacts: if std.isArray(v=artifacts) then artifacts else [artifacts] } } } },
        ...
        withArtifactsMixin(artifacts): { template+: { spec+: { arguments+: { artifacts+: if std.isArray(v=artifacts) then artifacts else [artifacts] } } } },
        ...
        withParameters(parameters): { template+: { spec+: { arguments+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } } },
        ...
        withParametersMixin(parameters): { template+: { spec+: { arguments+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } } },
      },
      ...
      artifactRepositoryRef: {
        ...
        withConfigMap(configMap): { template+: { spec+: { artifactRepositoryRef+: { configMap: configMap } } } },
        ...
        withKey(key): { template+: { spec+: { artifactRepositoryRef+: { key: key } } } },
      },
      ...
      executor: {
        ...
        withServiceAccountName(serviceAccountName): { template+: { spec+: { executor+: { serviceAccountName: serviceAccountName } } } },
      },
      ...
      metrics: {
        ...
        withPrometheus(prometheus): { template+: { spec+: { metrics+: { prometheus: if std.isArray(v=prometheus) then prometheus else [prometheus] } } } },
        ...
        withPrometheusMixin(prometheus): { template+: { spec+: { metrics+: { prometheus+: if std.isArray(v=prometheus) then prometheus else [prometheus] } } } },
      },
      ...
      podDisruptionBudget: {
        ...
        maxUnavailable: {
          ...
          withIntVal(intVal): { template+: { spec+: { podDisruptionBudget+: { maxUnavailable+: { intVal: intVal } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { template+: { spec+: { podDisruptionBudget+: { maxUnavailable+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { template+: { spec+: { podDisruptionBudget+: { maxUnavailable+: { type: type } } } } },
        },
        '#minAvailable':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
        minAvailable: {
          '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
          withIntVal(intVal): { template+: { spec+: { podDisruptionBudget+: { minAvailable+: { intVal: intVal } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { template+: { spec+: { podDisruptionBudget+: { minAvailable+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { template+: { spec+: { podDisruptionBudget+: { minAvailable+: { type: type } } } } },
        },
        ...
        selector: {
          ...
          withMatchExpressions(matchExpressions): { template+: { spec+: { podDisruptionBudget+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } },
          '#withMatchExpressionsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
          withMatchExpressionsMixin(matchExpressions): { template+: { spec+: { podDisruptionBudget+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } },
          '#withMatchLabels':: d.fn(help='', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { template+: { spec+: { podDisruptionBudget+: { selector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { template+: { spec+: { podDisruptionBudget+: { selector+: { matchLabels+: matchLabels } } } } },
        },
      },
      ...
      podGC: {
        ...
        withStrategy(strategy): { template+: { spec+: { podGC+: { strategy: strategy } } } },
      },
      ...
      retryStrategy: {
        ...
        backoff: {
          ...
          factor: {
            '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
            withIntVal(intVal): { template+: { spec+: { retryStrategy+: { backoff+: { factor+: { intVal: intVal } } } } } },
            '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
            withStrVal(strVal): { template+: { spec+: { retryStrategy+: { backoff+: { factor+: { strVal: strVal } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { template+: { spec+: { retryStrategy+: { backoff+: { factor+: { type: type } } } } } },
          },
          ...
          withDuration(duration): { template+: { spec+: { retryStrategy+: { backoff+: { duration: duration } } } } },
          ...
          withMaxDuration(maxDuration): { template+: { spec+: { retryStrategy+: { backoff+: { maxDuration: maxDuration } } } } },
        },
        '#limit':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
        limit: {
          '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
          withIntVal(intVal): { template+: { spec+: { retryStrategy+: { limit+: { intVal: intVal } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { template+: { spec+: { retryStrategy+: { limit+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { template+: { spec+: { retryStrategy+: { limit+: { type: type } } } } },
        },
        ...
        withRetryPolicy(retryPolicy): { template+: { spec+: { retryStrategy+: { retryPolicy: retryPolicy } } } },
      },
      ...
      synchronization: {
        ...
        mutex: {
          ...
          withName(name): { template+: { spec+: { synchronization+: { mutex+: { name: name } } } } },
        },
        ...
        semaphore: {
          ...
          configMapKeyRef: {
            ...
            localObjectReference: {
              '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { template+: { spec+: { synchronization+: { semaphore+: { configMapKeyRef+: { localObjectReference+: { name: name } } } } } } },
            },
            '#withKey':: d.fn(help='The key to select.', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { template+: { spec+: { synchronization+: { semaphore+: { configMapKeyRef+: { key: key } } } } } },
            '#withOptional':: d.fn(help='', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { template+: { spec+: { synchronization+: { semaphore+: { configMapKeyRef+: { optional: optional } } } } } },
          },
        },
      },
      ...
      ttlStrategy: {
        ...
        withSecondsAfterCompletion(secondsAfterCompletion): { template+: { spec+: { ttlStrategy+: { secondsAfterCompletion: secondsAfterCompletion } } } },
        ...
        withSecondsAfterFailure(secondsAfterFailure): { template+: { spec+: { ttlStrategy+: { secondsAfterFailure: secondsAfterFailure } } } },
        ...
        withSecondsAfterSuccess(secondsAfterSuccess): { template+: { spec+: { ttlStrategy+: { secondsAfterSuccess: secondsAfterSuccess } } } },
      },
      ...
      volumeClaimGC: {
        ...
        withStrategy(strategy): { template+: { spec+: { volumeClaimGC+: { strategy: strategy } } } },
      },
      ...
      withEntrypoint(entrypoint): { template+: { spec+: { entrypoint: entrypoint } } },
      ...
      withOnExit(onExit): { template+: { spec+: { onExit: onExit } } },
      ...
      withParallelism(parallelism): { template+: { spec+: { parallelism: parallelism } } },
      '#withPodPriority':: d.fn(help='Priority to apply to workflow pods.', args=[d.arg(name='podPriority', type=d.T.integer)]),
      withPodPriority(podPriority): { template+: { spec+: { podPriority: podPriority } } },
      ...
      withPodPriorityClassName(podPriorityClassName): { template+: { spec+: { podPriorityClassName: podPriorityClassName } } },
      ...
      withPodSpecPatch(podSpecPatch): { template+: { spec+: { podSpecPatch: podSpecPatch } } },
      ...
      withShutdown(shutdown): { template+: { spec+: { shutdown: shutdown } } },
      ...
      withSuspend(suspend): { template+: { spec+: { suspend: suspend } } },
      ...
      withTemplates(templates): { template+: { spec+: { templates: if std.isArray(v=templates) then templates else [templates] } } },
      ...
      withTemplatesMixin(templates): { template+: { spec+: { templates+: if std.isArray(v=templates) then templates else [templates] } } },
      ...
      withTtlSecondsAfterFinished(ttlSecondsAfterFinished): { template+: { spec+: { ttlSecondsAfterFinished: ttlSecondsAfterFinished } } },
      ...
      withVolumeClaimTemplates(volumeClaimTemplates): { template+: { spec+: { volumeClaimTemplates: if std.isArray(v=volumeClaimTemplates) then volumeClaimTemplates else [volumeClaimTemplates] } } },
      ...
      withVolumeClaimTemplatesMixin(volumeClaimTemplates): { template+: { spec+: { volumeClaimTemplates+: if std.isArray(v=volumeClaimTemplates) then volumeClaimTemplates else [volumeClaimTemplates] } } },
      ...
      workflowMetadata: {
        ...
        creationTimestamp: {
          '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
          withNanos(nanos): { template+: { spec+: { workflowMetadata+: { creationTimestamp+: { nanos: nanos } } } } },
          '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
          withSeconds(seconds): { template+: { spec+: { workflowMetadata+: { creationTimestamp+: { seconds: seconds } } } } },
        },
        '#deletionTimestamp':: d.obj(help='Time is a wrapper around time.Time which supports correct\nmarshaling to YAML and JSON.  Wrappers are provided for many\nof the factory methods that the time package offers.\n\n+protobuf.options.marshal=false\n+protobuf.as=Timestamp\n+protobuf.options.(gogoproto.goproto_stringer)=false'),
        deletionTimestamp: {
          '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
          withNanos(nanos): { template+: { spec+: { workflowMetadata+: { deletionTimestamp+: { nanos: nanos } } } } },
          '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
          withSeconds(seconds): { template+: { spec+: { workflowMetadata+: { deletionTimestamp+: { seconds: seconds } } } } },
        },
        '#withAnnotations':: d.fn(help='', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotations(annotations): { template+: { spec+: { workflowMetadata+: { annotations: annotations } } } },
        '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotationsMixin(annotations): { template+: { spec+: { workflowMetadata+: { annotations+: annotations } } } },
        '#withClusterName':: d.fn(help='', args=[d.arg(name='clusterName', type=d.T.string)]),
        withClusterName(clusterName): { template+: { spec+: { workflowMetadata+: { clusterName: clusterName } } } },
        '#withDeletionGracePeriodSeconds':: d.fn(help='', args=[d.arg(name='deletionGracePeriodSeconds', type=d.T.string)]),
        withDeletionGracePeriodSeconds(deletionGracePeriodSeconds): { template+: { spec+: { workflowMetadata+: { deletionGracePeriodSeconds: deletionGracePeriodSeconds } } } },
        '#withFinalizers':: d.fn(help='', args=[d.arg(name='finalizers', type=d.T.array)]),
        withFinalizers(finalizers): { template+: { spec+: { workflowMetadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } } },
        '#withFinalizersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
        withFinalizersMixin(finalizers): { template+: { spec+: { workflowMetadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } } },
        '#withGenerateName':: d.fn(help='GenerateName is an optional prefix, used by the server, to generate a unique\nname ONLY IF the Name field has not been provided.\nIf this field is used, the name returned to the client will be different\nthan the name passed. This value will also be combined with a unique suffix.\nThe provided value has the same validation rules as the Name field,\nand may be truncated by the length of the suffix required to make the value\nunique on the server.\n\nIf this field is specified and the generated name exists, the server will\nNOT return a 409 - instead, it will either return 201 Created or 500 with Reason\nServerTimeout indicating a unique name could not be found in the time allotted, and the client\nshould retry (optionally after the time indicated in the Retry-After header).\n\nApplied only if Name is not specified.\nMore info: https://git.io.k8s.community/contributors/devel/sig-architecture/api-conventions.md#idempotency\n+optional', args=[d.arg(name='generateName', type=d.T.string)]),
        withGenerateName(generateName): { template+: { spec+: { workflowMetadata+: { generateName: generateName } } } },
        '#withGeneration':: d.fn(help='', args=[d.arg(name='generation', type=d.T.string)]),
        withGeneration(generation): { template+: { spec+: { workflowMetadata+: { generation: generation } } } },
        '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
        withLabels(labels): { template+: { spec+: { workflowMetadata+: { labels: labels } } } },
        '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
        withLabelsMixin(labels): { template+: { spec+: { workflowMetadata+: { labels+: labels } } } },
        '#withManagedFields':: d.fn(help="ManagedFields maps workflow-id and version to the set of fields\nthat are managed by that io.argoproj.workflow.v1alpha1. This is mostly for internal\nhousekeeping, and users typically shouldn't need to set or\nunderstand this field. A workflow can be the user's name, a\ncontroller's name, or the name of a specific apply path like\n'ci-cd'. The set of fields is always in the version that the\nworkflow used when modifying the object.\n\n+optional", args=[d.arg(name='managedFields', type=d.T.array)]),
        withManagedFields(managedFields): { template+: { spec+: { workflowMetadata+: { managedFields: if std.isArray(v=managedFields) then managedFields else [managedFields] } } } },
        '#withManagedFieldsMixin':: d.fn(help="ManagedFields maps workflow-id and version to the set of fields\nthat are managed by that io.argoproj.workflow.v1alpha1. This is mostly for internal\nhousekeeping, and users typically shouldn't need to set or\nunderstand this field. A workflow can be the user's name, a\ncontroller's name, or the name of a specific apply path like\n'ci-cd'. The set of fields is always in the version that the\nworkflow used when modifying the object.\n\n+optional\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='managedFields', type=d.T.array)]),
        withManagedFieldsMixin(managedFields): { template+: { spec+: { workflowMetadata+: { managedFields+: if std.isArray(v=managedFields) then managedFields else [managedFields] } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { spec+: { workflowMetadata+: { name: name } } } },
        '#withNamespace':: d.fn(help='Namespace defines the space within each name must be unique. An empty namespace is\nequivalent to the "default" namespace, but "default" is the canonical representation.\nNot all objects are required to be scoped to a namespace - the value of this field for\nthose objects will be empty.\n\nMust be a DNS_LABEL.\nCannot be updated.\nMore info: http://kubernetes.io/docs/user-guide/namespaces\n+optional', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { template+: { spec+: { workflowMetadata+: { namespace: namespace } } } },
        '#withOwnerReferences':: d.fn(help='', args=[d.arg(name='ownerReferences', type=d.T.array)]),
        withOwnerReferences(ownerReferences): { template+: { spec+: { workflowMetadata+: { ownerReferences: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } } },
        '#withOwnerReferencesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ownerReferences', type=d.T.array)]),
        withOwnerReferencesMixin(ownerReferences): { template+: { spec+: { workflowMetadata+: { ownerReferences+: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } } },
        '#withResourceVersion':: d.fn(help='An opaque value that represents the internal version of this object that can\nbe used by clients to determine when objects have changed. May be used for optimistic\nconcurrency, change detection, and the watch operation on a resource or set of resources.\nClients must treat these values as opaque and passed unmodified back to the server.\nThey may only be valid for a particular resource or set of resources.\n\nPopulated by the system.\nRead-only.\nValue must be treated as opaque by clients and .\nMore info: https://git.io.k8s.community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency\n+optional', args=[d.arg(name='resourceVersion', type=d.T.string)]),
        withResourceVersion(resourceVersion): { template+: { spec+: { workflowMetadata+: { resourceVersion: resourceVersion } } } },
        '#withSelfLink':: d.fn(help='SelfLink is a URL representing this object.\nPopulated by the system.\nRead-only.\n\nDEPRECATED\nKubernetes will stop propagating this field in 1.20 release and the field is planned\nto be removed in 1.21 release.\n+optional', args=[d.arg(name='selfLink', type=d.T.string)]),
        withSelfLink(selfLink): { template+: { spec+: { workflowMetadata+: { selfLink: selfLink } } } },
        '#withUid':: d.fn(help='UID is the unique in time and space value for this object. It is typically generated by\nthe server on successful creation of a resource and is not allowed to change on PUT\noperations.\n\nPopulated by the system.\nRead-only.\nMore info: http://kubernetes.io/docs/user-guide/identifiers#uids\n+optional', args=[d.arg(name='uid', type=d.T.string)]),
        withUid(uid): { template+: { spec+: { workflowMetadata+: { uid: uid } } } },
      },
      ...
      workflowTemplateRef: {
        ...
        withClusterScope(clusterScope): { template+: { spec+: { workflowTemplateRef+: { clusterScope: clusterScope } } } },
        '#withName':: d.fn(help='Name is the resource name of the workflow template.', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { template+: { spec+: { workflowTemplateRef+: { name: name } } } },
      },
    },
