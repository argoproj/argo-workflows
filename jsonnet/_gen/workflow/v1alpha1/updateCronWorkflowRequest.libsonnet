{
  ...
  '#':: d.pkg(name='updateCronWorkflowRequest', url='', help=''),
  '#cronWorkflow':: d.obj(help='CronWorkflow is the definition of a scheduled workflow resource'),
  cronWorkflow: {
    ...
    metadata: {
      ...
      creationTimestamp: {
        ...
        withNanos(nanos): { cronWorkflow+: { metadata+: { creationTimestamp+: { nanos: nanos } } } },
        ...
        withSeconds(seconds): { cronWorkflow+: { metadata+: { creationTimestamp+: { seconds: seconds } } } },
      },
      '#deletionTimestamp':: d.obj(help='Time is a wrapper around time.Time which supports correct\nmarshaling to YAML and JSON.  Wrappers are provided for many\nof the factory methods that the time package offers.\n\n+protobuf.options.marshal=false\n+protobuf.as=Timestamp\n+protobuf.options.(gogoproto.goproto_stringer)=false'),
      deletionTimestamp: {
        '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
        withNanos(nanos): { cronWorkflow+: { metadata+: { deletionTimestamp+: { nanos: nanos } } } },
        '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
        withSeconds(seconds): { cronWorkflow+: { metadata+: { deletionTimestamp+: { seconds: seconds } } } },
      },
      '#withAnnotations':: d.fn(help='', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotations(annotations): { cronWorkflow+: { metadata+: { annotations: annotations } } },
      '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotationsMixin(annotations): { cronWorkflow+: { metadata+: { annotations+: annotations } } },
      '#withClusterName':: d.fn(help='', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { cronWorkflow+: { metadata+: { clusterName: clusterName } } },
      '#withDeletionGracePeriodSeconds':: d.fn(help='', args=[d.arg(name='deletionGracePeriodSeconds', type=d.T.string)]),
      withDeletionGracePeriodSeconds(deletionGracePeriodSeconds): { cronWorkflow+: { metadata+: { deletionGracePeriodSeconds: deletionGracePeriodSeconds } } },
      '#withFinalizers':: d.fn(help='', args=[d.arg(name='finalizers', type=d.T.array)]),
      withFinalizers(finalizers): { cronWorkflow+: { metadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      '#withFinalizersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
      withFinalizersMixin(finalizers): { cronWorkflow+: { metadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      ...
      withGenerateName(generateName): { cronWorkflow+: { metadata+: { generateName: generateName } } },
      '#withGeneration':: d.fn(help='', args=[d.arg(name='generation', type=d.T.string)]),
      withGeneration(generation): { cronWorkflow+: { metadata+: { generation: generation } } },
      '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { cronWorkflow+: { metadata+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { cronWorkflow+: { metadata+: { labels+: labels } } },
      ...
      withManagedFields(managedFields): { cronWorkflow+: { metadata+: { managedFields: if std.isArray(v=managedFields) then managedFields else [managedFields] } } },
      '#withManagedFieldsMixin':: d.fn(help="ManagedFields maps workflow-id and version to the set of fields\nthat are managed by that io.argoproj.workflow.v1alpha1. This is mostly for internal\nhousekeeping, and users typically shouldn't need to set or\nunderstand this field. A workflow can be the user's name, a\ncontroller's name, or the name of a specific apply path like\n'ci-cd'. The set of fields is always in the version that the\nworkflow used when modifying the object.\n\n+optional\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='managedFields', type=d.T.array)]),
      withManagedFieldsMixin(managedFields): { cronWorkflow+: { metadata+: { managedFields+: if std.isArray(v=managedFields) then managedFields else [managedFields] } } },
      '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { cronWorkflow+: { metadata+: { name: name } } },
      ...
      withNamespace(namespace): { cronWorkflow+: { metadata+: { namespace: namespace } } },
      '#withOwnerReferences':: d.fn(help='', args=[d.arg(name='ownerReferences', type=d.T.array)]),
      withOwnerReferences(ownerReferences): { cronWorkflow+: { metadata+: { ownerReferences: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } },
      '#withOwnerReferencesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ownerReferences', type=d.T.array)]),
      withOwnerReferencesMixin(ownerReferences): { cronWorkflow+: { metadata+: { ownerReferences+: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } },
      ...
      withResourceVersion(resourceVersion): { cronWorkflow+: { metadata+: { resourceVersion: resourceVersion } } },
      ...
      withSelfLink(selfLink): { cronWorkflow+: { metadata+: { selfLink: selfLink } } },
      ...
      withUid(uid): { cronWorkflow+: { metadata+: { uid: uid } } },
    },
    '#spec':: d.obj(help='CronWorkflowSpec is the specification of a CronWorkflow'),
    spec: {
      ...
      withConcurrencyPolicy(concurrencyPolicy): { cronWorkflow+: { spec+: { concurrencyPolicy: concurrencyPolicy } } },
      ...
      withFailedJobsHistoryLimit(failedJobsHistoryLimit): { cronWorkflow+: { spec+: { failedJobsHistoryLimit: failedJobsHistoryLimit } } },
      ...
      withSchedule(schedule): { cronWorkflow+: { spec+: { schedule: schedule } } },
      ...
      withStartingDeadlineSeconds(startingDeadlineSeconds): { cronWorkflow+: { spec+: { startingDeadlineSeconds: startingDeadlineSeconds } } },
      ...
      withSuccessfulJobsHistoryLimit(successfulJobsHistoryLimit): { cronWorkflow+: { spec+: { successfulJobsHistoryLimit: successfulJobsHistoryLimit } } },
      ...
      withSuspend(suspend): { cronWorkflow+: { spec+: { suspend: suspend } } },
      ...
      withTimezone(timezone): { cronWorkflow+: { spec+: { timezone: timezone } } },
      '#workflowMetadata':: d.obj(help='ObjectMeta is metadata that all persisted resources must have, which includes all objects\nusers must create.'),
      workflowMetadata: {
        '#creationTimestamp':: d.obj(help='Time is a wrapper around time.Time which supports correct\nmarshaling to YAML and JSON.  Wrappers are provided for many\nof the factory methods that the time package offers.\n\n+protobuf.options.marshal=false\n+protobuf.as=Timestamp\n+protobuf.options.(gogoproto.goproto_stringer)=false'),
        creationTimestamp: {
          '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
          withNanos(nanos): { cronWorkflow+: { spec+: { workflowMetadata+: { creationTimestamp+: { nanos: nanos } } } } },
          '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
          withSeconds(seconds): { cronWorkflow+: { spec+: { workflowMetadata+: { creationTimestamp+: { seconds: seconds } } } } },
        },
        '#deletionTimestamp':: d.obj(help='Time is a wrapper around time.Time which supports correct\nmarshaling to YAML and JSON.  Wrappers are provided for many\nof the factory methods that the time package offers.\n\n+protobuf.options.marshal=false\n+protobuf.as=Timestamp\n+protobuf.options.(gogoproto.goproto_stringer)=false'),
        deletionTimestamp: {
          '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
          withNanos(nanos): { cronWorkflow+: { spec+: { workflowMetadata+: { deletionTimestamp+: { nanos: nanos } } } } },
          '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
          withSeconds(seconds): { cronWorkflow+: { spec+: { workflowMetadata+: { deletionTimestamp+: { seconds: seconds } } } } },
        },
        '#withAnnotations':: d.fn(help='', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotations(annotations): { cronWorkflow+: { spec+: { workflowMetadata+: { annotations: annotations } } } },
        '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
        withAnnotationsMixin(annotations): { cronWorkflow+: { spec+: { workflowMetadata+: { annotations+: annotations } } } },
        '#withClusterName':: d.fn(help='', args=[d.arg(name='clusterName', type=d.T.string)]),
        withClusterName(clusterName): { cronWorkflow+: { spec+: { workflowMetadata+: { clusterName: clusterName } } } },
        '#withDeletionGracePeriodSeconds':: d.fn(help='', args=[d.arg(name='deletionGracePeriodSeconds', type=d.T.string)]),
        withDeletionGracePeriodSeconds(deletionGracePeriodSeconds): { cronWorkflow+: { spec+: { workflowMetadata+: { deletionGracePeriodSeconds: deletionGracePeriodSeconds } } } },
        '#withFinalizers':: d.fn(help='', args=[d.arg(name='finalizers', type=d.T.array)]),
        withFinalizers(finalizers): { cronWorkflow+: { spec+: { workflowMetadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } } },
        '#withFinalizersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
        withFinalizersMixin(finalizers): { cronWorkflow+: { spec+: { workflowMetadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } } },
        '#withGenerateName':: d.fn(help='GenerateName is an optional prefix, used by the server, to generate a unique\nname ONLY IF the Name field has not been provided.\nIf this field is used, the name returned to the client will be different\nthan the name passed. This value will also be combined with a unique suffix.\nThe provided value has the same validation rules as the Name field,\nand may be truncated by the length of the suffix required to make the value\nunique on the server.\n\nIf this field is specified and the generated name exists, the server will\nNOT return a 409 - instead, it will either return 201 Created or 500 with Reason\nServerTimeout indicating a unique name could not be found in the time allotted, and the client\nshould retry (optionally after the time indicated in the Retry-After header).\n\nApplied only if Name is not specified.\nMore info: https://git.io.k8s.community/contributors/devel/sig-architecture/api-conventions.md#idempotency\n+optional', args=[d.arg(name='generateName', type=d.T.string)]),
        withGenerateName(generateName): { cronWorkflow+: { spec+: { workflowMetadata+: { generateName: generateName } } } },
        '#withGeneration':: d.fn(help='', args=[d.arg(name='generation', type=d.T.string)]),
        withGeneration(generation): { cronWorkflow+: { spec+: { workflowMetadata+: { generation: generation } } } },
        '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
        withLabels(labels): { cronWorkflow+: { spec+: { workflowMetadata+: { labels: labels } } } },
        '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
        withLabelsMixin(labels): { cronWorkflow+: { spec+: { workflowMetadata+: { labels+: labels } } } },
        '#withManagedFields':: d.fn(help="ManagedFields maps workflow-id and version to the set of fields\nthat are managed by that io.argoproj.workflow.v1alpha1. This is mostly for internal\nhousekeeping, and users typically shouldn't need to set or\nunderstand this field. A workflow can be the user's name, a\ncontroller's name, or the name of a specific apply path like\n'ci-cd'. The set of fields is always in the version that the\nworkflow used when modifying the object.\n\n+optional", args=[d.arg(name='managedFields', type=d.T.array)]),
        withManagedFields(managedFields): { cronWorkflow+: { spec+: { workflowMetadata+: { managedFields: if std.isArray(v=managedFields) then managedFields else [managedFields] } } } },
        '#withManagedFieldsMixin':: d.fn(help="ManagedFields maps workflow-id and version to the set of fields\nthat are managed by that io.argoproj.workflow.v1alpha1. This is mostly for internal\nhousekeeping, and users typically shouldn't need to set or\nunderstand this field. A workflow can be the user's name, a\ncontroller's name, or the name of a specific apply path like\n'ci-cd'. The set of fields is always in the version that the\nworkflow used when modifying the object.\n\n+optional\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='managedFields', type=d.T.array)]),
        withManagedFieldsMixin(managedFields): { cronWorkflow+: { spec+: { workflowMetadata+: { managedFields+: if std.isArray(v=managedFields) then managedFields else [managedFields] } } } },
        '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { cronWorkflow+: { spec+: { workflowMetadata+: { name: name } } } },
        '#withNamespace':: d.fn(help='Namespace defines the space within each name must be unique. An empty namespace is\nequivalent to the "default" namespace, but "default" is the canonical representation.\nNot all objects are required to be scoped to a namespace - the value of this field for\nthose objects will be empty.\n\nMust be a DNS_LABEL.\nCannot be updated.\nMore info: http://kubernetes.io/docs/user-guide/namespaces\n+optional', args=[d.arg(name='namespace', type=d.T.string)]),
        withNamespace(namespace): { cronWorkflow+: { spec+: { workflowMetadata+: { namespace: namespace } } } },
        '#withOwnerReferences':: d.fn(help='', args=[d.arg(name='ownerReferences', type=d.T.array)]),
        withOwnerReferences(ownerReferences): { cronWorkflow+: { spec+: { workflowMetadata+: { ownerReferences: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } } },
        '#withOwnerReferencesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ownerReferences', type=d.T.array)]),
        withOwnerReferencesMixin(ownerReferences): { cronWorkflow+: { spec+: { workflowMetadata+: { ownerReferences+: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } } },
        '#withResourceVersion':: d.fn(help='An opaque value that represents the internal version of this object that can\nbe used by clients to determine when objects have changed. May be used for optimistic\nconcurrency, change detection, and the watch operation on a resource or set of resources.\nClients must treat these values as opaque and passed unmodified back to the server.\nThey may only be valid for a particular resource or set of resources.\n\nPopulated by the system.\nRead-only.\nValue must be treated as opaque by clients and .\nMore info: https://git.io.k8s.community/contributors/devel/sig-architecture/api-conventions.md#concurrency-control-and-consistency\n+optional', args=[d.arg(name='resourceVersion', type=d.T.string)]),
        withResourceVersion(resourceVersion): { cronWorkflow+: { spec+: { workflowMetadata+: { resourceVersion: resourceVersion } } } },
        '#withSelfLink':: d.fn(help='SelfLink is a URL representing this object.\nPopulated by the system.\nRead-only.\n\nDEPRECATED\nKubernetes will stop propagating this field in 1.20 release and the field is planned\nto be removed in 1.21 release.\n+optional', args=[d.arg(name='selfLink', type=d.T.string)]),
        withSelfLink(selfLink): { cronWorkflow+: { spec+: { workflowMetadata+: { selfLink: selfLink } } } },
        '#withUid':: d.fn(help='UID is the unique in time and space value for this object. It is typically generated by\nthe server on successful creation of a resource and is not allowed to change on PUT\noperations.\n\nPopulated by the system.\nRead-only.\nMore info: http://kubernetes.io/docs/user-guide/identifiers#uids\n+optional', args=[d.arg(name='uid', type=d.T.string)]),
        withUid(uid): { cronWorkflow+: { spec+: { workflowMetadata+: { uid: uid } } } },
      },
      ...
      workflowSpec: {
        ...
        affinity: {
          ...
          nodeAffinity: {
            ...
            requiredDuringSchedulingIgnoredDuringExecution: {
              ...
              withNodeSelectorTerms(nodeSelectorTerms): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
              ...
              withNodeSelectorTermsMixin(nodeSelectorTerms): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } } },
            },
            ...
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          '#podAffinity':: d.obj(help='Pod affinity is a group of inter pod affinity scheduling rules.'),
          podAffinity: {
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            ...
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
          '#podAntiAffinity':: d.obj(help='Pod anti affinity is a group of inter pod anti affinity scheduling rules.'),
          podAntiAffinity: {
            '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
            '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
            withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { cronWorkflow+: { spec+: { workflowSpec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } } },
          },
        },
        ...
        arguments: {
          ...
          withArtifacts(artifacts): { cronWorkflow+: { spec+: { workflowSpec+: { arguments+: { artifacts: if std.isArray(v=artifacts) then artifacts else [artifacts] } } } } },
          ...
          withArtifactsMixin(artifacts): { cronWorkflow+: { spec+: { workflowSpec+: { arguments+: { artifacts+: if std.isArray(v=artifacts) then artifacts else [artifacts] } } } } },
          ...
          withParameters(parameters): { cronWorkflow+: { spec+: { workflowSpec+: { arguments+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } } } },
          ...
          withParametersMixin(parameters): { cronWorkflow+: { spec+: { workflowSpec+: { arguments+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } } } },
        },
        ...
        artifactRepositoryRef: {
          ...
          withConfigMap(configMap): { cronWorkflow+: { spec+: { workflowSpec+: { artifactRepositoryRef+: { configMap: configMap } } } } },
          ...
          withKey(key): { cronWorkflow+: { spec+: { workflowSpec+: { artifactRepositoryRef+: { key: key } } } } },
        },
        ...
        dnsConfig: {
          ...
          withNameservers(nameservers): { cronWorkflow+: { spec+: { workflowSpec+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          ...
          withNameserversMixin(nameservers): { cronWorkflow+: { spec+: { workflowSpec+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } } },
          '#withOptions':: d.fn(help='', args=[d.arg(name='options', type=d.T.array)]),
          withOptions(options): { cronWorkflow+: { spec+: { workflowSpec+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } } },
          ...
          withOptionsMixin(options): { cronWorkflow+: { spec+: { workflowSpec+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } } },
          '#withSearches':: d.fn(help='', args=[d.arg(name='searches', type=d.T.array)]),
          withSearches(searches): { cronWorkflow+: { spec+: { workflowSpec+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } } },
          ...
          withSearchesMixin(searches): { cronWorkflow+: { spec+: { workflowSpec+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } } },
        },
        ...
        executor: {
          ...
          withServiceAccountName(serviceAccountName): { cronWorkflow+: { spec+: { workflowSpec+: { executor+: { serviceAccountName: serviceAccountName } } } } },
        },
        ...
        metrics: {
          ...
          withPrometheus(prometheus): { cronWorkflow+: { spec+: { workflowSpec+: { metrics+: { prometheus: if std.isArray(v=prometheus) then prometheus else [prometheus] } } } } },
          ...
          withPrometheusMixin(prometheus): { cronWorkflow+: { spec+: { workflowSpec+: { metrics+: { prometheus+: if std.isArray(v=prometheus) then prometheus else [prometheus] } } } } },
        },
        ...
        podDisruptionBudget: {
          ...
          maxUnavailable: {
            ...
            withIntVal(intVal): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { maxUnavailable+: { intVal: intVal } } } } } },
            '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
            withStrVal(strVal): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { maxUnavailable+: { strVal: strVal } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { maxUnavailable+: { type: type } } } } } },
          },
          '#minAvailable':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
          minAvailable: {
            '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
            withIntVal(intVal): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { minAvailable+: { intVal: intVal } } } } } },
            '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
            withStrVal(strVal): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { minAvailable+: { strVal: strVal } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { minAvailable+: { type: type } } } } } },
          },
          ...
          selector: {
            ...
            withMatchExpressions(matchExpressions): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } },
            '#withMatchExpressionsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
            withMatchExpressionsMixin(matchExpressions): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } } },
            '#withMatchLabels':: d.fn(help='', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabels(matchLabels): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { selector+: { matchLabels: matchLabels } } } } } },
            '#withMatchLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
            withMatchLabelsMixin(matchLabels): { cronWorkflow+: { spec+: { workflowSpec+: { podDisruptionBudget+: { selector+: { matchLabels+: matchLabels } } } } } },
          },
        },
        ...
        podGC: {
          ...
          withStrategy(strategy): { cronWorkflow+: { spec+: { workflowSpec+: { podGC+: { strategy: strategy } } } } },
        },
        ...
        retryStrategy: {
          ...
          backoff: {
            ...
            factor: {
              '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
              withIntVal(intVal): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { backoff+: { factor+: { intVal: intVal } } } } } } },
              '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
              withStrVal(strVal): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { backoff+: { factor+: { strVal: strVal } } } } } } },
              '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
              withType(type): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { backoff+: { factor+: { type: type } } } } } } },
            },
            ...
            withDuration(duration): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { backoff+: { duration: duration } } } } } },
            ...
            withMaxDuration(maxDuration): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { backoff+: { maxDuration: maxDuration } } } } } },
          },
          '#limit':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
          limit: {
            '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
            withIntVal(intVal): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { limit+: { intVal: intVal } } } } } },
            '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
            withStrVal(strVal): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { limit+: { strVal: strVal } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { limit+: { type: type } } } } } },
          },
          ...
          withRetryPolicy(retryPolicy): { cronWorkflow+: { spec+: { workflowSpec+: { retryStrategy+: { retryPolicy: retryPolicy } } } } },
        },
        ...
        securityContext: {
          ...
          seLinuxOptions: {
            ...
            withLevel(level): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { seLinuxOptions+: { level: level } } } } } },
            '#withRole':: d.fn(help='', args=[d.arg(name='role', type=d.T.string)]),
            withRole(role): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { seLinuxOptions+: { role: role } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { seLinuxOptions+: { type: type } } } } } },
            '#withUser':: d.fn(help='', args=[d.arg(name='user', type=d.T.string)]),
            withUser(user): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { seLinuxOptions+: { user: user } } } } } },
          },
          ...
          windowsOptions: {
            ...
            withGmsaCredentialSpec(gmsaCredentialSpec): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } } },
            '#withGmsaCredentialSpecName':: d.fn(help='', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
            withGmsaCredentialSpecName(gmsaCredentialSpecName): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } } },
            '#withRunAsUserName':: d.fn(help='', args=[d.arg(name='runAsUserName', type=d.T.string)]),
            withRunAsUserName(runAsUserName): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } } },
          },
          ...
          withFsGroup(fsGroup): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { fsGroup: fsGroup } } } } },
          '#withRunAsGroup':: d.fn(help='', args=[d.arg(name='runAsGroup', type=d.T.string)]),
          withRunAsGroup(runAsGroup): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { runAsGroup: runAsGroup } } } } },
          '#withRunAsNonRoot':: d.fn(help='', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
          withRunAsNonRoot(runAsNonRoot): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } } },
          '#withRunAsUser':: d.fn(help='', args=[d.arg(name='runAsUser', type=d.T.string)]),
          withRunAsUser(runAsUser): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { runAsUser: runAsUser } } } } },
          '#withSupplementalGroups':: d.fn(help='', args=[d.arg(name='supplementalGroups', type=d.T.array)]),
          withSupplementalGroups(supplementalGroups): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          ...
          withSupplementalGroupsMixin(supplementalGroups): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } } },
          '#withSysctls':: d.fn(help='', args=[d.arg(name='sysctls', type=d.T.array)]),
          withSysctls(sysctls): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
          ...
          withSysctlsMixin(sysctls): { cronWorkflow+: { spec+: { workflowSpec+: { securityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } } },
        },
        ...
        synchronization: {
          ...
          mutex: {
            ...
            withName(name): { cronWorkflow+: { spec+: { workflowSpec+: { synchronization+: { mutex+: { name: name } } } } } },
          },
          ...
          semaphore: {
            ...
            configMapKeyRef: {
              ...
              localObjectReference: {
                '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
                withName(name): { cronWorkflow+: { spec+: { workflowSpec+: { synchronization+: { semaphore+: { configMapKeyRef+: { localObjectReference+: { name: name } } } } } } } },
              },
              '#withKey':: d.fn(help='The key to select.', args=[d.arg(name='key', type=d.T.string)]),
              withKey(key): { cronWorkflow+: { spec+: { workflowSpec+: { synchronization+: { semaphore+: { configMapKeyRef+: { key: key } } } } } } },
              '#withOptional':: d.fn(help='', args=[d.arg(name='optional', type=d.T.boolean)]),
              withOptional(optional): { cronWorkflow+: { spec+: { workflowSpec+: { synchronization+: { semaphore+: { configMapKeyRef+: { optional: optional } } } } } } },
            },
          },
        },
        ...
        ttlStrategy: {
          ...
          withSecondsAfterCompletion(secondsAfterCompletion): { cronWorkflow+: { spec+: { workflowSpec+: { ttlStrategy+: { secondsAfterCompletion: secondsAfterCompletion } } } } },
          ...
          withSecondsAfterFailure(secondsAfterFailure): { cronWorkflow+: { spec+: { workflowSpec+: { ttlStrategy+: { secondsAfterFailure: secondsAfterFailure } } } } },
          ...
          withSecondsAfterSuccess(secondsAfterSuccess): { cronWorkflow+: { spec+: { workflowSpec+: { ttlStrategy+: { secondsAfterSuccess: secondsAfterSuccess } } } } },
        },
        ...
        volumeClaimGC: {
          ...
          withStrategy(strategy): { cronWorkflow+: { spec+: { workflowSpec+: { volumeClaimGC+: { strategy: strategy } } } } },
        },
        ...
        withActiveDeadlineSeconds(activeDeadlineSeconds): { cronWorkflow+: { spec+: { workflowSpec+: { activeDeadlineSeconds: activeDeadlineSeconds } } } },
        ...
        withAutomountServiceAccountToken(automountServiceAccountToken): { cronWorkflow+: { spec+: { workflowSpec+: { automountServiceAccountToken: automountServiceAccountToken } } } },
        ...
        withDnsPolicy(dnsPolicy): { cronWorkflow+: { spec+: { workflowSpec+: { dnsPolicy: dnsPolicy } } } },
        ...
        withEntrypoint(entrypoint): { cronWorkflow+: { spec+: { workflowSpec+: { entrypoint: entrypoint } } } },
        '#withHostAliases':: d.fn(help='', args=[d.arg(name='hostAliases', type=d.T.array)]),
        withHostAliases(hostAliases): { cronWorkflow+: { spec+: { workflowSpec+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        ...
        withHostAliasesMixin(hostAliases): { cronWorkflow+: { spec+: { workflowSpec+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } } },
        ...
        withHostNetwork(hostNetwork): { cronWorkflow+: { spec+: { workflowSpec+: { hostNetwork: hostNetwork } } } },
        ...
        withImagePullSecrets(imagePullSecrets): { cronWorkflow+: { spec+: { workflowSpec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        ...
        withImagePullSecretsMixin(imagePullSecrets): { cronWorkflow+: { spec+: { workflowSpec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } } },
        ...
        withNodeSelector(nodeSelector): { cronWorkflow+: { spec+: { workflowSpec+: { nodeSelector: nodeSelector } } } },
        ...
        withNodeSelectorMixin(nodeSelector): { cronWorkflow+: { spec+: { workflowSpec+: { nodeSelector+: nodeSelector } } } },
        ...
        withOnExit(onExit): { cronWorkflow+: { spec+: { workflowSpec+: { onExit: onExit } } } },
        ...
        withParallelism(parallelism): { cronWorkflow+: { spec+: { workflowSpec+: { parallelism: parallelism } } } },
        '#withPodPriority':: d.fn(help='Priority to apply to workflow pods.', args=[d.arg(name='podPriority', type=d.T.integer)]),
        withPodPriority(podPriority): { cronWorkflow+: { spec+: { workflowSpec+: { podPriority: podPriority } } } },
        ...
        withPodPriorityClassName(podPriorityClassName): { cronWorkflow+: { spec+: { workflowSpec+: { podPriorityClassName: podPriorityClassName } } } },
        ...
        withPodSpecPatch(podSpecPatch): { cronWorkflow+: { spec+: { workflowSpec+: { podSpecPatch: podSpecPatch } } } },
        ...
        withPriority(priority): { cronWorkflow+: { spec+: { workflowSpec+: { priority: priority } } } },
        ...
        withSchedulerName(schedulerName): { cronWorkflow+: { spec+: { workflowSpec+: { schedulerName: schedulerName } } } },
        ...
        withServiceAccountName(serviceAccountName): { cronWorkflow+: { spec+: { workflowSpec+: { serviceAccountName: serviceAccountName } } } },
        ...
        withShutdown(shutdown): { cronWorkflow+: { spec+: { workflowSpec+: { shutdown: shutdown } } } },
        ...
        withSuspend(suspend): { cronWorkflow+: { spec+: { workflowSpec+: { suspend: suspend } } } },
        ...
        withTemplates(templates): { cronWorkflow+: { spec+: { workflowSpec+: { templates: if std.isArray(v=templates) then templates else [templates] } } } },
        ...
        withTemplatesMixin(templates): { cronWorkflow+: { spec+: { workflowSpec+: { templates+: if std.isArray(v=templates) then templates else [templates] } } } },
        '#withTolerations':: d.fn(help='Tolerations to apply to workflow pods.', args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerations(tolerations): { cronWorkflow+: { spec+: { workflowSpec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        ...
        withTolerationsMixin(tolerations): { cronWorkflow+: { spec+: { workflowSpec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        ...
        withTtlSecondsAfterFinished(ttlSecondsAfterFinished): { cronWorkflow+: { spec+: { workflowSpec+: { ttlSecondsAfterFinished: ttlSecondsAfterFinished } } } },
        ...
        withVolumeClaimTemplates(volumeClaimTemplates): { cronWorkflow+: { spec+: { workflowSpec+: { volumeClaimTemplates: if std.isArray(v=volumeClaimTemplates) then volumeClaimTemplates else [volumeClaimTemplates] } } } },
        ...
        withVolumeClaimTemplatesMixin(volumeClaimTemplates): { cronWorkflow+: { spec+: { workflowSpec+: { volumeClaimTemplates+: if std.isArray(v=volumeClaimTemplates) then volumeClaimTemplates else [volumeClaimTemplates] } } } },
        ...
        withVolumes(volumes): { cronWorkflow+: { spec+: { workflowSpec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } } },
        ...
        withVolumesMixin(volumes): { cronWorkflow+: { spec+: { workflowSpec+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } } },
        ...
        workflowTemplateRef: {
          ...
          withClusterScope(clusterScope): { cronWorkflow+: { spec+: { workflowSpec+: { workflowTemplateRef+: { clusterScope: clusterScope } } } } },
          '#withName':: d.fn(help='Name is the resource name of the workflow template.', args=[d.arg(name='name', type=d.T.string)]),
          withName(name): { cronWorkflow+: { spec+: { workflowSpec+: { workflowTemplateRef+: { name: name } } } } },
        },
      },
    },
    ...
    withKind(kind): { cronWorkflow+: { kind: kind } },
  },
  '#withName':: d.fn(help='DEPRECATED: This field is ignored.', args=[d.arg(name='name', type=d.T.string)]),
