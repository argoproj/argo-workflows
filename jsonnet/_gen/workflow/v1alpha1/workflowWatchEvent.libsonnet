{
  ...
  '#':: d.pkg(name='workflowWatchEvent', url='', help=''),
  '#object':: d.obj(help='Workflow is the definition of a workflow resource'),
  object: {
    ...
    metadata: {
      ...
      creationTimestamp: {
        ...
        withNanos(nanos): { object+: { metadata+: { creationTimestamp+: { nanos: nanos } } } },
        ...
        withSeconds(seconds): { object+: { metadata+: { creationTimestamp+: { seconds: seconds } } } },
      },
      '#deletionTimestamp':: d.obj(help='Time is a wrapper around time.Time which supports correct\nmarshaling to YAML and JSON.  Wrappers are provided for many\nof the factory methods that the time package offers.\n\n+protobuf.options.marshal=false\n+protobuf.as=Timestamp\n+protobuf.options.(gogoproto.goproto_stringer)=false'),
      deletionTimestamp: {
        '#withNanos':: d.fn(help='Non-negative fractions of a second at nanosecond resolution. Negative\nsecond values with fractions must still have non-negative nanos values\nthat count forward in time. Must be from 0 to 999,999,999\ninclusive. This field may be limited in precision depending on context.', args=[d.arg(name='nanos', type=d.T.integer)]),
        withNanos(nanos): { object+: { metadata+: { deletionTimestamp+: { nanos: nanos } } } },
        '#withSeconds':: d.fn(help='Represents seconds of UTC time since Unix epoch\n1970-01-01T00:00:00Z. Must be from 0001-01-01T00:00:00Z to\n9999-12-31T23:59:59Z inclusive.', args=[d.arg(name='seconds', type=d.T.string)]),
        withSeconds(seconds): { object+: { metadata+: { deletionTimestamp+: { seconds: seconds } } } },
      },
      '#withAnnotations':: d.fn(help='', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotations(annotations): { object+: { metadata+: { annotations: annotations } } },
      '#withAnnotationsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='annotations', type=d.T.object)]),
      withAnnotationsMixin(annotations): { object+: { metadata+: { annotations+: annotations } } },
      '#withClusterName':: d.fn(help='', args=[d.arg(name='clusterName', type=d.T.string)]),
      withClusterName(clusterName): { object+: { metadata+: { clusterName: clusterName } } },
      '#withDeletionGracePeriodSeconds':: d.fn(help='', args=[d.arg(name='deletionGracePeriodSeconds', type=d.T.string)]),
      withDeletionGracePeriodSeconds(deletionGracePeriodSeconds): { object+: { metadata+: { deletionGracePeriodSeconds: deletionGracePeriodSeconds } } },
      '#withFinalizers':: d.fn(help='', args=[d.arg(name='finalizers', type=d.T.array)]),
      withFinalizers(finalizers): { object+: { metadata+: { finalizers: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      '#withFinalizersMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='finalizers', type=d.T.array)]),
      withFinalizersMixin(finalizers): { object+: { metadata+: { finalizers+: if std.isArray(v=finalizers) then finalizers else [finalizers] } } },
      ...
      withGenerateName(generateName): { object+: { metadata+: { generateName: generateName } } },
      '#withGeneration':: d.fn(help='', args=[d.arg(name='generation', type=d.T.string)]),
      withGeneration(generation): { object+: { metadata+: { generation: generation } } },
      '#withLabels':: d.fn(help='', args=[d.arg(name='labels', type=d.T.object)]),
      withLabels(labels): { object+: { metadata+: { labels: labels } } },
      '#withLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='labels', type=d.T.object)]),
      withLabelsMixin(labels): { object+: { metadata+: { labels+: labels } } },
      ...
      withManagedFields(managedFields): { object+: { metadata+: { managedFields: if std.isArray(v=managedFields) then managedFields else [managedFields] } } },
      '#withManagedFieldsMixin':: d.fn(help="ManagedFields maps workflow-id and version to the set of fields\nthat are managed by that io.argoproj.workflow.v1alpha1. This is mostly for internal\nhousekeeping, and users typically shouldn't need to set or\nunderstand this field. A workflow can be the user's name, a\ncontroller's name, or the name of a specific apply path like\n'ci-cd'. The set of fields is always in the version that the\nworkflow used when modifying the object.\n\n+optional\n\n**Note:** This function appends passed data to existing values", args=[d.arg(name='managedFields', type=d.T.array)]),
      withManagedFieldsMixin(managedFields): { object+: { metadata+: { managedFields+: if std.isArray(v=managedFields) then managedFields else [managedFields] } } },
      '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
      withName(name): { object+: { metadata+: { name: name } } },
      ...
      withNamespace(namespace): { object+: { metadata+: { namespace: namespace } } },
      '#withOwnerReferences':: d.fn(help='', args=[d.arg(name='ownerReferences', type=d.T.array)]),
      withOwnerReferences(ownerReferences): { object+: { metadata+: { ownerReferences: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } },
      '#withOwnerReferencesMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='ownerReferences', type=d.T.array)]),
      withOwnerReferencesMixin(ownerReferences): { object+: { metadata+: { ownerReferences+: if std.isArray(v=ownerReferences) then ownerReferences else [ownerReferences] } } },
      ...
      withResourceVersion(resourceVersion): { object+: { metadata+: { resourceVersion: resourceVersion } } },
      ...
      withSelfLink(selfLink): { object+: { metadata+: { selfLink: selfLink } } },
      ...
      withUid(uid): { object+: { metadata+: { uid: uid } } },
    },
    ...
    spec: {
      ...
      affinity: {
        ...
        nodeAffinity: {
          ...
          requiredDuringSchedulingIgnoredDuringExecution: {
            ...
            withNodeSelectorTerms(nodeSelectorTerms): { object+: { spec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
            ...
            withNodeSelectorTermsMixin(nodeSelectorTerms): { object+: { spec+: { affinity+: { nodeAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: { nodeSelectorTerms+: if std.isArray(v=nodeSelectorTerms) then nodeSelectorTerms else [nodeSelectorTerms] } } } } } },
          },
          ...
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { nodeAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        ...
        podAffinity: {
          ...
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { podAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          ...
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { podAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
        '#podAntiAffinity':: d.obj(help='Pod anti affinity is a group of inter pod anti affinity scheduling rules.'),
        podAntiAffinity: {
          '#withPreferredDuringSchedulingIgnoredDuringExecution':: d.fn(help='', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecution(preferredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withPreferredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='preferredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withPreferredDuringSchedulingIgnoredDuringExecutionMixin(preferredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { podAntiAffinity+: { preferredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=preferredDuringSchedulingIgnoredDuringExecution) then preferredDuringSchedulingIgnoredDuringExecution else [preferredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecution':: d.fn(help='', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecution(requiredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
          '#withRequiredDuringSchedulingIgnoredDuringExecutionMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='requiredDuringSchedulingIgnoredDuringExecution', type=d.T.array)]),
          withRequiredDuringSchedulingIgnoredDuringExecutionMixin(requiredDuringSchedulingIgnoredDuringExecution): { object+: { spec+: { affinity+: { podAntiAffinity+: { requiredDuringSchedulingIgnoredDuringExecution+: if std.isArray(v=requiredDuringSchedulingIgnoredDuringExecution) then requiredDuringSchedulingIgnoredDuringExecution else [requiredDuringSchedulingIgnoredDuringExecution] } } } } },
        },
      },
      ...
      arguments: {
        ...
        withArtifacts(artifacts): { object+: { spec+: { arguments+: { artifacts: if std.isArray(v=artifacts) then artifacts else [artifacts] } } } },
        ...
        withArtifactsMixin(artifacts): { object+: { spec+: { arguments+: { artifacts+: if std.isArray(v=artifacts) then artifacts else [artifacts] } } } },
        ...
        withParameters(parameters): { object+: { spec+: { arguments+: { parameters: if std.isArray(v=parameters) then parameters else [parameters] } } } },
        ...
        withParametersMixin(parameters): { object+: { spec+: { arguments+: { parameters+: if std.isArray(v=parameters) then parameters else [parameters] } } } },
      },
      ...
      artifactRepositoryRef: {
        ...
        withConfigMap(configMap): { object+: { spec+: { artifactRepositoryRef+: { configMap: configMap } } } },
        ...
        withKey(key): { object+: { spec+: { artifactRepositoryRef+: { key: key } } } },
      },
      ...
      dnsConfig: {
        ...
        withNameservers(nameservers): { object+: { spec+: { dnsConfig+: { nameservers: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        ...
        withNameserversMixin(nameservers): { object+: { spec+: { dnsConfig+: { nameservers+: if std.isArray(v=nameservers) then nameservers else [nameservers] } } } },
        '#withOptions':: d.fn(help='', args=[d.arg(name='options', type=d.T.array)]),
        withOptions(options): { object+: { spec+: { dnsConfig+: { options: if std.isArray(v=options) then options else [options] } } } },
        ...
        withOptionsMixin(options): { object+: { spec+: { dnsConfig+: { options+: if std.isArray(v=options) then options else [options] } } } },
        '#withSearches':: d.fn(help='', args=[d.arg(name='searches', type=d.T.array)]),
        withSearches(searches): { object+: { spec+: { dnsConfig+: { searches: if std.isArray(v=searches) then searches else [searches] } } } },
        ...
        withSearchesMixin(searches): { object+: { spec+: { dnsConfig+: { searches+: if std.isArray(v=searches) then searches else [searches] } } } },
      },
      ...
      executor: {
        ...
        withServiceAccountName(serviceAccountName): { object+: { spec+: { executor+: { serviceAccountName: serviceAccountName } } } },
      },
      ...
      metrics: {
        ...
        withPrometheus(prometheus): { object+: { spec+: { metrics+: { prometheus: if std.isArray(v=prometheus) then prometheus else [prometheus] } } } },
        ...
        withPrometheusMixin(prometheus): { object+: { spec+: { metrics+: { prometheus+: if std.isArray(v=prometheus) then prometheus else [prometheus] } } } },
      },
      ...
      podDisruptionBudget: {
        ...
        maxUnavailable: {
          ...
          withIntVal(intVal): { object+: { spec+: { podDisruptionBudget+: { maxUnavailable+: { intVal: intVal } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { object+: { spec+: { podDisruptionBudget+: { maxUnavailable+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { object+: { spec+: { podDisruptionBudget+: { maxUnavailable+: { type: type } } } } },
        },
        '#minAvailable':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
        minAvailable: {
          '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
          withIntVal(intVal): { object+: { spec+: { podDisruptionBudget+: { minAvailable+: { intVal: intVal } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { object+: { spec+: { podDisruptionBudget+: { minAvailable+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { object+: { spec+: { podDisruptionBudget+: { minAvailable+: { type: type } } } } },
        },
        ...
        selector: {
          ...
          withMatchExpressions(matchExpressions): { object+: { spec+: { podDisruptionBudget+: { selector+: { matchExpressions: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } },
          '#withMatchExpressionsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchExpressions', type=d.T.array)]),
          withMatchExpressionsMixin(matchExpressions): { object+: { spec+: { podDisruptionBudget+: { selector+: { matchExpressions+: if std.isArray(v=matchExpressions) then matchExpressions else [matchExpressions] } } } } },
          '#withMatchLabels':: d.fn(help='', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabels(matchLabels): { object+: { spec+: { podDisruptionBudget+: { selector+: { matchLabels: matchLabels } } } } },
          '#withMatchLabelsMixin':: d.fn(help='\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='matchLabels', type=d.T.object)]),
          withMatchLabelsMixin(matchLabels): { object+: { spec+: { podDisruptionBudget+: { selector+: { matchLabels+: matchLabels } } } } },
        },
      },
      ...
      podGC: {
        ...
        withStrategy(strategy): { object+: { spec+: { podGC+: { strategy: strategy } } } },
      },
      ...
      retryStrategy: {
        ...
        backoff: {
          ...
          factor: {
            '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
            withIntVal(intVal): { object+: { spec+: { retryStrategy+: { backoff+: { factor+: { intVal: intVal } } } } } },
            '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
            withStrVal(strVal): { object+: { spec+: { retryStrategy+: { backoff+: { factor+: { strVal: strVal } } } } } },
            '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
            withType(type): { object+: { spec+: { retryStrategy+: { backoff+: { factor+: { type: type } } } } } },
          },
          ...
          withDuration(duration): { object+: { spec+: { retryStrategy+: { backoff+: { duration: duration } } } } },
          ...
          withMaxDuration(maxDuration): { object+: { spec+: { retryStrategy+: { backoff+: { maxDuration: maxDuration } } } } },
        },
        '#limit':: d.obj(help='+protobuf=true\n+protobuf.options.(gogoproto.goproto_stringer)=false\n+k8s:openapi-gen=true'),
        limit: {
          '#withIntVal':: d.fn(help='', args=[d.arg(name='intVal', type=d.T.integer)]),
          withIntVal(intVal): { object+: { spec+: { retryStrategy+: { limit+: { intVal: intVal } } } } },
          '#withStrVal':: d.fn(help='', args=[d.arg(name='strVal', type=d.T.string)]),
          withStrVal(strVal): { object+: { spec+: { retryStrategy+: { limit+: { strVal: strVal } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { object+: { spec+: { retryStrategy+: { limit+: { type: type } } } } },
        },
        ...
        withRetryPolicy(retryPolicy): { object+: { spec+: { retryStrategy+: { retryPolicy: retryPolicy } } } },
      },
      ...
      securityContext: {
        ...
        seLinuxOptions: {
          ...
          withLevel(level): { object+: { spec+: { securityContext+: { seLinuxOptions+: { level: level } } } } },
          '#withRole':: d.fn(help='', args=[d.arg(name='role', type=d.T.string)]),
          withRole(role): { object+: { spec+: { securityContext+: { seLinuxOptions+: { role: role } } } } },
          '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
          withType(type): { object+: { spec+: { securityContext+: { seLinuxOptions+: { type: type } } } } },
          '#withUser':: d.fn(help='', args=[d.arg(name='user', type=d.T.string)]),
          withUser(user): { object+: { spec+: { securityContext+: { seLinuxOptions+: { user: user } } } } },
        },
        ...
        windowsOptions: {
          ...
          withGmsaCredentialSpec(gmsaCredentialSpec): { object+: { spec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpec: gmsaCredentialSpec } } } } },
          '#withGmsaCredentialSpecName':: d.fn(help='', args=[d.arg(name='gmsaCredentialSpecName', type=d.T.string)]),
          withGmsaCredentialSpecName(gmsaCredentialSpecName): { object+: { spec+: { securityContext+: { windowsOptions+: { gmsaCredentialSpecName: gmsaCredentialSpecName } } } } },
          '#withRunAsUserName':: d.fn(help='', args=[d.arg(name='runAsUserName', type=d.T.string)]),
          withRunAsUserName(runAsUserName): { object+: { spec+: { securityContext+: { windowsOptions+: { runAsUserName: runAsUserName } } } } },
        },
        ...
        withFsGroup(fsGroup): { object+: { spec+: { securityContext+: { fsGroup: fsGroup } } } },
        '#withRunAsGroup':: d.fn(help='', args=[d.arg(name='runAsGroup', type=d.T.string)]),
        withRunAsGroup(runAsGroup): { object+: { spec+: { securityContext+: { runAsGroup: runAsGroup } } } },
        '#withRunAsNonRoot':: d.fn(help='', args=[d.arg(name='runAsNonRoot', type=d.T.boolean)]),
        withRunAsNonRoot(runAsNonRoot): { object+: { spec+: { securityContext+: { runAsNonRoot: runAsNonRoot } } } },
        '#withRunAsUser':: d.fn(help='', args=[d.arg(name='runAsUser', type=d.T.string)]),
        withRunAsUser(runAsUser): { object+: { spec+: { securityContext+: { runAsUser: runAsUser } } } },
        '#withSupplementalGroups':: d.fn(help='', args=[d.arg(name='supplementalGroups', type=d.T.array)]),
        withSupplementalGroups(supplementalGroups): { object+: { spec+: { securityContext+: { supplementalGroups: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        ...
        withSupplementalGroupsMixin(supplementalGroups): { object+: { spec+: { securityContext+: { supplementalGroups+: if std.isArray(v=supplementalGroups) then supplementalGroups else [supplementalGroups] } } } },
        '#withSysctls':: d.fn(help='', args=[d.arg(name='sysctls', type=d.T.array)]),
        withSysctls(sysctls): { object+: { spec+: { securityContext+: { sysctls: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
        ...
        withSysctlsMixin(sysctls): { object+: { spec+: { securityContext+: { sysctls+: if std.isArray(v=sysctls) then sysctls else [sysctls] } } } },
      },
      ...
      synchronization: {
        ...
        mutex: {
          ...
          withName(name): { object+: { spec+: { synchronization+: { mutex+: { name: name } } } } },
        },
        ...
        semaphore: {
          ...
          configMapKeyRef: {
            ...
            localObjectReference: {
              '#withName':: d.fn(help='', args=[d.arg(name='name', type=d.T.string)]),
              withName(name): { object+: { spec+: { synchronization+: { semaphore+: { configMapKeyRef+: { localObjectReference+: { name: name } } } } } } },
            },
            '#withKey':: d.fn(help='The key to select.', args=[d.arg(name='key', type=d.T.string)]),
            withKey(key): { object+: { spec+: { synchronization+: { semaphore+: { configMapKeyRef+: { key: key } } } } } },
            '#withOptional':: d.fn(help='', args=[d.arg(name='optional', type=d.T.boolean)]),
            withOptional(optional): { object+: { spec+: { synchronization+: { semaphore+: { configMapKeyRef+: { optional: optional } } } } } },
          },
        },
      },
      ...
      ttlStrategy: {
        ...
        withSecondsAfterCompletion(secondsAfterCompletion): { object+: { spec+: { ttlStrategy+: { secondsAfterCompletion: secondsAfterCompletion } } } },
        ...
        withSecondsAfterFailure(secondsAfterFailure): { object+: { spec+: { ttlStrategy+: { secondsAfterFailure: secondsAfterFailure } } } },
        ...
        withSecondsAfterSuccess(secondsAfterSuccess): { object+: { spec+: { ttlStrategy+: { secondsAfterSuccess: secondsAfterSuccess } } } },
      },
      ...
      volumeClaimGC: {
        ...
        withStrategy(strategy): { object+: { spec+: { volumeClaimGC+: { strategy: strategy } } } },
      },
      ...
      withActiveDeadlineSeconds(activeDeadlineSeconds): { object+: { spec+: { activeDeadlineSeconds: activeDeadlineSeconds } } },
      ...
      withAutomountServiceAccountToken(automountServiceAccountToken): { object+: { spec+: { automountServiceAccountToken: automountServiceAccountToken } } },
      ...
      withDnsPolicy(dnsPolicy): { object+: { spec+: { dnsPolicy: dnsPolicy } } },
      ...
      withEntrypoint(entrypoint): { object+: { spec+: { entrypoint: entrypoint } } },
      '#withHostAliases':: d.fn(help='', args=[d.arg(name='hostAliases', type=d.T.array)]),
      withHostAliases(hostAliases): { object+: { spec+: { hostAliases: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      ...
      withHostAliasesMixin(hostAliases): { object+: { spec+: { hostAliases+: if std.isArray(v=hostAliases) then hostAliases else [hostAliases] } } },
      ...
      withHostNetwork(hostNetwork): { object+: { spec+: { hostNetwork: hostNetwork } } },
      ...
      withImagePullSecrets(imagePullSecrets): { object+: { spec+: { imagePullSecrets: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } },
      ...
      withImagePullSecretsMixin(imagePullSecrets): { object+: { spec+: { imagePullSecrets+: if std.isArray(v=imagePullSecrets) then imagePullSecrets else [imagePullSecrets] } } },
      ...
      withNodeSelector(nodeSelector): { object+: { spec+: { nodeSelector: nodeSelector } } },
      ...
      withNodeSelectorMixin(nodeSelector): { object+: { spec+: { nodeSelector+: nodeSelector } } },
      ...
      withOnExit(onExit): { object+: { spec+: { onExit: onExit } } },
      ...
      withParallelism(parallelism): { object+: { spec+: { parallelism: parallelism } } },
      '#withPodPriority':: d.fn(help='Priority to apply to workflow pods.', args=[d.arg(name='podPriority', type=d.T.integer)]),
      withPodPriority(podPriority): { object+: { spec+: { podPriority: podPriority } } },
      ...
      withPodPriorityClassName(podPriorityClassName): { object+: { spec+: { podPriorityClassName: podPriorityClassName } } },
      ...
      withPodSpecPatch(podSpecPatch): { object+: { spec+: { podSpecPatch: podSpecPatch } } },
      ...
      withPriority(priority): { object+: { spec+: { priority: priority } } },
      ...
      withSchedulerName(schedulerName): { object+: { spec+: { schedulerName: schedulerName } } },
      ...
      withServiceAccountName(serviceAccountName): { object+: { spec+: { serviceAccountName: serviceAccountName } } },
      ...
      withShutdown(shutdown): { object+: { spec+: { shutdown: shutdown } } },
      ...
      withSuspend(suspend): { object+: { spec+: { suspend: suspend } } },
      ...
      withTemplates(templates): { object+: { spec+: { templates: if std.isArray(v=templates) then templates else [templates] } } },
      ...
      withTemplatesMixin(templates): { object+: { spec+: { templates+: if std.isArray(v=templates) then templates else [templates] } } },
      '#withTolerations':: d.fn(help='Tolerations to apply to workflow pods.', args=[d.arg(name='tolerations', type=d.T.array)]),
      withTolerations(tolerations): { object+: { spec+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      ...
      withTolerationsMixin(tolerations): { object+: { spec+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } },
      ...
      withTtlSecondsAfterFinished(ttlSecondsAfterFinished): { object+: { spec+: { ttlSecondsAfterFinished: ttlSecondsAfterFinished } } },
      ...
      withVolumeClaimTemplates(volumeClaimTemplates): { object+: { spec+: { volumeClaimTemplates: if std.isArray(v=volumeClaimTemplates) then volumeClaimTemplates else [volumeClaimTemplates] } } },
      ...
      withVolumeClaimTemplatesMixin(volumeClaimTemplates): { object+: { spec+: { volumeClaimTemplates+: if std.isArray(v=volumeClaimTemplates) then volumeClaimTemplates else [volumeClaimTemplates] } } },
      ...
      withVolumes(volumes): { object+: { spec+: { volumes: if std.isArray(v=volumes) then volumes else [volumes] } } },
      ...
      withVolumesMixin(volumes): { object+: { spec+: { volumes+: if std.isArray(v=volumes) then volumes else [volumes] } } },
      ...
      workflowTemplateRef: {
        ...
        withClusterScope(clusterScope): { object+: { spec+: { workflowTemplateRef+: { clusterScope: clusterScope } } } },
        '#withName':: d.fn(help='Name is the resource name of the workflow template.', args=[d.arg(name='name', type=d.T.string)]),
        withName(name): { object+: { spec+: { workflowTemplateRef+: { name: name } } } },
      },
    },
    ...
    withKind(kind): { object+: { kind: kind } },
  },
  '#withType':: d.fn(help='', args=[d.arg(name='type', type=d.T.string)]),
