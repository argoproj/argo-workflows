...
# **createCronWorkflow**
> V1alpha1CronWorkflow createCronWorkflow(namespace, body)
...
import io.argoproj.argo.client.api.CronWorkflowServiceApi;
...
public class Example {
  public static void main(String[] args) {
    ...
    CronworkflowCreateCronWorkflowRequest body = new CronworkflowCreateCronWorkflowRequest(); // CronworkflowCreateCronWorkflowRequest | 
    try {
      V1alpha1CronWorkflow result = apiInstance.createCronWorkflow(namespace, body);
...
# **getCronWorkflow**
> V1alpha1CronWorkflow getCronWorkflow(namespace, name, getOptionsResourceVersion)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1alpha1CronWorkflow result = apiInstance.getCronWorkflow(namespace, name, getOptionsResourceVersion);
      System.out.println(result);
    } catch (ApiException e) {
...
# **listCronWorkflows**
> V1alpha1CronWorkflowList listCronWorkflows(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      V1alpha1CronWorkflowList result = apiInstance.listCronWorkflows(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
      System.out.println(result);
    } catch (ApiException e) {
...
# **updateCronWorkflow**
> V1alpha1CronWorkflow updateCronWorkflow(namespace, name, body)
...
public class Example {
  public static void main(String[] args) {
    ...
    String namespace = "namespace_example"; // String | 
    String name = "name_example"; // String | 
    CronworkflowUpdateCronWorkflowRequest body = new CronworkflowUpdateCronWorkflowRequest(); // CronworkflowUpdateCronWorkflowRequest | 
    try {
      V1alpha1CronWorkflow result = apiInstance.updateCronWorkflow(namespace, name, body);
      System.out.println(result);
    } catch (ApiException e) {
