...
public class V1alpha1Capabilities {
  ...
  public V1alpha1Capabilities add(List<String> add) {
    
    this.add = add;
    return this;
  }

  public V1alpha1Capabilities addAddItem(String addItem) {
    if (this.add == null) {
  ...
  **/
  ...
  public V1alpha1Capabilities drop(List<String> drop) {
    
    this.drop = drop;
    return this;
  }

  public V1alpha1Capabilities addDropItem(String dropItem) {
    if (this.drop == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    V1alpha1Capabilities v1alpha1Capabilities = (V1alpha1Capabilities) o;
    return Objects.equals(this.add, v1alpha1Capabilities.add) &&
        Objects.equals(this.drop, v1alpha1Capabilities.drop);
  }
  ...
  public String toString() {
    ...
    sb.append("class V1alpha1Capabilities {\n");
