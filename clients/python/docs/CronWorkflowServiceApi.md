...
body = openapi_client.CronworkflowCreateCronWorkflowRequest() # CronworkflowCreateCronWorkflowRequest | 
...
with openapi_client.ApiClient() as api_client:
    ...
    namespace = 'namespace_example' # str | 
name = 'name_example' # str | 
body = openapi_client.CronworkflowUpdateCronWorkflowRequest() # CronworkflowUpdateCronWorkflowRequest | 
