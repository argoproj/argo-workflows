...
body = openapi_client.WorkflowtemplateWorkflowTemplateCreateRequest() # WorkflowtemplateWorkflowTemplateCreateRequest | 
...
with openapi_client.ApiClient() as api_client:
    ...
    api_instance = openapi_client.WorkflowTemplateServiceApi(api_client)
    namespace = 'namespace_example' # str | 
body = openapi_client.WorkflowtemplateWorkflowTemplateLintRequest() # WorkflowtemplateWorkflowTemplateLintRequest | 
...
with openapi_client.ApiClient() as api_client:
    ...
    namespace = 'namespace_example' # str | 
name = 'name_example' # str | 
body = openapi_client.WorkflowtemplateWorkflowTemplateUpdateRequest() # WorkflowtemplateWorkflowTemplateUpdateRequest | 
