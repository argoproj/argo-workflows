...
class V1alpha1NodeAffinity(object):
    ...
    """
    openapi_types = {
        'preferred_during_scheduling_ignored_during_execution': 'list[V1alpha1PreferredSchedulingTerm]',
        'required_during_scheduling_ignored_during_execution': 'V1alpha1NodeSelector'
    }
    ...
    def __init__(self, preferred_during_scheduling_ignored_during_execution=None, required_during_scheduling_ignored_during_execution=None, local_vars_configuration=None):  # noqa: E501
        """V1alpha1NodeAffinity - a model defined in OpenAPI"""  # noqa: E501
    ...
    def preferred_during_scheduling_ignored_during_execution(self):
        """Gets the preferred_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.  # noqa: E501


        :return: The preferred_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.  # noqa: E501
        :rtype: list[V1alpha1PreferredSchedulingTerm]
        """
    ...
    def preferred_during_scheduling_ignored_during_execution(self, preferred_during_scheduling_ignored_during_execution):
        """Sets the preferred_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.


        :param preferred_during_scheduling_ignored_during_execution: The preferred_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.  # noqa: E501
        :type: list[V1alpha1PreferredSchedulingTerm]
        """
    ...
    def required_during_scheduling_ignored_during_execution(self):
        """Gets the required_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.  # noqa: E501


        :return: The required_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.  # noqa: E501
        :rtype: V1alpha1NodeSelector
        """
    ...
    def required_during_scheduling_ignored_during_execution(self, required_during_scheduling_ignored_during_execution):
        """Sets the required_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.


        :param required_during_scheduling_ignored_during_execution: The required_during_scheduling_ignored_during_execution of this V1alpha1NodeAffinity.  # noqa: E501
        :type: V1alpha1NodeSelector
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, V1alpha1NodeAffinity):
            return False
