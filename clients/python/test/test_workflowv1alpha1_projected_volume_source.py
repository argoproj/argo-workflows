...
from openapi_client.io.argoproj.argo.client.model.workflowv1alpha1_projected_volume_source import Workflowv1alpha1ProjectedVolumeSource  # noqa: E501
from openapi_client.rest import ApiException

class TestWorkflowv1alpha1ProjectedVolumeSource(unittest.TestCase):
    """Workflowv1alpha1ProjectedVolumeSource unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test Workflowv1alpha1ProjectedVolumeSource
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.workflowv1alpha1_projected_volume_source.Workflowv1alpha1ProjectedVolumeSource()  # noqa: E501
        if include_optional :
            return Workflowv1alpha1ProjectedVolumeSource(
                default_mode = 56, 
                sources = [
    ...
    def testWorkflowv1alpha1ProjectedVolumeSource(self):
        """Test Workflowv1alpha1ProjectedVolumeSource"""
