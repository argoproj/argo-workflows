...
from openapi_client.io.argoproj.argo.client.model.v1alpha1_artifact import V1alpha1Artifact  # noqa: E501
from openapi_client.rest import ApiException

class TestV1alpha1Artifact(unittest.TestCase):
    """V1alpha1Artifact unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha1Artifact
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.v1alpha1_artifact.V1alpha1Artifact()  # noqa: E501
        if include_optional :
