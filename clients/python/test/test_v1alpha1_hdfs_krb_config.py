...
from openapi_client.io.argoproj.argo.client.model.v1alpha1_hdfs_krb_config import V1alpha1HDFSKrbConfig  # noqa: E501
from openapi_client.rest import ApiException

class TestV1alpha1HDFSKrbConfig(unittest.TestCase):
    """V1alpha1HDFSKrbConfig unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha1HDFSKrbConfig
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.v1alpha1_hdfs_krb_config.V1alpha1HDFSKrbConfig()  # noqa: E501
        if include_optional :
            return V1alpha1HDFSKrbConfig(
    ...
    def testV1alpha1HDFSKrbConfig(self):
        """Test V1alpha1HDFSKrbConfig"""
