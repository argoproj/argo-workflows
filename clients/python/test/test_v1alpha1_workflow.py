...
from openapi_client.io.argoproj.argo.client.model.v1alpha1_workflow import V1alpha1Workflow  # noqa: E501
from openapi_client.rest import ApiException

class TestV1alpha1Workflow(unittest.TestCase):
    """V1alpha1Workflow unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha1Workflow
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.v1alpha1_workflow.V1alpha1Workflow()  # noqa: E501
        if include_optional :
