...
from openapi_client.io.argoproj.argo.client.model.workflow_workflow_lint_request import WorkflowWorkflowLintRequest  # noqa: E501
from openapi_client.rest import ApiException

class TestWorkflowWorkflowLintRequest(unittest.TestCase):
    """WorkflowWorkflowLintRequest unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test WorkflowWorkflowLintRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.workflow_workflow_lint_request.WorkflowWorkflowLintRequest()  # noqa: E501
        if include_optional :
            return WorkflowWorkflowLintRequest(
                namespace = '0', 
                workflow = openapi_client.models.workflow_is_the_definition_of_a_workflow_resource
+genclient
+genclient:no_status
+k8s:deepcopy_gen:interfaces=k8s/io/apimachinery/pkg/runtime/object.Workflow is the definition of a workflow resource
+genclient
+genclient:noStatus
+k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object(
                    metadata = openapi_client.models.v1_object_meta.v1ObjectMeta(
                        ...
                        self_link = '0', 
                        uid = '0', ), 
                    spec = openapi_client.models.v1alpha1_workflow_spec.v1alpha1WorkflowSpec(
                        ...
                        dns_config = openapi_client.models.workflowv1alpha1_pod_dns_config.workflowv1alpha1PodDNSConfig(
                            nameservers = [
                                '0'
                                ], 
                            options = [
                        ...
                        host_network = True, 
                        image_pull_secrets = [
                            openapi_client.models.workflowv1alpha1_local_object_reference.workflowv1alpha1LocalObjectReference(
                                name = '0', )
                            ], 
                        node_selector = {
                            'key' : '0'
...
The value of Item can be a map, string, bool, or number(
                        ...
                        volume_claim_templates = [
                            openapi_client.models.workflowv1alpha1_persistent_volume_claim.workflowv1alpha1PersistentVolumeClaim(
                    ...
                    status = openapi_client.models.workflow_status_contains_overall_status_information_about_a_workflow.WorkflowStatus contains overall status information about a workflow(
                        compressed_nodes = '0', 
                        finished_at = openapi_client.models.v1_time.v1Time(
                            nanos = 56, 
                            seconds = '0', ), 
                        message = '0', 
                        nodes = {
                            'key' : openapi_client.models.node_status_contains_status_information_about_an_individual_node_in_the_workflow.NodeStatus contains status information about an individual node in the workflow(
                                boundary_id = '0', 
                                children = [
                                    '0'
                                    ], 
                                ...
                                phase = '0', 
                                pod_ip = '0', 
                                started_at = openapi_client.models.v1_time.v1Time(
                                    nanos = 56, 
                                    seconds = '0', ), 
                                ...
                                template_scope = '0', 
                                type = '0', 
                                workflow_template_name = '0', )
                            }, 
                        offload_node_status_version = '0', 
                        ...
                        started_at = openapi_client.models.v1_time.v1Time(
                            ...
                            seconds = '0', ), 
                        stored_templates = {
                            'key' : openapi_client.models.template_is_a_reusable_and_composable_unit_of_execution_in_a_workflow.Template is a reusable and composable unit of execution in a workflow(
                                active_deadline_seconds = '0', 
                                automount_service_account_token = True, 
                                daemon = True, 
                                host_aliases = [
    ...
    def testWorkflowWorkflowLintRequest(self):
        """Test WorkflowWorkflowLintRequest"""
