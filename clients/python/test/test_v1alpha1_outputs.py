...
from openapi_client.io.argoproj.argo.client.model.v1alpha1_outputs import V1alpha1Outputs  # noqa: E501
from openapi_client.rest import ApiException

class TestV1alpha1Outputs(unittest.TestCase):
    """V1alpha1Outputs unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha1Outputs
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.v1alpha1_outputs.V1alpha1Outputs()  # noqa: E501
        if include_optional :
            return V1alpha1Outputs(
                artifacts = [
