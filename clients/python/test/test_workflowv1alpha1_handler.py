...
from openapi_client.io.argoproj.argo.client.model.workflowv1alpha1_handler import Workflowv1alpha1Handler  # noqa: E501
from openapi_client.rest import ApiException

class TestWorkflowv1alpha1Handler(unittest.TestCase):
    """Workflowv1alpha1Handler unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test Workflowv1alpha1Handler
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.workflowv1alpha1_handler.Workflowv1alpha1Handler()  # noqa: E501
        if include_optional :
            return Workflowv1alpha1Handler(
                _exec = openapi_client.models.workflowv1alpha1_exec_action.workflowv1alpha1ExecAction(
                    command = [
                        '0'
                        ], ), 
...
TODO: Rename to Int32OrString(
    ...
    def testWorkflowv1alpha1Handler(self):
        """Test Workflowv1alpha1Handler"""
