...
from openapi_client.io.argoproj.argo.client.model.v1_handler import V1Handler  # noqa: E501
...
class TestV1Handler(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.v1_handler.V1Handler()  # noqa: E501
        if include_optional :
            return V1Handler(
                _exec = openapi_client.models.v1_exec_action.v1ExecAction(
                    command = [
                        '0'
                        ], ), 
