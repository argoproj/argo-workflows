...
from openapi_client.io.argoproj.argo.client.model.v1alpha1_cron_workflow_list import V1alpha1CronWorkflowList  # noqa: E501
from openapi_client.rest import ApiException

class TestV1alpha1CronWorkflowList(unittest.TestCase):
    """V1alpha1CronWorkflowList unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test V1alpha1CronWorkflowList
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = openapi_client.models.v1alpha1_cron_workflow_list.V1alpha1CronWorkflowList()  # noqa: E501
        if include_optional :
            return V1alpha1CronWorkflowList(
                items = [
                    openapi_client.models.cron_workflow_is_the_definition_of_a_scheduled_workflow_resource
+genclient
+genclient:no_status
...
The value of Item can be a map, string, bool, or number(
    ...
    def testV1alpha1CronWorkflowList(self):
        """Test V1alpha1CronWorkflowList"""
