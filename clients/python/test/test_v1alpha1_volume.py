...
from openapi_client.io.argoproj.argo.client.model.v1alpha1_volume import V1alpha1Volume  # noqa: E501
from openapi_client.rest import ApiException

class TestV1alpha1Volume(unittest.TestCase):
    """V1alpha1Volume unit test stubs"""
    ...
    def make_instance(self, include_optional):
        ...
        # model = openapi_client.models.v1alpha1_volume.V1alpha1Volume()  # noqa: E501
        if include_optional :
            return V1alpha1Volume(
                name = '0', 
                volume_source = openapi_client.models.v1alpha1_volume_source.v1alpha1VolumeSource(
