        ...
        <Page title='Login' toolbar={{breadcrumbs: [{title: 'Login'}]}}>
            <div className='argo-container'>
                <div className='white-box'>
                    ...
                    <p>
                        <a href='https://argo-workflows.readthedocs.io/en/release-3.5.2/argo-server-auth-mode/'>Learn more</a>.
                    </p>
                </div>
                ...
                <div className='row'>
                    ...
                    <div className='columns small-4'>
                        <p>
                            ...
                            <a href='https://argo-workflows.readthedocs.io/en/release-3.5.2/access-token/#token-creation'>here</a> and paste in this box:
                        </p>
                        <div>
