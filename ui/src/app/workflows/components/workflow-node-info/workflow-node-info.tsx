                        ...
                        .map(link => (
                            <a
                                ...
                                href={link.url
                                    ...
                                    .replace(/\${metadata\.name}/g, props.workflow.metadata.name)
                                    .replace(/\${status\.startedAt}/g, props.workflow.status.startedAt)
                                    .replace(/\${status\.finishedAt}/g, props.workflow.status.finishedAt)}>
