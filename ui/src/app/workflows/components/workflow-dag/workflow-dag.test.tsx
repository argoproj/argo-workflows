...
it('renders correctly', () => {
    const tree = mount(
        <WorkflowDag
            workflowName={'dag-diamond-jvlhq'}
            nodes={{
                'dag-diamond-jvlhq': {
                    ...
                    children: ['dag-diamond-jvlhq-3813812925'],
                    outboundNodes: ['dag-diamond-jvlhq-3729924830']
                },
                ...
                'dag-diamond-jvlhq-3763480068': {
                    ...
                    children: ['dag-diamond-jvlhq-3729924830'],
                    hostNodeName: 'minikube'
                },
                ...
                'dag-diamond-jvlhq-3813812925': {
                    ...
                    children: ['dag-diamond-jvlhq-3763480068', 'dag-diamond-jvlhq-3780257687'],
                    hostNodeName: 'minikube'
                }
            }}
        />
