...
export const NewVersionModal = ({version, dismiss}: {version: string; dismiss: () => void}) => {
    return (
        <Modal dismiss={dismiss}>
            ...
            <ul className='new-version-modal-bullets'>
                <li>
                    <a href='https://argo-workflows.readthedocs.io/en/stable/artifact-visualization/?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                        Visualize artifact{' '}
                    </a>
                    in the UI
                </li>
                <li>
                    Automated{' '}
                    <a href='https://argo-workflows.readthedocs.io/en/stable/walk-through/artifacts/#artifact-garbage-collection?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                        artifact garbage collection
                    </a>
                </li>
                <li>
                    Provide{' '}
                    <a href='https://argo-workflows.readthedocs.io/en/stable/intermediate-inputs/?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                        parameter input{' '}
                    </a>
            ...
            <ul className='new-version-modal-bullets'>
                <li>
                    ...
                    <a href='https://argo-workflows.readthedocs.io/en/stable/plugins/?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                        plugin templates
                    </a>
                    .
                </li>
            ...
            <ul className='new-version-modal-bullets'>
                <li>
                    ...
                    <a href='https://argo-workflows.readthedocs.io/en/stable/client-libraries/?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                ...
                <li>
                    ...
                    <a href='https://argo-workflows.readthedocs.io/en/stable/http-template/?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                        HTTP template
                    </a>
                    .
                </li>
            ...
            <ul className='new-version-modal-bullets'>
                <li>
                    ...
                    <a href='https://argo-workflows.readthedocs.io/en/stable/container-set-template/?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                ...
                <li>
                    ...
                    <a href='https://argo-workflows.readthedocs.io/en/stable/data-sourcing-and-transformation/?utm_source=argo-ui' target='_blank' rel='noreferrer'>
                        data templates
                    </a>
                    .
                </li>
                <li>
                    ...
                    <a href='https://argo-workflows.readthedocs.io/en/stable/variables/?utm_source=argo-ui#expression' target='_blank' rel='noreferrer'>
