            ...
            <p>
                ...
                {podName && podNamesToNodeIDs.get(podName) && (
                    <>
                        ...
                        <a href={services.workflows.getArtifactLogsPath(workflow, podNamesToNodeIDs.get(podName), selectedContainer, archived)} target='_blank' rel='noreferrer'>logs from the artifacts</a>.
                    </>
                )}
