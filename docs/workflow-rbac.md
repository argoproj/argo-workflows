...
For the API methods you can take for reference a matching between create, update, list, delete and patch privilegies to what would be POST ( and POST), GET, DELETE AND PUT respectively.
