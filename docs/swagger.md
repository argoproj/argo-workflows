...
| volumeGC | [io.argoproj.workflow.v1alpha1.VolumeClaimGC](#io.argoproj.workflow.v1alpha1.volumeclaimgc) | VolumeClaimGC describes the strategy to use when to deleting volumes from completed workflows | No |
