...
#### io.argoproj.workflow.v1alpha1.VolumeGC
...
| volumeGC | [io.argoproj.workflow.v1alpha1.VolumeGC](#io.argoproj.workflow.v1alpha1.volumegc) | VolumeGC describes the strategy to use when to deleting volumes from completed workflows | No |
