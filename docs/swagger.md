...
| timeoutDuration | [io.k8s.apimachinery.pkg.util.intstr.IntOrString](#io.k8s.apimachinery.pkg.util.intstr.intorstring) | Max duration allows for the node execution from node StartTime. This duration includes node pending state also. This duration will not be applied on Step and DAG type Templates | No |
