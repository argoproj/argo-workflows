...
| `SEMAPHORE_WAITING_HOLDERS_DISPLAY_LIMIT`| `int`               | `10`                                                                                        | Maximum number of holders to display in semaphore waiting status. This helps reduce memory usage when many workflows are holding the same semaphore. Set to 0 or negative to disable limit (show all holders).                                                                                                                          |
