...
| `CACHE_GC_PERIOD` | `time.Duration` | | How often to perform memoization cache GC. |
| `CACHE_GC_AFTER_NOT_HIT_DURATION` | `time.Duration` | | When a memoization cache has not been hit after this duration, it will be deleted. |
