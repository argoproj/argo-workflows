...
| `ARGO_AGENT_S3_UPLOAD_THREADS`           | `int`               | `4`                                                                                         | Number of threads for artifact upload through S3. Default: 4.                                                                                                                                                                                                            |
| `ARGO_AGENT_S3_UPLOAD_PART_SIZE_MIB`     | `int`               | ``                                                                                          | Size in MiB of the part of a Multipart upload. Default: let MinIO calculate automatically (16 MiB for file <= 156 GiB).                                                                                                                                                     |
