...
Many of the Argo examples used in this walk-through are available in the [`examples` directory](https://github.com/argoproj/argo-workflows/tree/master/examples) on GitHub. If you like this project, please give us a star!
