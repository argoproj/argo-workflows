...
Here are the steps to follow:
  ...
  1. Modify your hosts file and set up a Kubernetes cluster according to [Running Locally](https://argo-workflows.readthedocs.io/en/release-3.5.2/running-locally/). Don't worry about the other instructions.
