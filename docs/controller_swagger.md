...
# The API for a controller plugin.
...
|---------|---------|--------|---------|
| POST | /api/v1/parameters.add | [add parameters](#add-parameters) |  |
| POST | /api/v1/node.postExecute | [node post execute](#node-post-execute) |  |
| POST | /api/v1/node.preExecute | [node pre execute](#node-pre-execute) |  |
| POST | /api/v1/workflow.postOperate | [workflow post operate](#workflow-post-operate) |  |
| POST | /api/v1/workflow.preOperate | [workflow pre operate](#workflow-pre-operate) |  |
  


## Paths

### <span id="add-parameters"></span> add parameters (*addParameters*)

```
POST /api/v1/parameters.add
```
...
|------|--------|------|---------|-----------| :------: |---------|-------------|
| Body | `body` | [ParameterPreSubstitutionArgs](#parameter-pre-substitution-args) | `models.ParameterPreSubstitutionArgs` | | ✓ | |  |

#### All responses
| Code | Status | Description | Has headers | Schema |
|------|--------|-------------|:-----------:|--------|
| [200](#add-parameters-200) | OK |  |  | [schema](#add-parameters-200-schema) |

#### Responses


##### <span id="add-parameters-200"></span> 200
Status: OK

###### <span id="add-parameters-200-schema"></span> Schema
   
  

[ParameterPreSubstitutionReply](#parameter-pre-substitution-reply)

### <span id="node-post-execute"></span> node post execute (*nodePostExecute*)

```
POST /api/v1/node.postExecute
```
...
| Name | Source | Type | Go type | Separator | Required | Default | Description |
|------|--------|------|---------|-----------| :------: |---------|-------------|
| Body | `body` | [NodePostExecuteArgs](#node-post-execute-args) | `models.NodePostExecuteArgs` | | ✓ | |  |

#### All responses
| Code | Status | Description | Has headers | Schema |
|------|--------|-------------|:-----------:|--------|
| [200](#node-post-execute-200) | OK |  |  | [schema](#node-post-execute-200-schema) |

#### Responses


##### <span id="node-post-execute-200"></span> 200
Status: OK

###### <span id="node-post-execute-200-schema"></span> Schema
   
  

[NodePostExecuteReply](#node-post-execute-reply)

### <span id="node-pre-execute"></span> node pre execute (*nodePreExecute*)

```
POST /api/v1/node.preExecute
```
...
| Name | Source | Type | Go type | Separator | Required | Default | Description |
|------|--------|------|---------|-----------| :------: |---------|-------------|
| Body | `body` | [NodePreExecuteArgs](#node-pre-execute-args) | `models.NodePreExecuteArgs` | | ✓ | |  |

#### All responses
| Code | Status | Description | Has headers | Schema |
|------|--------|-------------|:-----------:|--------|
| [200](#node-pre-execute-200) | OK |  |  | [schema](#node-pre-execute-200-schema) |

#### Responses


##### <span id="node-pre-execute-200"></span> 200
Status: OK

###### <span id="node-pre-execute-200-schema"></span> Schema
   
  

[NodePreExecuteReply](#node-pre-execute-reply)

### <span id="workflow-post-operate"></span> workflow post operate (*workflowPostOperate*)

```
POST /api/v1/workflow.postOperate
```
...
| Name | Source | Type | Go type | Separator | Required | Default | Description |
|------|--------|------|---------|-----------| :------: |---------|-------------|
| Body | `body` | [WorkflowPreOperateArgs](#workflow-pre-operate-args) | `models.WorkflowPreOperateArgs` | | ✓ | |  |

#### All responses
| Code | Status | Description | Has headers | Schema |
|------|--------|-------------|:-----------:|--------|
| [200](#workflow-post-operate-200) | OK |  |  | [schema](#workflow-post-operate-200-schema) |

#### Responses


##### <span id="workflow-post-operate-200"></span> 200
Status: OK

###### <span id="workflow-post-operate-200-schema"></span> Schema
   
  

[WorkflowPreOperateReply](#workflow-pre-operate-reply)

### <span id="workflow-pre-operate"></span> workflow pre operate (*workflowPreOperate*)

```
POST /api/v1/workflow.preOperate
```
...
| Code | Status | Description | Has headers | Schema |
|------|--------|-------------|:-----------:|--------|
| [200](#workflow-pre-operate-200) | OK |  |  | [schema](#workflow-pre-operate-200-schema) |

#### Responses


##### <span id="workflow-pre-operate-200"></span> 200
Status: OK

###### <span id="workflow-pre-operate-200-schema"></span> Schema
...
### <span id="node-post-execute-args"></span> NodePostExecuteArgs
...
| Name | Type | Go type | Required | Default | Description | Example |
|------|------|---------|:--------:| ------- |-------------|---------|
| new | [NodeStatus](#node-status)| `NodeStatus` |  | |  |  |
| old | [NodeStatus](#node-status)| `NodeStatus` |  | |  |  |
| template | [Template](#template)| `Template` |  | |  |  |
| workflow | [Workflow](#workflow)| `Workflow` |  | |  |  |



### <span id="node-post-execute-reply"></span> NodePostExecuteReply
...
### <span id="node-pre-execute-args"></span> NodePreExecuteArgs
...
| Name | Type | Go type | Required | Default | Description | Example |
|------|------|---------|:--------:| ------- |-------------|---------|
| node | [NodeStatus](#node-status)| `NodeStatus` | ✓ | |  |  |
| template | [Template](#template)| `Template` | ✓ | |  |  |
| workflow | [Workflow](#workflow)| `Workflow` | ✓ | |  |  |



### <span id="node-pre-execute-reply"></span> NodePreExecuteReply
...
### <span id="parameter-pre-substitution-args"></span> ParameterPreSubstitutionArgs
...
### <span id="parameter-pre-substitution-reply"></span> ParameterPreSubstitutionReply
...
### <span id="workflow-pre-operate-args"></span> WorkflowPreOperateArgs
...
### <span id="workflow-pre-operate-reply"></span> WorkflowPreOperateReply
