...
| dataTransferProtection | string| `string` |  | | DataTransferProtection is the protection level for HDFS data transfer.</br>It corresponds to the dfs.data.transfer.protection configuration in HDFS.</br>It can be one of the following values: "authentication", "integrity", "privacy", or empty. |  |
