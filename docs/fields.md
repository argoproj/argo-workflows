...
|`pendingTimeout`|`string`|PendingTimeout allows to set the maximum time spent in pending status counting from the node's start time. This duration may not be applied to Step or DAG templates.|
