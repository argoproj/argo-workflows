...
|`nodeName`|`string`|NodeName is a selector which will result in all pods of the workflow to be scheduled on the selected node(s). This can be overridden by a nodeName specified in the template.|
