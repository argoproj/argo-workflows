...
| `Agent`                    | [`AgentConfig`](#agentconfig)                                                                               | Agent contains configuration for agent pods                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
|       Field Name        |                                                            Field Type                                                             |                                                                                          Description                                                                                           |
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `Resources`             | [`apiv1.ResourceRequirements`](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#resourcerequirements-v1-core) | Main container resource configuration                                                                                                                                                          |
| `SecurityContext`       | [`apiv1.SecurityContext`](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#securitycontext-v1-core)           | Main container security context                                                                                                                                                                |
| `RunMultipleWorkflow`   | `bool`                                                                                                                            | RunMultipleWorkflow enables sharing agent pod between workflows When true, agent pod is named: argo-agent-${serviceAccountName} When false, agent pod is named: ${workflowName}-agent          |
| `DeleteAfterCompletion` | `bool`                                                                                                                            | DeleteAfterCompletion determines if agent pod should be deleted after workflow completes Only applies when RunMultipleWorkflow is true When false, agent pod persists for subsequent workflows |
| `CreatePod`             | `bool`                                                                                                                            | CreatePod determines if controller should create agent pods When false, external operator/agent manages pods, controller only updates TaskSets                                                 |
