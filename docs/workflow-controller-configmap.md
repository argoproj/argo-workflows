...
| `LogoutRedirectURL`    | `string`                                                                                                                    | LogoutRedirectURL is the absolute URL to redirect to after logout and use for OIDC provider logout when SSO auth mode is enabled |
