...
| `HiddenColumns`            | `Array<string>`                                                                                             | HiddenColumns is a list of default columns to hide from the Workflow List View. Supported values: `name`, `namespace`, `started`, `finished`, `duration`, `progress`, `message`, `details`, `archived`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     |
