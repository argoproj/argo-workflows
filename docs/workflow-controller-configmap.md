...
| `WorkflowTemplateNotFoundGracePeriod` | [`metav1.Duration`](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.32/#duration-v1-meta)  | WorkflowTemplateNotFoundGracePeriod is how long, measured from a Workflow's creation, it is kept Pending and retried while its referenced WorkflowTemplate is not yet available (e.g. applied together via GitOps, or informer cache lag) before being failed. Defaults to 30 seconds.                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
