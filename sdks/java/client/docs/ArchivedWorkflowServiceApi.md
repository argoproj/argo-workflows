...
[**archivedWorkflowServiceDeleteArchivedWorkflowWithHttpInfo**](ArchivedWorkflowServiceApi.md#archivedWorkflowServiceDeleteArchivedWorkflowWithHttpInfo) | **DELETE** /api/v1/archived-workflows/{uid} | 
...
[**archivedWorkflowServiceGetArchivedWorkflowWithHttpInfo**](ArchivedWorkflowServiceApi.md#archivedWorkflowServiceGetArchivedWorkflowWithHttpInfo) | **GET** /api/v1/archived-workflows/{uid} | 
...
[**archivedWorkflowServiceListArchivedWorkflowLabelKeysWithHttpInfo**](ArchivedWorkflowServiceApi.md#archivedWorkflowServiceListArchivedWorkflowLabelKeysWithHttpInfo) | **GET** /api/v1/archived-workflows-label-keys | 
...
[**archivedWorkflowServiceListArchivedWorkflowLabelValuesWithHttpInfo**](ArchivedWorkflowServiceApi.md#archivedWorkflowServiceListArchivedWorkflowLabelValuesWithHttpInfo) | **GET** /api/v1/archived-workflows-label-values | 
...
[**archivedWorkflowServiceListArchivedWorkflowsWithHttpInfo**](ArchivedWorkflowServiceApi.md#archivedWorkflowServiceListArchivedWorkflowsWithHttpInfo) | **GET** /api/v1/archived-workflows | 
...
[**archivedWorkflowServiceResubmitArchivedWorkflowWithHttpInfo**](ArchivedWorkflowServiceApi.md#archivedWorkflowServiceResubmitArchivedWorkflowWithHttpInfo) | **PUT** /api/v1/archived-workflows/{uid}/resubmit | 
...
[**archivedWorkflowServiceRetryArchivedWorkflowWithHttpInfo**](ArchivedWorkflowServiceApi.md#archivedWorkflowServiceRetryArchivedWorkflowWithHttpInfo) | **PUT** /api/v1/archived-workflows/{uid}/retry | 
...
## archivedWorkflowServiceDeleteArchivedWorkflowWithHttpInfo

> ApiResponse<Object> archivedWorkflowServiceDeleteArchivedWorkflow archivedWorkflowServiceDeleteArchivedWorkflowWithHttpInfo(uid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String uid = "uid_example"; // String | 
        try {
            ApiResponse<Object> response = apiInstance.archivedWorkflowServiceDeleteArchivedWorkflowWithHttpInfo(uid);
...
## archivedWorkflowServiceGetArchivedWorkflowWithHttpInfo

> ApiResponse<IoArgoprojWorkflowV1alpha1Workflow> archivedWorkflowServiceGetArchivedWorkflow archivedWorkflowServiceGetArchivedWorkflowWithHttpInfo(uid)
...
public class Example {
    public static void main(String[] args) {
        ...
        String uid = "uid_example"; // String | 
        try {
            ApiResponse<IoArgoprojWorkflowV1alpha1Workflow> response = apiInstance.archivedWorkflowServiceGetArchivedWorkflowWithHttpInfo(uid);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
## archivedWorkflowServiceListArchivedWorkflowLabelKeysWithHttpInfo

> ApiResponse<IoArgoprojWorkflowV1alpha1LabelKeys> archivedWorkflowServiceListArchivedWorkflowLabelKeys archivedWorkflowServiceListArchivedWorkflowLabelKeysWithHttpInfo()
...
public class Example {
    public static void main(String[] args) {
        ...
        ArchivedWorkflowServiceApi apiInstance = new ArchivedWorkflowServiceApi(defaultClient);
        try {
            ApiResponse<IoArgoprojWorkflowV1alpha1LabelKeys> response = apiInstance.archivedWorkflowServiceListArchivedWorkflowLabelKeysWithHttpInfo();
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**IoArgoprojWorkflowV1alpha1LabelKeys**](IoArgoprojWorkflowV1alpha1LabelKeys.md)>
...
ApiResponse<[**IoArgoprojWorkflowV1alpha1LabelValues**](IoArgoprojWorkflowV1alpha1LabelValues.md)>
...
## archivedWorkflowServiceListArchivedWorkflowsWithHttpInfo

> ApiResponse<IoArgoprojWorkflowV1alpha1WorkflowList> archivedWorkflowServiceListArchivedWorkflows archivedWorkflowServiceListArchivedWorkflowsWithHttpInfo(listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, namePrefix)
...
## archivedWorkflowServiceResubmitArchivedWorkflowWithHttpInfo

> ApiResponse<IoArgoprojWorkflowV1alpha1Workflow> archivedWorkflowServiceResubmitArchivedWorkflow archivedWorkflowServiceResubmitArchivedWorkflowWithHttpInfo(uid, body)
...
## archivedWorkflowServiceRetryArchivedWorkflowWithHttpInfo

> ApiResponse<IoArgoprojWorkflowV1alpha1Workflow> archivedWorkflowServiceRetryArchivedWorkflow archivedWorkflowServiceRetryArchivedWorkflowWithHttpInfo(uid, body)
