...
**multiclusterResource** | **Object** | Item expands a single workflow step into multiple parallel steps The value of Item can be a map, string, bool, or number |  [optional]
