...
**executorPlugins** | [**List&lt;IoArgoprojWorkflowV1alpha1ExecutorPlugin&gt;**](IoArgoprojWorkflowV1alpha1ExecutorPlugin.md) | ExecutorPlugins specifies a list of executor plugins at the workflow level. If any plugin is defined here, the corresponding settings from the ConfigMap are ignored. |  [optional]
