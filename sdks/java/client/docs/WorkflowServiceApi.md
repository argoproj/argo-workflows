...
[**workflowServiceListK8SAndArchivedWorkflows**](WorkflowServiceApi.md#workflowServiceListK8SAndArchivedWorkflows) | **GET** /api/v1/k8s-archived-workflows/{namespace} | 
...
<a name="workflowServiceListK8SAndArchivedWorkflows"></a>
# **workflowServiceListK8SAndArchivedWorkflows**
> IoArgoprojWorkflowV1alpha1WorkflowList workflowServiceListK8SAndArchivedWorkflows(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, fields, paginationOptionsWfContinue, paginationOptionsArchivedContinue)
...
public class Example {
  public static void main(String[] args) {
    ...
    String paginationOptionsWfContinue = "paginationOptionsWfContinue_example"; // String | 
    String paginationOptionsArchivedContinue = "paginationOptionsArchivedContinue_example"; // String | 
    try {
      IoArgoprojWorkflowV1alpha1WorkflowList result = apiInstance.workflowServiceListK8SAndArchivedWorkflows(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue, fields, paginationOptionsWfContinue, paginationOptionsArchivedContinue);
      System.out.println(result);
    } catch (ApiException e) {
      System.err.println("Exception when calling WorkflowServiceApi#workflowServiceListK8SAndArchivedWorkflows");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
 ...
 **paginationOptionsWfContinue** | **String**|  | [optional]
 **paginationOptionsArchivedContinue** | **String**|  | [optional]
