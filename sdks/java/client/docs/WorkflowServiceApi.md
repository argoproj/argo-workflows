...
public class Example {
  public static void main(String[] args) {
    ...
    String namePrefix = "namePrefix_example"; // String | Return workflows having this name prefix.
    String namePattern = "namePattern_example"; // String | Return workflows with name containing this value.
    try {
 ...
 **namePrefix** | **String**| Return workflows having this name prefix. | [optional]
 **namePattern** | **String**| Return workflows with name containing this value. | [optional]
