...
public class Example {
  public static void main(String[] args) {
    ...
    IoArgoprojWorkflowV1alpha1UpdateClusterWorkflowTemplateBody body = new IoArgoprojWorkflowV1alpha1UpdateClusterWorkflowTemplateBody(); // IoArgoprojWorkflowV1alpha1UpdateClusterWorkflowTemplateBody | 
    try {
 ...
 **body** | [**IoArgoprojWorkflowV1alpha1UpdateClusterWorkflowTemplateBody**](IoArgoprojWorkflowV1alpha1UpdateClusterWorkflowTemplateBody.md)|  |
