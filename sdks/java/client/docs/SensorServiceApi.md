...
public class Example {
  public static void main(String[] args) {
    ...
    SensorCreateSensorBody body = new SensorCreateSensorBody(); // SensorCreateSensorBody | 
    try {
...
------------- | ------------- | ------------- | -------------
 **namespace** | **String**|  |
 **body** | [**SensorCreateSensorBody**](SensorCreateSensorBody.md)|  |
...
> Object sensorServiceDeleteSensor(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun, deleteOptionsIgnoreStoreReadErrorWithClusterBreakingPotential)
...
> StreamResultOfSensorLogEntry sensorServiceSensorsLogs(namespace, name, triggerName, grep, podLogOptionsContainer, podLogOptionsFollow, podLogOptionsPrevious, podLogOptionsSinceSeconds, podLogOptionsSinceTimeSeconds, podLogOptionsSinceTimeNanos, podLogOptionsTimestamps, podLogOptionsTailLines, podLogOptionsLimitBytes, podLogOptionsInsecureSkipTLSVerifyBackend, podLogOptionsStream)
...
public class Example {
  public static void main(String[] args) {
    ...
    String namespace = "namespace_example"; // String | 
    String name = "name_example"; // String | 
    SensorUpdateSensorBody body = new SensorUpdateSensorBody(); // SensorUpdateSensorBody | 
    try {
 ...
 **namespace** | **String**|  |
 **name** | **String**|  |
 **body** | [**SensorUpdateSensorBody**](SensorUpdateSensorBody.md)|  |
