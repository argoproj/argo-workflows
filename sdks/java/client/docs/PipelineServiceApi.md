...
[**pipelineServiceDeletePipelineWithHttpInfo**](PipelineServiceApi.md#pipelineServiceDeletePipelineWithHttpInfo) | **DELETE** /api/v1/pipelines/{namespace}/{name} | 
[**pipelineServiceGetPipeline**](PipelineServiceApi.md#pipelineServiceGetPipeline) | **GET** /api/v1/pipelines/{namespace}/{name} | 
[**pipelineServiceGetPipelineWithHttpInfo**](PipelineServiceApi.md#pipelineServiceGetPipelineWithHttpInfo) | **GET** /api/v1/pipelines/{namespace}/{name} | 
[**pipelineServiceListPipelines**](PipelineServiceApi.md#pipelineServiceListPipelines) | **GET** /api/v1/pipelines/{namespace} | 
[**pipelineServiceListPipelinesWithHttpInfo**](PipelineServiceApi.md#pipelineServiceListPipelinesWithHttpInfo) | **GET** /api/v1/pipelines/{namespace} | 
[**pipelineServicePipelineLogs**](PipelineServiceApi.md#pipelineServicePipelineLogs) | **GET** /api/v1/stream/pipelines/{namespace}/logs | 
[**pipelineServicePipelineLogsWithHttpInfo**](PipelineServiceApi.md#pipelineServicePipelineLogsWithHttpInfo) | **GET** /api/v1/stream/pipelines/{namespace}/logs | 
...
[**pipelineServiceRestartPipelineWithHttpInfo**](PipelineServiceApi.md#pipelineServiceRestartPipelineWithHttpInfo) | **POST** /api/v1/pipelines/{namespace}/{name}/restart | 
[**pipelineServiceWatchPipelines**](PipelineServiceApi.md#pipelineServiceWatchPipelines) | **GET** /api/v1/stream/pipelines/{namespace} | 
[**pipelineServiceWatchPipelinesWithHttpInfo**](PipelineServiceApi.md#pipelineServiceWatchPipelinesWithHttpInfo) | **GET** /api/v1/stream/pipelines/{namespace} | 
[**pipelineServiceWatchSteps**](PipelineServiceApi.md#pipelineServiceWatchSteps) | **GET** /api/v1/stream/steps/{namespace} | 
[**pipelineServiceWatchStepsWithHttpInfo**](PipelineServiceApi.md#pipelineServiceWatchStepsWithHttpInfo) | **GET** /api/v1/stream/steps/{namespace} | 
...
## pipelineServiceDeletePipelineWithHttpInfo

> ApiResponse<Object> pipelineServiceDeletePipeline pipelineServiceDeletePipelineWithHttpInfo(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun)
...
public class Example {
    public static void main(String[] args) {
        ...
        List<String> deleteOptionsDryRun = Arrays.asList(); // List<String> | When present, indicates that modifications should not be persisted. An invalid or unrecognized dryRun directive will result in an error response and no further processing of the request. Valid values are: - All: all dry run stages will be processed +optional.
        try {
            ApiResponse<Object> response = apiInstance.pipelineServiceDeletePipelineWithHttpInfo(namespace, name, deleteOptionsGracePeriodSeconds, deleteOptionsPreconditionsUid, deleteOptionsPreconditionsResourceVersion, deleteOptionsOrphanDependents, deleteOptionsPropagationPolicy, deleteOptionsDryRun);
...
## pipelineServiceGetPipelineWithHttpInfo

> ApiResponse<GithubComArgoprojLabsArgoDataflowApiV1alpha1Pipeline> pipelineServiceGetPipeline pipelineServiceGetPipelineWithHttpInfo(namespace, name, getOptionsResourceVersion)
...
public class Example {
    public static void main(String[] args) {
        ...
        String getOptionsResourceVersion = "getOptionsResourceVersion_example"; // String | resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional
        try {
            ApiResponse<GithubComArgoprojLabsArgoDataflowApiV1alpha1Pipeline> response = apiInstance.pipelineServiceGetPipelineWithHttpInfo(namespace, name, getOptionsResourceVersion);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**GithubComArgoprojLabsArgoDataflowApiV1alpha1Pipeline**](GithubComArgoprojLabsArgoDataflowApiV1alpha1Pipeline.md)>
...
## pipelineServiceListPipelinesWithHttpInfo

> ApiResponse<GithubComArgoprojLabsArgoDataflowApiV1alpha1PipelineList> pipelineServiceListPipelines pipelineServiceListPipelinesWithHttpInfo(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
ApiResponse<[**GithubComArgoprojLabsArgoDataflowApiV1alpha1PipelineList**](GithubComArgoprojLabsArgoDataflowApiV1alpha1PipelineList.md)>
...
> ApiResponse<StreamResultOfPipelineLogEntry> pipelineServicePipelineLogs pipelineServicePipelineLogsWithHttpInfo(namespace, name, stepName, grep, podLogOptionsContainer, podLogOptionsFollow, podLogOptionsPrevious, podLogOptionsSinceSeconds, podLogOptionsSinceTimeSeconds, podLogOptionsSinceTimeNanos, podLogOptionsTimestamps, podLogOptionsTailLines, podLogOptionsLimitBytes, podLogOptionsInsecureSkipTLSVerifyBackend)
...
public class Example {
    public static void main(String[] args) {
        ...
        Boolean podLogOptionsInsecureSkipTLSVerifyBackend = true; // Boolean | insecureSkipTLSVerifyBackend indicates that the apiserver should not confirm the validity of the serving certificate of the backend it is connecting to.  This will make the HTTPS connection between the apiserver and the backend insecure. This means the apiserver cannot verify the log data it is receiving came from the real kubelet.  If the kubelet is configured to verify the apiserver's TLS credentials, it does not mean the connection to the real kubelet is vulnerable to a man in the middle attack (e.g. an attacker could not intercept the actual log data coming from the real kubelet). +optional.
        try {
            ApiResponse<StreamResultOfPipelineLogEntry> response = apiInstance.pipelineServicePipelineLogsWithHttpInfo(namespace, name, stepName, grep, podLogOptionsContainer, podLogOptionsFollow, podLogOptionsPrevious, podLogOptionsSinceSeconds, podLogOptionsSinceTimeSeconds, podLogOptionsSinceTimeNanos, podLogOptionsTimestamps, podLogOptionsTailLines, podLogOptionsLimitBytes, podLogOptionsInsecureSkipTLSVerifyBackend);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**StreamResultOfPipelineLogEntry**](StreamResultOfPipelineLogEntry.md)>
...
## pipelineServiceRestartPipelineWithHttpInfo

> ApiResponse<Object> pipelineServiceRestartPipeline pipelineServiceRestartPipelineWithHttpInfo(namespace, name)
...
public class Example {
    public static void main(String[] args) {
        ...
        String name = "name_example"; // String | 
        try {
            ApiResponse<Object> response = apiInstance.pipelineServiceRestartPipelineWithHttpInfo(namespace, name);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
public class Example {
    public static void main(String[] args) {
        ...
        String listOptionsContinue = "listOptionsContinue_example"; // String | The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
        try {
            ApiResponse<StreamResultOfPipelinePipelineWatchEvent> response = apiInstance.pipelineServiceWatchPipelinesWithHttpInfo(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**StreamResultOfPipelinePipelineWatchEvent**](StreamResultOfPipelinePipelineWatchEvent.md)>
...
> ApiResponse<StreamResultOfPipelineStepWatchEvent> pipelineServiceWatchSteps pipelineServiceWatchStepsWithHttpInfo(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue)
...
public class Example {
    public static void main(String[] args) {
        ...
        String listOptionsContinue = "listOptionsContinue_example"; // String | The continue option should be set when retrieving more results from the server. Since this value is server defined, clients may only use the continue value from a previous query result with identical query parameters (except for the value of continue) and the server may reject a continue value it does not recognize. If the specified continue value is no longer valid whether due to expiration (generally five to fifteen minutes) or a configuration change on the server, the server will respond with a 410 ResourceExpired error together with a continue token. If the client needs a consistent list, it must restart their list without the continue field. Otherwise, the client may send another list request with the token received with the 410 error, the server will respond with a list starting from the next key, but from the latest snapshot, which is inconsistent from the previous list results - objects that are created, modified, or deleted after the first list request will be included in the response, as long as their keys are after the \"next key\".  This field is not supported when watch is true. Clients may start a watch from the last resourceVersion value returned by the server and not miss any modifications.
        try {
            ApiResponse<StreamResultOfPipelineStepWatchEvent> response = apiInstance.pipelineServiceWatchStepsWithHttpInfo(namespace, listOptionsLabelSelector, listOptionsFieldSelector, listOptionsWatch, listOptionsAllowWatchBookmarks, listOptionsResourceVersion, listOptionsResourceVersionMatch, listOptionsTimeoutSeconds, listOptionsLimit, listOptionsContinue);
            System.out.println("Status code: " + response.getStatusCode());
            System.out.println("Response headers: " + response.getHeaders());
            System.out.println("Response body: " + response.getData());
        } catch (ApiException e) {
...
ApiResponse<[**StreamResultOfPipelineStepWatchEvent**](StreamResultOfPipelineStepWatchEvent.md)>
