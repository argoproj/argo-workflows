...
> Object eventServiceReceiveEvent(namespace, discriminator, payload)
...
public class Example {
  public static void main(String[] args) {
    ...
    Object payload = null; // Object | The event itself can be any data.
    try {
      Object result = apiInstance.eventServiceReceiveEvent(namespace, discriminator, payload);
      System.out.println(result);
    } catch (ApiException e) {
 ...
 **payload** | **Object**| The event itself can be any data. |
