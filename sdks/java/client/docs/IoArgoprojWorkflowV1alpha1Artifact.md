...
**fromMulti** | **String** | FromMulti, if defined, allows an artifact to reference multi artifacts from a previous loop step |  [optional]
...
**pathMulti** | **String** | PathMulti, if defined, is the container path template with {{index}} to the multi artifacts |  [optional]
