...
public class IoArgoprojWorkflowV1alpha1S3ArtifactRepository {
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository accessKeySecret(io.kubernetes.client.openapi.models.V1SecretKeySelector accessKeySecret) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository bucket(String bucket) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository createBucketIfNotPresent(IoArgoprojWorkflowV1alpha1CreateS3BucketOptions createBucketIfNotPresent) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository encryptionOptions(IoArgoprojWorkflowV1alpha1S3EncryptionOptions encryptionOptions) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository endpoint(String endpoint) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository insecure(Boolean insecure) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository keyFormat(String keyFormat) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository keyPrefix(String keyPrefix) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository region(String region) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository roleARN(String roleARN) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository secretKeySecret(io.kubernetes.client.openapi.models.V1SecretKeySelector secretKeySecret) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1S3ArtifactRepository useSDKCreds(Boolean useSDKCreds) {
