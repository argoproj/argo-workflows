...
public class IoArgoprojWorkflowV1alpha1CronWorkflowList {
  ...
  public IoArgoprojWorkflowV1alpha1CronWorkflowList apiVersion(String apiVersion) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1CronWorkflowList items(List<IoArgoprojWorkflowV1alpha1CronWorkflow> items) {
  ...
  **/
  ...
  public void setItems(List<IoArgoprojWorkflowV1alpha1CronWorkflow> items) {
    this.items = items;
  }


  public IoArgoprojWorkflowV1alpha1CronWorkflowList kind(String kind) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1CronWorkflowList metadata(io.kubernetes.client.openapi.models.V1ListMeta metadata) {
