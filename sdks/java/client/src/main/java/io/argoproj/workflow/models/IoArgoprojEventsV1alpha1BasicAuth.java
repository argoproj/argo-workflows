...
public class IoArgoprojEventsV1alpha1BasicAuth {
  ...
  public IoArgoprojEventsV1alpha1BasicAuth password(io.kubernetes.client.openapi.models.V1SecretKeySelector password) {
  ...
  **/
  ...
  public IoArgoprojEventsV1alpha1BasicAuth username(io.kubernetes.client.openapi.models.V1SecretKeySelector username) {
