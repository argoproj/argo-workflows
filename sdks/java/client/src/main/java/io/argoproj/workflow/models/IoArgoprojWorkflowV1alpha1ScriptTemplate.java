...
public class IoArgoprojWorkflowV1alpha1ScriptTemplate {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate env(List<io.kubernetes.client.openapi.models.V1EnvVar> env) {
    
    this.env = env;
    return this;
  }

  public IoArgoprojWorkflowV1alpha1ScriptTemplate addEnvItem(io.kubernetes.client.openapi.models.V1EnvVar envItem) {
    if (this.env == null) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate envFrom(List<io.kubernetes.client.openapi.models.V1EnvFromSource> envFrom) {
    
    this.envFrom = envFrom;
    return this;
  }

  public IoArgoprojWorkflowV1alpha1ScriptTemplate addEnvFromItem(io.kubernetes.client.openapi.models.V1EnvFromSource envFromItem) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate lifecycle(io.kubernetes.client.openapi.models.V1Lifecycle lifecycle) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate livenessProbe(io.kubernetes.client.openapi.models.V1Probe livenessProbe) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate ports(List<io.kubernetes.client.openapi.models.V1ContainerPort> ports) {
    
    this.ports = ports;
    return this;
  }

  public IoArgoprojWorkflowV1alpha1ScriptTemplate addPortsItem(io.kubernetes.client.openapi.models.V1ContainerPort portsItem) {
    if (this.ports == null) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate readinessProbe(io.kubernetes.client.openapi.models.V1Probe readinessProbe) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate resources(io.kubernetes.client.openapi.models.V1ResourceRequirements resources) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate securityContext(io.kubernetes.client.openapi.models.V1SecurityContext securityContext) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate startupProbe(io.kubernetes.client.openapi.models.V1Probe startupProbe) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate volumeDevices(List<io.kubernetes.client.openapi.models.V1VolumeDevice> volumeDevices) {
    
    this.volumeDevices = volumeDevices;
    return this;
  }

  public IoArgoprojWorkflowV1alpha1ScriptTemplate addVolumeDevicesItem(io.kubernetes.client.openapi.models.V1VolumeDevice volumeDevicesItem) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ScriptTemplate volumeMounts(List<io.kubernetes.client.openapi.models.V1VolumeMount> volumeMounts) {
    
    this.volumeMounts = volumeMounts;
    return this;
  }

  public IoArgoprojWorkflowV1alpha1ScriptTemplate addVolumeMountsItem(io.kubernetes.client.openapi.models.V1VolumeMount volumeMountsItem) {
