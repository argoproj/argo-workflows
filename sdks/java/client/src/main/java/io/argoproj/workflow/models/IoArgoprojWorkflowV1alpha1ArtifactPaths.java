...
public class IoArgoprojWorkflowV1alpha1ArtifactPaths {
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths archive(IoArgoprojWorkflowV1alpha1ArchiveStrategy archive) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths archiveLogs(Boolean archiveLogs) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths from(String from) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths fromExpression(String fromExpression) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths gcs(IoArgoprojWorkflowV1alpha1GCSArtifact gcs) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths git(IoArgoprojWorkflowV1alpha1GitArtifact git) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths globalName(String globalName) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths hdfs(IoArgoprojWorkflowV1alpha1HDFSArtifact hdfs) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths http(IoArgoprojWorkflowV1alpha1HTTPArtifact http) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths mode(Integer mode) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths name(String name) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths optional(Boolean optional) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths oss(IoArgoprojWorkflowV1alpha1OSSArtifact oss) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths path(String path) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths raw(IoArgoprojWorkflowV1alpha1RawArtifact raw) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths recurseMode(Boolean recurseMode) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths s3(IoArgoprojWorkflowV1alpha1S3Artifact s3) {
  ...
  **/
  ...
  public IoArgoprojWorkflowV1alpha1ArtifactPaths subPath(String subPath) {
