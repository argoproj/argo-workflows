...
pub struct IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList {
    ...
    #[serde(rename = "items")]
    pub items: Vec<crate::models::IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate>,
...
impl IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList {
    ...
    pub fn new(items: Vec<crate::models::IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate>, metadata: crate::models::ListMeta) -> IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateList {
