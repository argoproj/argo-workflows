...
pub struct IoArgoprojWorkflowV1alpha1WorkflowTemplateList {
    ...
    #[serde(rename = "items")]
    pub items: Vec<crate::models::IoArgoprojWorkflowV1alpha1WorkflowTemplate>,
...
impl IoArgoprojWorkflowV1alpha1WorkflowTemplateList {
    ...
    pub fn new(items: Vec<crate::models::IoArgoprojWorkflowV1alpha1WorkflowTemplate>, metadata: crate::models::ListMeta) -> IoArgoprojWorkflowV1alpha1WorkflowTemplateList {
