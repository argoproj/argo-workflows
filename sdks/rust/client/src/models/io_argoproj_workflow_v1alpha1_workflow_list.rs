...
pub struct IoArgoprojWorkflowV1alpha1WorkflowList {
    ...
    #[serde(rename = "items")]
    pub items: Vec<crate::models::IoArgoprojWorkflowV1alpha1Workflow>,
...
impl IoArgoprojWorkflowV1alpha1WorkflowList {
    ...
    pub fn new(items: Vec<crate::models::IoArgoprojWorkflowV1alpha1Workflow>, metadata: crate::models::ListMeta) -> IoArgoprojWorkflowV1alpha1WorkflowList {
