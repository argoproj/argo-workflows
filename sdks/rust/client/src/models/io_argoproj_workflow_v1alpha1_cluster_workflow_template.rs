...
impl IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate {
    ...
    pub fn new(metadata: crate::models::ObjectMeta, spec: crate::models::IoArgoprojWorkflowV1alpha1WorkflowSpec) -> IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate {
