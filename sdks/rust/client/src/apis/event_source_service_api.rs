...
/// struct for passing parameters to the method `create_event_source`
#[derive(Clone, Debug)]
pub struct CreateEventSourceParams {
    pub namespace: String,
    pub body: crate::models::EventsourceCreateEventSourceRequest
}

/// struct for passing parameters to the method `delete_event_source`
#[derive(Clone, Debug)]
pub struct DeleteEventSourceParams {
    pub namespace: String,
    pub name: String,
...
/// struct for passing parameters to the method `event_sources_logs`
#[derive(Clone, Debug)]
pub struct EventSourcesLogsParams {
    pub namespace: String,
...
/// struct for passing parameters to the method `get_event_source`
#[derive(Clone, Debug)]
pub struct GetEventSourceParams {
    pub namespace: String,
    pub name: String
}

/// struct for passing parameters to the method `list_event_sources`
#[derive(Clone, Debug)]
pub struct ListEventSourcesParams {
    pub namespace: String,
...
/// struct for passing parameters to the method `update_event_source`
#[derive(Clone, Debug)]
pub struct UpdateEventSourceParams {
    pub namespace: String,
    pub name: String,
    pub body: crate::models::EventsourceUpdateEventSourceRequest
}

/// struct for passing parameters to the method `watch_event_sources`
#[derive(Clone, Debug)]
pub struct WatchEventSourcesParams {
    pub namespace: String,
    /// A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.
    pub list_options_label_selector: Option<String>,
    /// A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.
...
/// struct for typed successes of method `create_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateEventSourceSuccess {
    Status200(crate::models::IoArgoprojEventsV1alpha1EventSource),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method `delete_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum DeleteEventSourceSuccess {
    Status200(serde_json::Value),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method `event_sources_logs`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum EventSourcesLogsSuccess {
    Status200(crate::models::StreamResultOfEventsourceLogEntry),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method `get_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEventSourceSuccess {
    Status200(crate::models::IoArgoprojEventsV1alpha1EventSource),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method `list_event_sources`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ListEventSourcesSuccess {
    Status200(crate::models::IoArgoprojEventsV1alpha1EventSourceList),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method `update_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum UpdateEventSourceSuccess {
    Status200(crate::models::IoArgoprojEventsV1alpha1EventSource),
    UnknownValue(serde_json::Value),
}

/// struct for typed successes of method `watch_event_sources`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WatchEventSourcesSuccess {
    Status200(crate::models::StreamResultOfEventsourceEventSourceWatchEvent),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `create_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method `delete_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method `event_sources_logs`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum EventSourcesLogsError {
    DefaultResponse(crate::models::GrpcGatewayRuntimeError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `get_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEventSourceError {
    DefaultResponse(crate::models::GrpcGatewayRuntimeError),
    UnknownValue(serde_json::Value),
}

/// struct for typed errors of method `list_event_sources`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method `update_event_source`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method `watch_event_sources`
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum WatchEventSourcesError {
    DefaultResponse(crate::models::GrpcGatewayRuntimeError),
    UnknownValue(serde_json::Value),
}


pub async fn create_event_source(configuration: &configuration::Configuration, params: CreateEventSourceParams) -> Result<ResponseContent<CreateEventSourceSuccess>, Error<CreateEventSourceError>> {
    ...
    let local_var_uri_str = format!("{}/api/v1/event-sources/{namespace}", configuration.base_path, namespace=crate::apis::urlencode(namespace));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<CreateEventSourceSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<CreateEventSourceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn delete_event_source(configuration: &configuration::Configuration, params: DeleteEventSourceParams) -> Result<ResponseContent<DeleteEventSourceSuccess>, Error<DeleteEventSourceError>> {
    // unbox the parameters
    let namespace = params.namespace;
    ...
    let local_var_uri_str = format!("{}/api/v1/event-sources/{namespace}/{name}", configuration.base_path, namespace=crate::apis::urlencode(namespace), name=crate::apis::urlencode(name));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<DeleteEventSourceSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<DeleteEventSourceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn event_sources_logs(configuration: &configuration::Configuration, params: EventSourcesLogsParams) -> Result<ResponseContent<EventSourcesLogsSuccess>, Error<EventSourcesLogsError>> {
    // unbox the parameters
    let namespace = params.namespace;
    let name = params.name;
    let event_source_type = params.event_source_type;
    ...
    let local_var_uri_str = format!("{}/api/v1/stream/event-sources/{namespace}/logs", configuration.base_path, namespace=crate::apis::urlencode(namespace));
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<EventSourcesLogsSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<EventSourcesLogsError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn get_event_source(configuration: &configuration::Configuration, params: GetEventSourceParams) -> Result<ResponseContent<GetEventSourceSuccess>, Error<GetEventSourceError>> {
    // unbox the parameters
    let namespace = params.namespace;
    let name = params.name;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<GetEventSourceSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<GetEventSourceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn list_event_sources(configuration: &configuration::Configuration, params: ListEventSourcesParams) -> Result<ResponseContent<ListEventSourcesSuccess>, Error<ListEventSourcesError>> {
    // unbox the parameters
    let namespace = params.namespace;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<ListEventSourcesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<ListEventSourcesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn update_event_source(configuration: &configuration::Configuration, params: UpdateEventSourceParams) -> Result<ResponseContent<UpdateEventSourceSuccess>, Error<UpdateEventSourceError>> {
    // unbox the parameters
    let namespace = params.namespace;
    let name = params.name;
    let body = params.body;
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<UpdateEventSourceSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<UpdateEventSourceError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}

pub async fn watch_event_sources(configuration: &configuration::Configuration, params: WatchEventSourcesParams) -> Result<ResponseContent<WatchEventSourcesSuccess>, Error<WatchEventSourcesError>> {
    // unbox the parameters
    let namespace = params.namespace;
    let list_options_label_selector = params.list_options_label_selector;
    let list_options_field_selector = params.list_options_field_selector;
    ...
    let local_var_uri_str = format!("{}/api/v1/stream/event-sources/{namespace}", configuration.base_path, namespace=crate::apis::urlencode(namespace));
    let mut local_var_req_builder = local_var_client.request(reqwest::Method::GET, local_var_uri_str.as_str());
    ...
    if !local_var_status.is_client_error() && !local_var_status.is_server_error() {
        let local_var_entity: Option<WatchEventSourcesSuccess> = serde_json::from_str(&local_var_content).ok();
        let local_var_result = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Ok(local_var_result)
    } else {
        let local_var_entity: Option<WatchEventSourcesError> = serde_json::from_str(&local_var_content).ok();
        let local_var_error = ResponseContent { status: local_var_status, content: local_var_content, entity: local_var_entity };
        Err(Error::ResponseError(local_var_error))
    }
}
