...
> crate::models::IoArgoprojEventsV1alpha1Sensor create_sensor(namespace, body)
...
**body** | [**SensorCreateSensorRequest**](SensorCreateSensorRequest.md) |  | [required] |

### Return type

[**crate::models::IoArgoprojEventsV1alpha1Sensor**](io.argoproj.events.v1alpha1.Sensor.md)
...
> serde_json::Value delete_sensor(namespace, name, delete_options_grace_period_seconds, delete_options_preconditions_uid, delete_options_preconditions_resource_version, delete_options_orphan_dependents, delete_options_propagation_policy, delete_options_dry_run)
...
> crate::models::IoArgoprojEventsV1alpha1Sensor get_sensor(namespace, name, get_options_resource_version)
...
> crate::models::IoArgoprojEventsV1alpha1SensorList list_sensors(namespace, list_options_label_selector, list_options_field_selector, list_options_watch, list_options_allow_watch_bookmarks, list_options_resource_version, list_options_resource_version_match, list_options_timeout_seconds, list_options_limit, list_options_continue)
...
[**crate::models::IoArgoprojEventsV1alpha1SensorList**](io.argoproj.events.v1alpha1.SensorList.md)
...
> crate::models::StreamResultOfSensorLogEntry sensors_logs(namespace, name, trigger_name, grep, pod_log_options_container, pod_log_options_follow, pod_log_options_previous, pod_log_options_since_seconds, pod_log_options_since_time_seconds, pod_log_options_since_time_nanos, pod_log_options_timestamps, pod_log_options_tail_lines, pod_log_options_limit_bytes, pod_log_options_insecure_skip_tls_verify_backend)
...
[**crate::models::StreamResultOfSensorLogEntry**](Stream_result_of_sensor_LogEntry.md)
...
> crate::models::IoArgoprojEventsV1alpha1Sensor update_sensor(namespace, name, body)
...
**namespace** | **String** |  | [required] |
**name** | **String** |  | [required] |
**body** | [**SensorUpdateSensorRequest**](SensorUpdateSensorRequest.md) |  | [required] |
...
> crate::models::StreamResultOfSensorSensorWatchEvent watch_sensors(namespace, list_options_label_selector, list_options_field_selector, list_options_watch, list_options_allow_watch_bookmarks, list_options_resource_version, list_options_resource_version_match, list_options_timeout_seconds, list_options_limit, list_options_continue)
...
[**crate::models::StreamResultOfSensorSensorWatchEvent**](Stream_result_of_sensor_SensorWatchEvent.md)
