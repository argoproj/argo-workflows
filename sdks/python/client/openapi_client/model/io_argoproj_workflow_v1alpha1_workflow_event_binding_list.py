...
def lazy_import():
    ...
    globals()['IoArgoprojWorkflowV1alpha1WorkflowEventBinding'] = IoArgoprojWorkflowV1alpha1WorkflowEventBinding
    globals()['ListMeta'] = ListMeta


class IoArgoprojWorkflowV1alpha1WorkflowEventBindingList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([IoArgoprojWorkflowV1alpha1WorkflowEventBinding],),  # noqa: E501
    ...
    def _from_openapi_data(cls, items, metadata, *args, **kwargs):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1WorkflowEventBindingList - a model defined in OpenAPI
