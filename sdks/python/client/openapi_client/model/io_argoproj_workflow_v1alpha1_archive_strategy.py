...
def lazy_import():
    ...
    globals()['IoArgoprojWorkflowV1alpha1TarStrategy'] = IoArgoprojWorkflowV1alpha1TarStrategy


class IoArgoprojWorkflowV1alpha1ArchiveStrategy(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            '_none': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
            'tar': (IoArgoprojWorkflowV1alpha1TarStrategy,),  # noqa: E501
            'zip': (bool, date, datetime, dict, float, int, list, str, none_type,),  # noqa: E501
        }
