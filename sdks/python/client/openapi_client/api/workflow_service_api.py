...
class WorkflowServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __workflow_service_create_workflow(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.workflow_service_create_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}',
                'operation_id': 'workflow_service_create_workflow',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            callable=__workflow_service_create_workflow
        )

        def __workflow_service_delete_workflow(
            self,
            namespace,
            name,
            **kwargs
        ...
        self.workflow_service_delete_workflow = _Endpoint(
            settings={
                'response_type': (bool, date, datetime, dict, float, int, list, str, none_type,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}',
                'operation_id': 'workflow_service_delete_workflow',
                'http_method': 'DELETE',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_delete_workflow
        )

        def __workflow_service_get_workflow(
            self,
            namespace,
            name,
            **kwargs
        ...
        self.workflow_service_get_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}',
            ...
            api_client=api_client,
            callable=__workflow_service_get_workflow
        )

        def __workflow_service_lint_workflow(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.workflow_service_lint_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/lint',
                'operation_id': 'workflow_service_lint_workflow',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_lint_workflow
        )

        def __workflow_service_list_workflows(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.workflow_service_list_workflows = _Endpoint(
            settings={
            ...
            api_client=api_client,
            callable=__workflow_service_list_workflows
        )

        def __workflow_service_pod_logs(
            self,
            namespace,
            name,
            pod_name,
        ...
        self.workflow_service_pod_logs = _Endpoint(
            ...
            api_client=api_client,
            callable=__workflow_service_pod_logs
        )

        def __workflow_service_resubmit_workflow(
            self,
            namespace,
            name,
            body,
        ...
        self.workflow_service_resubmit_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/resubmit',
                'operation_id': 'workflow_service_resubmit_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_resubmit_workflow
        )

        def __workflow_service_resume_workflow(
            self,
            namespace,
            name,
            body,
        ...
        self.workflow_service_resume_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/resume',
                'operation_id': 'workflow_service_resume_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_resume_workflow
        )

        def __workflow_service_retry_workflow(
            self,
            namespace,
            name,
            body,
        ...
        self.workflow_service_retry_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/retry',
                'operation_id': 'workflow_service_retry_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_retry_workflow
        )

        def __workflow_service_set_workflow(
            self,
            namespace,
            name,
            body,
        ...
        self.workflow_service_set_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/set',
                'operation_id': 'workflow_service_set_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_set_workflow
        )

        def __workflow_service_stop_workflow(
            self,
            namespace,
            name,
            body,
        ...
        self.workflow_service_stop_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/stop',
                'operation_id': 'workflow_service_stop_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_stop_workflow
        )

        def __workflow_service_submit_workflow(
            self,
            namespace,
            body,
            **kwargs
        ...
        self.workflow_service_submit_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/submit',
                'operation_id': 'workflow_service_submit_workflow',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_submit_workflow
        )

        def __workflow_service_suspend_workflow(
            self,
            namespace,
            name,
            body,
        ...
        self.workflow_service_suspend_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/suspend',
                'operation_id': 'workflow_service_suspend_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_suspend_workflow
        )

        def __workflow_service_terminate_workflow(
            self,
            namespace,
            name,
            body,
        ...
        self.workflow_service_terminate_workflow = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/terminate',
                'operation_id': 'workflow_service_terminate_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_terminate_workflow
        )

        def __workflow_service_watch_events(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.workflow_service_watch_events = _Endpoint(
            settings={
                'response_type': (StreamResultOfEvent,),
                'auth': [],
                'endpoint_path': '/api/v1/stream/events/{namespace}',
                'operation_id': 'workflow_service_watch_events',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_watch_events
        )

        def __workflow_service_watch_workflows(
            self,
            namespace,
            **kwargs
        ):
        ...
        self.workflow_service_watch_workflows = _Endpoint(
            ...
            api_client=api_client,
            callable=__workflow_service_watch_workflows
        )

        def __workflow_service_workflow_logs(
            self,
            namespace,
            name,
            **kwargs
        ...
        self.workflow_service_workflow_logs = _Endpoint(
            settings={
                'response_type': (StreamResultOfIoArgoprojWorkflowV1alpha1LogEntry,),
                'auth': [],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/log',
                'operation_id': 'workflow_service_workflow_logs',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
            ...
            api_client=api_client,
            callable=__workflow_service_workflow_logs
        )
