...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1Selector(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1Selector - a model defined in OpenAPI
