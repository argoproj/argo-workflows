...
class IoArgoprojWorkflowV1alpha1RetryConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1RetryConfig - a model defined in OpenAPI
