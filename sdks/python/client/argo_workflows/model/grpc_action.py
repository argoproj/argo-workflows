...
class GRPCAction(ModelNormal):
    ...
    def _from_openapi_data(cls, port, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            service (str): Service is the name of the service to place in the gRPC HealthCheckRequest (see https://github.com/grpc/grpc/blob/master/doc/health-checking.md).  If this is not specified, the default behavior is defined by gRPC.. [optional]  # noqa: E501
        """
