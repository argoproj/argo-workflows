...
class IoArgoprojWorkflowV1alpha1ArtifactList(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, artifacts, *args, **kwargs):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1ArtifactList - a model defined in OpenAPI
