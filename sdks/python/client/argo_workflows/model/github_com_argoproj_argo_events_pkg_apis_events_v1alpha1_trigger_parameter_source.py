...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1TriggerParameterSource(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'context_template': (str,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'context_template': 'contextTemplate',  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1TriggerParameterSource - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            context_key (str): ContextKey is the JSONPath of the event's (JSON decoded) context key ContextKey is a series of keys separated by a dot. A key may contain wildcard characters '*' and '?'. To access an array value use the index as the key. The dot and wildcard characters can be escaped with '\\\\'. See https://github.com/tidwall/gjson#path-syntax for more information on how to use this.. [optional]  # noqa: E501
            context_template (str): [optional]  # noqa: E501
