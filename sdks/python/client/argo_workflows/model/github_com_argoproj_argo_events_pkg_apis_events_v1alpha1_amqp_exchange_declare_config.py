...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1AMQPExchangeDeclareConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1AMQPExchangeDeclareConfig - a model defined in OpenAPI
