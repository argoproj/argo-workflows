...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1OpenWhiskTrigger(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1OpenWhiskTrigger - a model defined in OpenAPI
