...
class IoArgoprojWorkflowV1alpha1ResubmitArchivedWorkflowRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1ResubmitArchivedWorkflowRequest - a model defined in OpenAPI
