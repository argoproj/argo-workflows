...
class GlusterfsVolumeSource(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, endpoints, path, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, endpoints, path, *args, **kwargs):  # noqa: E501
        """GlusterfsVolumeSource - a model defined in OpenAPI
