...
class OwnerReference(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, api_version, kind, name, uid, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, api_version, kind, name, uid, *args, **kwargs):  # noqa: E501
        """OwnerReference - a model defined in OpenAPI
