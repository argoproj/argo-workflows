...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1BasicAuth(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1BasicAuth - a model defined in OpenAPI
