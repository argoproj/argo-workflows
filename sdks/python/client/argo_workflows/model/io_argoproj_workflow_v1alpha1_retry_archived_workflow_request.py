...
class IoArgoprojWorkflowV1alpha1RetryArchivedWorkflowRequest(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1RetryArchivedWorkflowRequest - a model defined in OpenAPI
