...
class IoArgoprojWorkflowV1alpha1Column(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, key, name, type, *args, **kwargs):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1Column - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, key, name, type, *args, **kwargs):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1Column - a model defined in OpenAPI
