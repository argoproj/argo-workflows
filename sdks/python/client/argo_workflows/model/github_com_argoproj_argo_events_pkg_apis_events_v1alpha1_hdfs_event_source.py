...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1HDFSEventSource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1HDFSEventSource - a model defined in OpenAPI
