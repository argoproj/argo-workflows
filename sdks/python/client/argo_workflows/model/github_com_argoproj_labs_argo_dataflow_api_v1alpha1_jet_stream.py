...
class GithubComArgoprojLabsArgoDataflowApiV1alpha1JetStream(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojLabsArgoDataflowApiV1alpha1JetStream - a model defined in OpenAPI
