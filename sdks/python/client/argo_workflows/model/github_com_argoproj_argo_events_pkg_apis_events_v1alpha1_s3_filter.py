...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1S3Filter(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1S3Filter - a model defined in OpenAPI
