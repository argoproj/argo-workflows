...
class IoArgoprojWorkflowV1alpha1Template(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            cluster (str): Cluster is the cluster the task should run it (if supported).. [optional]  # noqa: E501
            ...
            namespace (str): Namespace is the name the task should run it (if supported).. [optional]  # noqa: E501
