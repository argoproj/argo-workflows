...
class IoK8sApiPolicyV1PodDisruptionBudgetSpec(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """IoK8sApiPolicyV1PodDisruptionBudgetSpec - a model defined in OpenAPI
