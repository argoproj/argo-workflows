...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SASLConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1SASLConfig - a model defined in OpenAPI
