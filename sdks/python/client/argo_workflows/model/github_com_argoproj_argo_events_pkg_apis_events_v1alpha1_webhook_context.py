...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1WebhookContext(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1WebhookContext - a model defined in OpenAPI
