...
def lazy_import():
    ...
    globals()['IoArgoprojWorkflowV1alpha1WorkflowStep'] = IoArgoprojWorkflowV1alpha1WorkflowStep


class IoArgoprojWorkflowV1alpha1ParallelSteps(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        """IoArgoprojWorkflowV1alpha1ParallelSteps - a model defined in OpenAPI

        Note that value can be passed either in args or in kwargs, but not in both.

        Args:
            args[0] ([IoArgoprojWorkflowV1alpha1WorkflowStep]):  # noqa: E501

        Keyword Args:
            value ([IoArgoprojWorkflowV1alpha1WorkflowStep]):  # noqa: E501
