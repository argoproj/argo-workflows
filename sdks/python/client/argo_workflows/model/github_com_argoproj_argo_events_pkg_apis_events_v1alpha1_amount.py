...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1Amount(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1Amount - a model defined in OpenAPI
