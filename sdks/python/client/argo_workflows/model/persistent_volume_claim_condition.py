...
class PersistentVolumeClaimCondition(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'type': (str,),  # noqa: E501
            'last_probe_time': (datetime,),  # noqa: E501
    ...
    attribute_map = {
        ...
        'type': 'type',  # noqa: E501
        'last_probe_time': 'lastProbeTime',  # noqa: E501
    ...
    def _from_openapi_data(cls, status, type, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            reason (str): reason is a unique, this should be a short, machine understandable string that gives the reason for condition's last transition. If it reports \"ResizeStarted\" that means the underlying persistent volume is being resized.. [optional]  # noqa: E501
        """
