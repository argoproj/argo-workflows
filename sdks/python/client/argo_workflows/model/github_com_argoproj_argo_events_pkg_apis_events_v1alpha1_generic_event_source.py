...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GenericEventSource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GenericEventSource - a model defined in OpenAPI
