...
class VolumeDevice(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, device_path, name, *args, **kwargs):  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, device_path, name, *args, **kwargs):  # noqa: E501
        """VolumeDevice - a model defined in OpenAPI
