...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1TLSConfig(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1TLSConfig - a model defined in OpenAPI
