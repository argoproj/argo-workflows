...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1Condition(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1Condition - a model defined in OpenAPI
