...
class IoArgoprojWorkflowV1alpha1DAGTask(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            priority (int): Priority is used if controller is configured to process limited number of tasks in parallel. Tasks with higher priority are processed first.. [optional]  # noqa: E501
