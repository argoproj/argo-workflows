...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1RedisEventSource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1RedisEventSource - a model defined in OpenAPI
