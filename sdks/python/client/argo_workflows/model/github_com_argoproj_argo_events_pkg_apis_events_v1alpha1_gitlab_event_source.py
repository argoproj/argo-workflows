...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GitlabEventSource(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GitlabEventSource - a model defined in OpenAPI
