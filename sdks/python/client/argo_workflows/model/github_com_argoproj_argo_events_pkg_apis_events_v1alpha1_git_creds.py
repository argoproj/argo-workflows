...
class GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GitCreds(ModelNormal):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """GithubComArgoprojArgoEventsPkgApisEventsV1alpha1GitCreds - a model defined in OpenAPI
