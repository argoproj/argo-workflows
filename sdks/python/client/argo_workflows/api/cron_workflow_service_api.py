...
class CronWorkflowServiceApi:
    ...
    def create_cron_workflow(
        ...
        :type namespace: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1CreateCronWorkflowRequest
        ...
        _param = self._create_cron_workflow_serialize(
            namespace=namespace,
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IoArgoprojWorkflowV1alpha1CronWorkflow",
        }
    ...
    @validate_call
    def create_cron_workflow_with_http_info(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1CreateCronWorkflowRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IoArgoprojWorkflowV1alpha1CronWorkflow]:
        """create_cron_workflow
    ...
    @validate_call
    def create_cron_workflow_without_preload_content(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1CreateCronWorkflowRequest,
        _request_timeout: Union[
    ...
    def _create_cron_workflow_serialize(
        self,
        namespace,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/cron-workflows/{namespace}',
    ...
    def delete_cron_workflow(
        ...
        _param = self._delete_cron_workflow_serialize(
            namespace=namespace,
            name=name,
    ...
    @validate_call
    def delete_cron_workflow_with_http_info(
        self,
        namespace: StrictStr,
        name: StrictStr,
        delete_options_grace_period_seconds: Annotated[Optional[StrictStr], Field(description="The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately. +optional.")] = None,
    ...
    @validate_call
    def delete_cron_workflow_without_preload_content(
        self,
        namespace: StrictStr,
        name: StrictStr,
        delete_options_grace_period_seconds: Annotated[Optional[StrictStr], Field(description="The duration in seconds before the object should be deleted. Value must be non-negative integer. The value zero indicates delete immediately. If this value is nil, the default grace period for the specified type will be used. Defaults to a per object value if not specified. zero means delete immediately. +optional.")] = None,
    ...
    def _delete_cron_workflow_serialize(
        self,
        namespace,
        name,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/cron-workflows/{namespace}/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_cron_workflow(
        ...
        _param = self._get_cron_workflow_serialize(
            namespace=namespace,
            name=name,
    ...
    @validate_call
    def get_cron_workflow_with_http_info(
        self,
        namespace: StrictStr,
        name: StrictStr,
        get_options_resource_version: Annotated[Optional[StrictStr], Field(description="resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional")] = None,
    ...
    @validate_call
    def get_cron_workflow_without_preload_content(
        self,
        namespace: StrictStr,
        name: StrictStr,
        get_options_resource_version: Annotated[Optional[StrictStr], Field(description="resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional")] = None,
    ...
    def _get_cron_workflow_serialize(
        self,
        namespace,
        name,
    ...
    def lint_cron_workflow(
        ...
        :type namespace: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1LintCronWorkflowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._lint_cron_workflow_serialize(
            namespace=namespace,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def lint_cron_workflow_with_http_info(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1LintCronWorkflowRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def lint_cron_workflow_without_preload_content(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1LintCronWorkflowRequest,
        _request_timeout: Union[
    ...
    def _lint_cron_workflow_serialize(
        self,
        namespace,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/cron-workflows/{namespace}/lint',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_cron_workflows(
        ...
        _param = self._list_cron_workflows_serialize(
            namespace=namespace,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IoArgoprojWorkflowV1alpha1CronWorkflowList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_cron_workflows_with_http_info(
        self,
        namespace: StrictStr,
        list_options_label_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.")] = None,
        list_options_field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.")] = None,
    ...
    @validate_call
    def list_cron_workflows_without_preload_content(
        self,
        namespace: StrictStr,
        list_options_label_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.")] = None,
        list_options_field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.")] = None,
    ...
    def _list_cron_workflows_serialize(
        self,
        namespace,
    ...
    def resume_cron_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1CronWorkflowResumeRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._resume_cron_workflow_serialize(
            namespace=namespace,
            name=name,
            body=body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def resume_cron_workflow_with_http_info(
        self,
        namespace: StrictStr,
        name: StrictStr,
        body: IoArgoprojWorkflowV1alpha1CronWorkflowResumeRequest,
    ...
    @validate_call
    def resume_cron_workflow_without_preload_content(
        self,
        namespace: StrictStr,
        name: StrictStr,
        body: IoArgoprojWorkflowV1alpha1CronWorkflowResumeRequest,
    ...
    def _resume_cron_workflow_serialize(
        self,
        namespace,
        name,
        body,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v1/cron-workflows/{namespace}/{name}/resume',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def suspend_cron_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1CronWorkflowSuspendRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._suspend_cron_workflow_serialize(
            namespace=namespace,
            name=name,
            body=body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def suspend_cron_workflow_with_http_info(
        self,
        namespace: StrictStr,
        name: StrictStr,
        body: IoArgoprojWorkflowV1alpha1CronWorkflowSuspendRequest,
    ...
    @validate_call
    def suspend_cron_workflow_without_preload_content(
        self,
        namespace: StrictStr,
        name: StrictStr,
        body: IoArgoprojWorkflowV1alpha1CronWorkflowSuspendRequest,
    ...
    def _suspend_cron_workflow_serialize(
        self,
        namespace,
        name,
        body,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/api/v1/cron-workflows/{namespace}/{name}/suspend',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_cron_workflow(
        ...
        :type name: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1UpdateCronWorkflowRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_cron_workflow_serialize(
            namespace=namespace,
            name=name,
            body=body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_cron_workflow_with_http_info(
        self,
        namespace: StrictStr,
        name: Annotated[StrictStr, Field(description="DEPRECATED: This field is ignored.")],
        body: IoArgoprojWorkflowV1alpha1UpdateCronWorkflowRequest,
    ...
    @validate_call
    def update_cron_workflow_without_preload_content(
        self,
        namespace: StrictStr,
        name: Annotated[StrictStr, Field(description="DEPRECATED: This field is ignored.")],
        body: IoArgoprojWorkflowV1alpha1UpdateCronWorkflowRequest,
    ...
    def _update_cron_workflow_serialize(
        self,
        namespace,
        name,
        body,
