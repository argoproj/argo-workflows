...
class WorkflowTemplateServiceApi:
    ...
    def create_workflow_template(
        ...
        :type namespace: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest
        ...
        _param = self._create_workflow_template_serialize(
            namespace=namespace,
            body=body,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IoArgoprojWorkflowV1alpha1WorkflowTemplate",
        }
    ...
    @validate_call
    def create_workflow_template_with_http_info(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IoArgoprojWorkflowV1alpha1WorkflowTemplate]:
        """create_workflow_template
    ...
    @validate_call
    def create_workflow_template_without_preload_content(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1WorkflowTemplateCreateRequest,
        _request_timeout: Union[
    ...
    def _create_workflow_template_serialize(
        self,
        namespace,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/workflow-templates/{namespace}',
    ...
    def _delete_workflow_template_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/workflow-templates/{namespace}/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_workflow_template(
        ...
        _param = self._get_workflow_template_serialize(
            namespace=namespace,
            name=name,
    ...
    @validate_call
    def get_workflow_template_with_http_info(
        self,
        namespace: StrictStr,
        name: StrictStr,
        get_options_resource_version: Annotated[Optional[StrictStr], Field(description="resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional")] = None,
    ...
    @validate_call
    def get_workflow_template_without_preload_content(
        self,
        namespace: StrictStr,
        name: StrictStr,
        get_options_resource_version: Annotated[Optional[StrictStr], Field(description="resourceVersion sets a constraint on what resource versions a request may be served from. See https://kubernetes.io/docs/reference/using-api/api-concepts/#resource-versions for details.  Defaults to unset +optional")] = None,
    ...
    def _get_workflow_template_serialize(
        self,
        namespace,
        name,
    ...
    def lint_workflow_template(
        ...
        :type namespace: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1WorkflowTemplateLintRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._lint_workflow_template_serialize(
            namespace=namespace,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def lint_workflow_template_with_http_info(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1WorkflowTemplateLintRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def lint_workflow_template_without_preload_content(
        self,
        namespace: StrictStr,
        body: IoArgoprojWorkflowV1alpha1WorkflowTemplateLintRequest,
        _request_timeout: Union[
    ...
    def _lint_workflow_template_serialize(
        self,
        namespace,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/workflow-templates/{namespace}/lint',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_workflow_templates(
        ...
        _param = self._list_workflow_templates_serialize(
            namespace=namespace,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IoArgoprojWorkflowV1alpha1WorkflowTemplateList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def list_workflow_templates_with_http_info(
        self,
        namespace: StrictStr,
        name_pattern: Optional[StrictStr] = None,
        list_options_label_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.")] = None,
    ...
    @validate_call
    def list_workflow_templates_without_preload_content(
        self,
        namespace: StrictStr,
        name_pattern: Optional[StrictStr] = None,
        list_options_label_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.")] = None,
    ...
    def _list_workflow_templates_serialize(
        self,
        namespace,
        name_pattern,
    ...
    def update_workflow_template(
        ...
        :type name: str
        :param body: (required)
        :type body: IoArgoprojWorkflowV1alpha1WorkflowTemplateUpdateRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_workflow_template_serialize(
            namespace=namespace,
            name=name,
            body=body,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_workflow_template_with_http_info(
        self,
        namespace: StrictStr,
        name: Annotated[StrictStr, Field(description="DEPRECATED: This field is ignored.")],
        body: IoArgoprojWorkflowV1alpha1WorkflowTemplateUpdateRequest,
    ...
    @validate_call
    def update_workflow_template_without_preload_content(
        self,
        namespace: StrictStr,
        name: Annotated[StrictStr, Field(description="DEPRECATED: This field is ignored.")],
        body: IoArgoprojWorkflowV1alpha1WorkflowTemplateUpdateRequest,
    ...
    def _update_workflow_template_serialize(
        self,
        namespace,
        name,
        body,
