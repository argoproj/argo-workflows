...
class SensorServiceApi:
    ...
    def create_sensor(
        ...
        :type namespace: str
        :param body: (required)
        :type body: SensorCreateSensorRequest
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IoArgoprojEventsV1alpha1Sensor",
        }
    ...
    def create_sensor_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IoArgoprojEventsV1alpha1Sensor]:
        """create_sensor
    ...
    def _create_sensor_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v1/sensors/{namespace}',
    ...
    def _delete_sensor_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/v1/sensors/{namespace}/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_sensors(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "IoArgoprojEventsV1alpha1SensorList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_sensors_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IoArgoprojEventsV1alpha1SensorList]:
        """list_sensors
    ...
    def sensors_logs(
        self,
        namespace: StrictStr,
        name: Annotated[Optional[StrictStr], Field(description="optional - only return entries for this sensor name.")] = None,
        trigger_name: Annotated[Optional[StrictStr], Field(description="optional - only return entries for this trigger.")] = None,
        grep: Annotated[Optional[StrictStr], Field(description="option - only return entries where `msg` contains this regular expressions.")] = None,
        ...
        :type name: str
        :param trigger_name: optional - only return entries for this trigger.
        ...
        _param = self._sensors_logs_serialize(
            namespace=namespace,
            name=name,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "StreamResultOfSensorLogEntry",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def sensors_logs_with_http_info(
        self,
        namespace: StrictStr,
        name: Annotated[Optional[StrictStr], Field(description="optional - only return entries for this sensor name.")] = None,
        trigger_name: Annotated[Optional[StrictStr], Field(description="optional - only return entries for this trigger.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StreamResultOfSensorLogEntry]:
        """sensors_logs
    ...
    @validate_call
    def sensors_logs_without_preload_content(
        self,
        namespace: StrictStr,
        name: Annotated[Optional[StrictStr], Field(description="optional - only return entries for this sensor name.")] = None,
        trigger_name: Annotated[Optional[StrictStr], Field(description="optional - only return entries for this trigger.")] = None,
    ...
    def _sensors_logs_serialize(
        ...
        if trigger_name is not None:
            ...
            _query_params.append(('triggerName', trigger_name))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/stream/sensors/{namespace}/logs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_sensor(
        ...
        :type name: str
        :param body: (required)
        :type body: SensorUpdateSensorRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def watch_sensors(
        ...
        _param = self._watch_sensors_serialize(
            namespace=namespace,
            list_options_label_selector=list_options_label_selector,
            list_options_field_selector=list_options_field_selector,
            list_options_watch=list_options_watch,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "StreamResultOfSensorSensorWatchEvent",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def watch_sensors_with_http_info(
        self,
        namespace: StrictStr,
        list_options_label_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.")] = None,
        list_options_field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[StreamResultOfSensorSensorWatchEvent]:
        """watch_sensors
    ...
    @validate_call
    def watch_sensors_without_preload_content(
        self,
        namespace: StrictStr,
        list_options_label_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their labels. Defaults to everything. +optional.")] = None,
        list_options_field_selector: Annotated[Optional[StrictStr], Field(description="A selector to restrict the list of returned objects by their fields. Defaults to everything. +optional.")] = None,
    ...
    def _watch_sensors_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/stream/sensors/{namespace}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
