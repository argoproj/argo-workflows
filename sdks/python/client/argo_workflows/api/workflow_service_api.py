...
class WorkflowServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        def __list_workflows_v2(
            self,
            cluster,
            namespace,
            **kwargs
        ):
            """list_workflows_v2  # noqa: E501

            This method makes a synchronous HTTP request by default. To make an
            asynchronous HTTP request, please pass async_req=True

            >>> thread = api.list_workflows_v2(cluster, namespace, async_req=True)
            >>> result = thread.get()
        ...
        self.list_workflows_v2 = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1WorkflowList,),
                'auth': [],
                'endpoint_path': '/api/v2/{cluster}/workflows/{namespace}',
                'operation_id': 'list_workflows_v2',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
