...
class WorkflowServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.approve_workflow_endpoint = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1Workflow,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/api/v1/workflows/{namespace}/{name}/approve',
                'operation_id': 'approve_workflow',
                'http_method': 'PUT',
                'servers': None,
            },
            params_map={
    ...
    def approve_workflow(
        ...
        **kwargs
        ...
        """approve_workflow  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.approve_workflow(namespace, name, body, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['body'] = \
            body
        return self.approve_workflow_endpoint.call_with_http_info(**kwargs)
