...
class WorkflowServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.list_k8_s_and_archived_workflows_endpoint = _Endpoint(
            settings={
                'response_type': (IoArgoprojWorkflowV1alpha1WorkflowList,),
                'auth': [
                    'BearerToken'
                ],
                'endpoint_path': '/api/v1/k8s-archived-workflows/{namespace}',
                'operation_id': 'list_k8_s_and_archived_workflows',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
                'all': [
                    ...
                    'fields',
                    'pagination_options_wf_continue',
                    'pagination_options_archived_continue',
                ],
                'required': [
                    'namespace',
                ],
            ...
            root_map={
                ...
                'attribute_map': {
                    ...
                    'fields': 'fields',
                    'pagination_options_wf_continue': 'paginationOptions.wfContinue',
                    'pagination_options_archived_continue': 'paginationOptions.archivedContinue',
                },
                'location_map': {
                    'namespace': 'path',
                    ...
                    'fields': 'query',
                    'pagination_options_wf_continue': 'query',
                    'pagination_options_archived_continue': 'query',
                },
                'collection_format_map': {
                }
            },
    ...
    def list_k8_s_and_archived_workflows(
        self,
        namespace,
        **kwargs
    ):
        """list_k8_s_and_archived_workflows  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.list_k8_s_and_archived_workflows(namespace, async_req=True)
        >>> result = thread.get()
        ...
        Keyword Args:
            ...
            pagination_options_wf_continue (str): [optional]
            pagination_options_archived_continue (str): [optional]
            _return_http_data_only (bool): response data without head status
                code and headers. Default is True.
            _preload_content (bool): if False, the urllib3.HTTPResponse object
                will be returned without reading/decoding response data.
        ...
        kwargs['namespace'] = \
            namespace
        return self.list_k8_s_and_archived_workflows_endpoint.call_with_http_info(**kwargs)
