...
class IoArgoprojEventsV1alpha1KafkaConsumerGroup(BaseModel):
    """
    IoArgoprojEventsV1alpha1KafkaConsumerGroup
    """ # noqa: E501
    group_name: Optional[StrictStr] = Field(default=None, alias="groupName")
    oldest: Optional[StrictBool] = None
    rebalance_strategy: Optional[StrictStr] = Field(default=None, alias="rebalanceStrategy")
    __properties: ClassVar[List[str]] = ["groupName", "oldest", "rebalanceStrategy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rebalanceStrategy": obj.get("rebalanceStrategy")
        })
        return _obj
