...
class EventsourceLogEntry(BaseModel):
    """
    EventsourceLogEntry
    """ # noqa: E501
    ...
    event_source_type: Optional[StrictStr] = Field(default=None, alias="eventSourceType")
    ...
    __properties: ClassVar[List[str]] = ["eventName", "eventSourceName", "eventSourceType", "level", "msg", "namespace", "time"]
