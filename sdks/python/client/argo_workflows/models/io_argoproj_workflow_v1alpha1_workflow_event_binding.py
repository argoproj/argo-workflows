...
class IoArgoprojWorkflowV1alpha1WorkflowEventBinding(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoArgoprojWorkflowV1alpha1WorkflowEventBindingSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None
        })
        return _obj
