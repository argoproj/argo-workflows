...
class IoArgoprojEventsV1alpha1SensorList(BaseModel):
    """
    IoArgoprojEventsV1alpha1SensorList
    """ # noqa: E501
    items: Optional[List[IoArgoprojEventsV1alpha1Sensor]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [IoArgoprojEventsV1alpha1Sensor.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
