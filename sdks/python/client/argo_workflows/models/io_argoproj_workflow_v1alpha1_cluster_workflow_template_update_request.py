...
class IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplateUpdateRequest(BaseModel):
    """
    ...
    template: Optional[IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "template": IoArgoprojWorkflowV1alpha1ClusterWorkflowTemplate.from_dict(obj["template"]) if obj.get("template") is not None else None
        })
        return _obj
