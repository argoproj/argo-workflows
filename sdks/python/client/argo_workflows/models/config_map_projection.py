...
class ConfigMapProjection(BaseModel):
    ...
    optional: Optional[StrictBool] = Field(default=None, description="Specify whether the ConfigMap or its keys must be defined")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigMapProjection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigMapProjection from a dict"""
        if obj is None:
            return None
