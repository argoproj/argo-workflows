...
class IoArgoprojWorkflowV1alpha1SemaphoreRef(BaseModel):
    """
    SemaphoreRef is a reference of Semaphore
    """ # noqa: E501
    config_map_key_ref: Optional[ConfigMapKeySelector] = Field(default=None, alias="configMapKeyRef")
    namespace: Optional[StrictStr] = Field(default=None, description="Namespace is the namespace of the configmap, default: [namespace of workflow]")
    __properties: ClassVar[List[str]] = ["configMapKeyRef", "namespace"]
