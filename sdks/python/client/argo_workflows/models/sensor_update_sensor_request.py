...
class SensorUpdateSensorRequest(BaseModel):
    """
    SensorUpdateSensorRequest
    """ # noqa: E501
    name: Optional[StrictStr] = None
    namespace: Optional[StrictStr] = None
    sensor: Optional[IoArgoprojEventsV1alpha1Sensor] = None
    __properties: ClassVar[List[str]] = ["name", "namespace", "sensor"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sensor": IoArgoprojEventsV1alpha1Sensor.from_dict(obj["sensor"]) if obj.get("sensor") is not None else None
        })
        return _obj
