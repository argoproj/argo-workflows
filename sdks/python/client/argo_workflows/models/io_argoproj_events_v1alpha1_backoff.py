...
class IoArgoprojEventsV1alpha1Backoff(BaseModel):
    """
    IoArgoprojEventsV1alpha1Backoff
    """ # noqa: E501
    duration: Optional[IoArgoprojEventsV1alpha1Int64OrString] = None
    factor: Optional[IoArgoprojEventsV1alpha1Amount] = None
    jitter: Optional[IoArgoprojEventsV1alpha1Amount] = None
    steps: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["duration", "factor", "jitter", "steps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "duration": IoArgoprojEventsV1alpha1Int64OrString.from_dict(obj["duration"]) if obj.get("duration") is not None else None,
            "factor": IoArgoprojEventsV1alpha1Amount.from_dict(obj["factor"]) if obj.get("factor") is not None else None,
            "jitter": IoArgoprojEventsV1alpha1Amount.from_dict(obj["jitter"]) if obj.get("jitter") is not None else None,
            "steps": obj.get("steps")
        })
        return _obj
