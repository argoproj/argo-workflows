...
class IoArgoprojWorkflowV1alpha1GitArtifact(object):
    ...
    def __init__(self, depth=None, disable_submodules=None, fetch=None, insecure_ignore_host_key=None, password_secret=None, repo=None, revision=None, ssh_private_key_secret=None, username_secret=None, local_vars_configuration=None):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1GitArtifact - a model defined in OpenAPI"""  # noqa: E501
