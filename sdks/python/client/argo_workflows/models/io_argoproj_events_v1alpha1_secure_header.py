...
class IoArgoprojEventsV1alpha1SecureHeader(BaseModel):
    """
    IoArgoprojEventsV1alpha1SecureHeader
    """ # noqa: E501
    name: Optional[StrictStr] = None
    value_from: Optional[IoArgoprojEventsV1alpha1ValueFromSource] = Field(default=None, alias="valueFrom")
    __properties: ClassVar[List[str]] = ["name", "valueFrom"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "valueFrom": IoArgoprojEventsV1alpha1ValueFromSource.from_dict(obj["valueFrom"]) if obj.get("valueFrom") is not None else None
        })
        return _obj
