...
class IoArgoprojEventsV1alpha1Status(BaseModel):
    """
    Status is a common structure which can be used for Status field.
    """ # noqa: E501
    conditions: Optional[List[IoArgoprojEventsV1alpha1Condition]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conditions": [IoArgoprojEventsV1alpha1Condition.from_dict(_item) for _item in obj["conditions"]] if obj.get("conditions") is not None else None
        })
        return _obj
