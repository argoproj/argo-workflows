...
class IoArgoprojWorkflowV1alpha1WorkflowSetRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["message", "name", "namespace", "nodeFieldSelector", "outputParameters", "phase"]
