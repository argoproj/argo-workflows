...
class IoArgoprojWorkflowV1alpha1ResubmitArchivedWorkflowRequest(BaseModel):
    """
    IoArgoprojWorkflowV1alpha1ResubmitArchivedWorkflowRequest
    """ # noqa: E501
    memoized: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    namespace: Optional[StrictStr] = None
    parameters: Optional[List[StrictStr]] = None
    uid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["memoized", "name", "namespace", "parameters", "uid"]
