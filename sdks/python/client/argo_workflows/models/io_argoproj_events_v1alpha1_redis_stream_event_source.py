...
class IoArgoprojEventsV1alpha1RedisStreamEventSource(BaseModel):
    """
    IoArgoprojEventsV1alpha1RedisStreamEventSource
    """ # noqa: E501
    consumer_group: Optional[StrictStr] = Field(default=None, alias="consumerGroup")
    db: Optional[StrictInt] = None
    filter: Optional[IoArgoprojEventsV1alpha1EventSourceFilter] = None
    host_address: Optional[StrictStr] = Field(default=None, alias="hostAddress")
    max_msg_count_per_read: Optional[StrictInt] = Field(default=None, alias="maxMsgCountPerRead")
    metadata: Optional[Dict[str, StrictStr]] = None
    password: Optional[SecretKeySelector] = None
    streams: Optional[List[StrictStr]] = Field(default=None, description="Streams to look for entries. XREADGROUP is used on all streams using a single consumer group.")
    tls: Optional[IoArgoprojEventsV1alpha1TLSConfig] = None
    username: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["consumerGroup", "db", "filter", "hostAddress", "maxMsgCountPerRead", "metadata", "password", "streams", "tls", "username"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "maxMsgCountPerRead": obj.get("maxMsgCountPerRead"),
