...
class IoArgoprojWorkflowV1alpha1Sequence(BaseModel):
    """
    Sequence expands a workflow step into numeric range
    """ # noqa: E501
    count: Optional[StrictStr] = None
    end: Optional[StrictStr] = None
    format: Optional[StrictStr] = Field(default=None, description="Format is a printf format string to format the value in the sequence")
    start: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["count", "end", "format", "start"]
