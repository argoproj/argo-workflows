...
class StreamResultOfIoArgoprojWorkflowV1alpha1WorkflowWatchEvent(BaseModel):
    """
    StreamResultOfIoArgoprojWorkflowV1alpha1WorkflowWatchEvent
    """ # noqa: E501
    error: Optional[GrpcGatewayRuntimeStreamError] = None
    result: Optional[IoArgoprojWorkflowV1alpha1WorkflowWatchEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": IoArgoprojWorkflowV1alpha1WorkflowWatchEvent.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
