...
class IoArgoprojWorkflowV1alpha1WorkflowTaskSetStatus(BaseModel):
    """
    IoArgoprojWorkflowV1alpha1WorkflowTaskSetStatus
    """ # noqa: E501
    nodes: Optional[Dict[str, IoArgoprojWorkflowV1alpha1NodeResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodes": dict(
                (_k, IoArgoprojWorkflowV1alpha1NodeResult.from_dict(_v))
