...
class IoArgoprojWorkflowV1alpha1DAGTask(BaseModel):
    """
    ...
    hooks: Optional[Dict[str, IoArgoprojWorkflowV1alpha1LifecycleHook]] = Field(default=None, description="Hooks hold the lifecycle hook which is invoked at lifecycle of task, irrespective of the success, failure, or error status of the primary task")
...
IoArgoprojWorkflowV1alpha1DAGTask.model_rebuild(raise_errors=False)
