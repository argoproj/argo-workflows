...
class IoArgoprojWorkflowV1alpha1WorkflowWatchEvent(BaseModel):
    """
    IoArgoprojWorkflowV1alpha1WorkflowWatchEvent
    """ # noqa: E501
    object: Optional[IoArgoprojWorkflowV1alpha1Workflow] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": IoArgoprojWorkflowV1alpha1Workflow.from_dict(obj["object"]) if obj.get("object") is not None else None,
            "type": obj.get("type")
        })
        return _obj
