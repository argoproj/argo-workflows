...
class IoArgoprojWorkflowV1alpha1S3Artifact(BaseModel):
    """
    ...
    key: Optional[StrictStr] = Field(default=None, description="Key is the key in the bucket where the artifact resides")
    ...
    __properties: ClassVar[List[str]] = ["accessKeySecret", "bucket", "caSecret", "createBucketIfNotPresent", "encryptionOptions", "endpoint", "insecure", "key", "region", "roleARN", "secretKeySecret", "useSDKCreds"]
