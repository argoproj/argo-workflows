...
class IoArgoprojEventsV1alpha1K8SResourcePolicy(BaseModel):
    """
    IoArgoprojEventsV1alpha1K8SResourcePolicy
    """ # noqa: E501
    backoff: Optional[IoArgoprojEventsV1alpha1Backoff] = None
    error_on_backoff_timeout: Optional[StrictBool] = Field(default=None, alias="errorOnBackoffTimeout")
    labels: Optional[Dict[str, StrictStr]] = None
    __properties: ClassVar[List[str]] = ["backoff", "errorOnBackoffTimeout", "labels"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "backoff": IoArgoprojEventsV1alpha1Backoff.from_dict(obj["backoff"]) if obj.get("backoff") is not None else None,
            "errorOnBackoffTimeout": obj.get("errorOnBackoffTimeout"),
