...
class EventSeries(BaseModel):
    ...
    last_observed_time: Optional[datetime] = Field(default=None, description="MicroTime is version of Time with microsecond level precision.", alias="lastObservedTime")
