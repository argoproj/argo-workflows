...
class AzureFileVolumeSource(BaseModel):
    ...
    secret_name: StrictStr = Field(description="the name of secret that contains Azure Storage Account Name and Key", alias="secretName")
    share_name: StrictStr = Field(description="Share Name", alias="shareName")
