...
class DownwardAPIVolumeFile(object):
    ...
    def __init__(self, field_ref=None, mode=None, path=None, resource_field_ref=None, local_vars_configuration=None):  # noqa: E501
        """DownwardAPIVolumeFile - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def field_ref(self):
        """Gets the field_ref of this DownwardAPIVolumeFile.  # noqa: E501


        :return: The field_ref of this DownwardAPIVolumeFile.  # noqa: E501
    ...
    def field_ref(self, field_ref):
        """Sets the field_ref of this DownwardAPIVolumeFile.


        :param field_ref: The field_ref of this DownwardAPIVolumeFile.  # noqa: E501
    ...
    @property
    def path(self):
        """Gets the path of this DownwardAPIVolumeFile.  # noqa: E501
        ...
        :return: The path of this DownwardAPIVolumeFile.  # noqa: E501
        :rtype: str
        """
        return self._path
    ...
    @path.setter
    def path(self, path):
        """Sets the path of this DownwardAPIVolumeFile.

        Required: Path is  the relative path name of the file to be created. Must not be absolute or contain the '..' path. Must be utf-8 encoded. The first item of the relative path must not start with '..'  # noqa: E501

        :param path: The path of this DownwardAPIVolumeFile.  # noqa: E501
        :type: str
        """
    ...
    def resource_field_ref(self):
        """Gets the resource_field_ref of this DownwardAPIVolumeFile.  # noqa: E501


        :return: The resource_field_ref of this DownwardAPIVolumeFile.  # noqa: E501
        :rtype: ResourceFieldSelector
        """
        return self._resource_field_ref

    @resource_field_ref.setter
    def resource_field_ref(self, resource_field_ref):
        """Sets the resource_field_ref of this DownwardAPIVolumeFile.


        :param resource_field_ref: The resource_field_ref of this DownwardAPIVolumeFile.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DownwardAPIVolumeFile):
            return False
