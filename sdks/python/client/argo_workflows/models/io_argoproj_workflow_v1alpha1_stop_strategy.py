...
class IoArgoprojWorkflowV1alpha1StopStrategy(BaseModel):
    """
    ...
    """ # noqa: E501
    condition: StrictStr = Field(description="Condition defines a condition that stops scheduling workflows when evaluates to true. Use the keywords `failed` or `succeeded` to access the number of failed or successful child workflows.")
