...
class IoArgoprojEventsV1alpha1EventSourceStatus(BaseModel):
    """
    IoArgoprojEventsV1alpha1EventSourceStatus
    """ # noqa: E501
    status: Optional[IoArgoprojEventsV1alpha1Status] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "status": IoArgoprojEventsV1alpha1Status.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
