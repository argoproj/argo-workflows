...
class IoArgoprojEventsV1alpha1NSQEventSource(BaseModel):
    """
    ...
    topic: Optional[StrictStr] = Field(default=None, description="Topic to subscribe to.")
    __properties: ClassVar[List[str]] = ["channel", "connectionBackoff", "filter", "hostAddress", "jsonBody", "metadata", "tls", "topic"]
