...
class IoArgoprojEventsV1alpha1WatchPathConfig(BaseModel):
    """
    IoArgoprojEventsV1alpha1WatchPathConfig
    """ # noqa: E501
    directory: Optional[StrictStr] = None
    path: Optional[StrictStr] = None
    path_regexp: Optional[StrictStr] = Field(default=None, alias="pathRegexp")
    __properties: ClassVar[List[str]] = ["directory", "path", "pathRegexp"]
