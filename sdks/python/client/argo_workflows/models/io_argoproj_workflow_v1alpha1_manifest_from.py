...
class IoArgoprojWorkflowV1alpha1ManifestFrom(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "artifact": IoArgoprojWorkflowV1alpha1Artifact.from_dict(obj["artifact"]) if obj.get("artifact") is not None else None
        })
        return _obj
