...
class IoArgoprojWorkflowV1alpha1S3ArtifactRepository(object):
    ...
    def __init__(self, access_key_secret=None, bucket=None, create_bucket_if_not_present=None, encryption_options=None, endpoint=None, insecure=None, key_format=None, key_prefix=None, region=None, role_arn=None, secret_key_secret=None, use_sdk_creds=None, local_vars_configuration=None):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1S3ArtifactRepository - a model defined in OpenAPI"""  # noqa: E501
