...
class EventsourceUpdateEventSourceRequest(BaseModel):
    """
    EventsourceUpdateEventSourceRequest
    """ # noqa: E501
    event_source: Optional[IoArgoprojEventsV1alpha1EventSource] = Field(default=None, alias="eventSource")
    name: Optional[StrictStr] = None
    namespace: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["eventSource", "name", "namespace"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.event_source:
            _dict['eventSource'] = self.event_source.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "eventSource": IoArgoprojEventsV1alpha1EventSource.from_dict(obj["eventSource"]) if obj.get("eventSource") is not None else None,
            "name": obj.get("name"),
