...
class IoArgoprojWorkflowV1alpha1AzureArtifactRepository(BaseModel):
    """
    AzureArtifactRepository defines the controller configuration for an Azure Blob Storage artifact repository
    """ # noqa: E501
    account_key_secret: Optional[SecretKeySelector] = Field(default=None, alias="accountKeySecret")
    blob_name_format: Optional[StrictStr] = Field(default=None, description="BlobNameFormat is defines the format of how to store blob names. Can reference workflow variables", alias="blobNameFormat")
    ...
    __properties: ClassVar[List[str]] = ["accountKeySecret", "blobNameFormat", "container", "endpoint", "useSDKCreds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accountKeySecret": SecretKeySelector.from_dict(obj["accountKeySecret"]) if obj.get("accountKeySecret") is not None else None,
            "blobNameFormat": obj.get("blobNameFormat"),
