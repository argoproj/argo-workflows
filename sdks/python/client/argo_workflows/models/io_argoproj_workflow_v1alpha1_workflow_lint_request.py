...
class IoArgoprojWorkflowV1alpha1WorkflowLintRequest(BaseModel):
    """
    IoArgoprojWorkflowV1alpha1WorkflowLintRequest
    """ # noqa: E501
    namespace: Optional[StrictStr] = None
    workflow: Optional[IoArgoprojWorkflowV1alpha1Workflow] = None
    __properties: ClassVar[List[str]] = ["namespace", "workflow"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflow": IoArgoprojWorkflowV1alpha1Workflow.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None
        })
        return _obj
