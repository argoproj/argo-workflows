...
class IoArgoprojWorkflowV1alpha1Version(BaseModel):
    """
    ...
    git_tag: StrictStr = Field(alias="gitTag")
    git_tree_state: StrictStr = Field(alias="gitTreeState")
    go_version: StrictStr = Field(alias="goVersion")
    platform: StrictStr
    version: StrictStr
    __properties: ClassVar[List[str]] = ["buildDate", "compiler", "gitCommit", "gitTag", "gitTreeState", "goVersion", "platform", "version"]
