...
class Affinity(BaseModel):
    ...
    """ # noqa: E501
    node_affinity: Optional[NodeAffinity] = Field(default=None, alias="nodeAffinity")
    pod_affinity: Optional[PodAffinity] = Field(default=None, alias="podAffinity")
    pod_anti_affinity: Optional[PodAntiAffinity] = Field(default=None, alias="podAntiAffinity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nodeAffinity": NodeAffinity.from_dict(obj["nodeAffinity"]) if obj.get("nodeAffinity") is not None else None,
            "podAffinity": PodAffinity.from_dict(obj["podAffinity"]) if obj.get("podAffinity") is not None else None,
            "podAntiAffinity": PodAntiAffinity.from_dict(obj["podAntiAffinity"]) if obj.get("podAntiAffinity") is not None else None
        })
        return _obj
