...
class IoArgoprojEventsV1alpha1MQTTEventSource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["auth", "clientId", "connectionBackoff", "filter", "jsonBody", "metadata", "tls", "topic", "url"]
