...
class IoArgoprojWorkflowV1alpha1Parameter(object):
    ...
    def __init__(self, default=None, description=None, enum=None, global_name=None, name=None, value=None, value_from=None, local_vars_configuration=None):  # noqa: E501
        """IoArgoprojWorkflowV1alpha1Parameter - a model defined in OpenAPI"""  # noqa: E501
