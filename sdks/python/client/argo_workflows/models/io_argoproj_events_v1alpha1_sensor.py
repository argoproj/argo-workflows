...
class IoArgoprojEventsV1alpha1Sensor(BaseModel):
    """
    IoArgoprojEventsV1alpha1Sensor
    """ # noqa: E501
    metadata: Optional[ObjectMeta] = None
    spec: Optional[IoArgoprojEventsV1alpha1SensorSpec] = None
    status: Optional[IoArgoprojEventsV1alpha1SensorStatus] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "spec": IoArgoprojEventsV1alpha1SensorSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
            "status": IoArgoprojEventsV1alpha1SensorStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
