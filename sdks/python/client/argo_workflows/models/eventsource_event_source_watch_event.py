...
class EventsourceEventSourceWatchEvent(BaseModel):
    """
    EventsourceEventSourceWatchEvent
    """ # noqa: E501
    object: Optional[IoArgoprojEventsV1alpha1EventSource] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "object": IoArgoprojEventsV1alpha1EventSource.from_dict(obj["object"]) if obj.get("object") is not None else None,
            "type": obj.get("type")
        })
        return _obj
