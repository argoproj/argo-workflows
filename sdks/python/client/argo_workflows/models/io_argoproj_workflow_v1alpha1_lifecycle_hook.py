...
class IoArgoprojWorkflowV1alpha1LifecycleHook(BaseModel):
    """
    ...
    template: Optional[StrictStr] = Field(default=None, description="Template is the name of the template to execute by the hook")
    template_ref: Optional[IoArgoprojWorkflowV1alpha1TemplateRef] = Field(default=None, alias="templateRef")
    __properties: ClassVar[List[str]] = ["arguments", "expression", "template", "templateRef"]
