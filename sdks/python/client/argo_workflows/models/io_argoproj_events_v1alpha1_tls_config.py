...
class IoArgoprojEventsV1alpha1TLSConfig(BaseModel):
    """
    TLSConfig refers to TLS configuration for a client.
    """ # noqa: E501
    ca_cert_secret: Optional[SecretKeySelector] = Field(default=None, alias="caCertSecret")
    ...
    __properties: ClassVar[List[str]] = ["caCertSecret", "clientCertSecret", "clientKeySecret", "insecureSkipVerify"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ca_cert_secret
        if self.ca_cert_secret:
            _dict['caCertSecret'] = self.ca_cert_secret.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "caCertSecret": SecretKeySelector.from_dict(obj["caCertSecret"]) if obj.get("caCertSecret") is not None else None,
