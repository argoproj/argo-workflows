...
class StreamResultOfIoArgoprojWorkflowV1alpha1LogEntry(BaseModel):
    """
    StreamResultOfIoArgoprojWorkflowV1alpha1LogEntry
    """ # noqa: E501
    error: Optional[GrpcGatewayRuntimeStreamError] = None
    result: Optional[IoArgoprojWorkflowV1alpha1LogEntry] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": IoArgoprojWorkflowV1alpha1LogEntry.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
