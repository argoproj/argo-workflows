...
class StreamResultOfEventsourceEventSourceWatchEvent(BaseModel):
    """
    StreamResultOfEventsourceEventSourceWatchEvent
    """ # noqa: E501
    error: Optional[GrpcGatewayRuntimeStreamError] = None
    result: Optional[EventsourceEventSourceWatchEvent] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": GrpcGatewayRuntimeStreamError.from_dict(obj["error"]) if obj.get("error") is not None else None,
            "result": EventsourceEventSourceWatchEvent.from_dict(obj["result"]) if obj.get("result") is not None else None
        })
        return _obj
