...
class IoArgoprojEventsV1alpha1AzureServiceBusTrigger(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["connectionString", "parameters", "payload", "queueName", "subscriptionName", "tls", "topicName"]
