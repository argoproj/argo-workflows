...
class IoArgoprojEventsV1alpha1RedisEventSource(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["channels", "db", "filter", "hostAddress", "jsonBody", "metadata", "namespace", "password", "tls", "username"]
