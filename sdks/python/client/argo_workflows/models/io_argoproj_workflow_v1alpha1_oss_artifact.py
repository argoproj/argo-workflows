...
class IoArgoprojWorkflowV1alpha1OSSArtifact(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["accessKeySecret", "bucket", "createBucketIfNotPresent", "endpoint", "key", "lifecycleRule", "secretKeySecret", "securityToken", "useSDKCreds"]
