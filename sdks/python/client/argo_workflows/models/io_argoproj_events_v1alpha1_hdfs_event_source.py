...
class IoArgoprojEventsV1alpha1HDFSEventSource(BaseModel):
    """
    IoArgoprojEventsV1alpha1HDFSEventSource
    """ # noqa: E501
    addresses: Optional[List[StrictStr]] = None
    check_interval: Optional[StrictStr] = Field(default=None, alias="checkInterval")
    ...
    __properties: ClassVar[List[str]] = ["addresses", "checkInterval", "filter", "hdfsUser", "krbCCacheSecret", "krbConfigConfigMap", "krbKeytabSecret", "krbRealm", "krbServicePrincipalName", "krbUsername", "metadata", "type", "watchPathConfig"]
