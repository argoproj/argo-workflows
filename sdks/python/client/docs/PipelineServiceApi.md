...
[**watch_pipeline_logs**](PipelineServiceApi.md#watch_pipeline_logs) | **GET** /api/v1/stream/pipelines/{namespace}/logs | 
...
# **watch_pipeline_logs**
> StreamResultOfPipelineLogEntry watch_pipeline_logs(namespace)
