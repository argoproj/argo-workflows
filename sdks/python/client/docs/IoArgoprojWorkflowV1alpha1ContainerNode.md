...
io_argoproj_workflow_v1alpha1_container_node_instance = IoArgoprojWorkflowV1alpha1ContainerNode.from_json(json)
# print the JSON string representation of the object
print(IoArgoprojWorkflowV1alpha1ContainerNode.to_json())

# convert the object into a dict
io_argoproj_workflow_v1alpha1_container_node_dict = io_argoproj_workflow_v1alpha1_container_node_instance.to_dict()
# create an instance of IoArgoprojWorkflowV1alpha1ContainerNode from a dict
io_argoproj_workflow_v1alpha1_container_node_form_dict = io_argoproj_workflow_v1alpha1_container_node.from_dict(io_argoproj_workflow_v1alpha1_container_node_dict)
```
