...
managed_fields_entry_instance = ManagedFieldsEntry.from_json(json)
# print the JSON string representation of the object
print(ManagedFieldsEntry.to_json())

# convert the object into a dict
managed_fields_entry_dict = managed_fields_entry_instance.to_dict()
# create an instance of ManagedFieldsEntry from a dict
managed_fields_entry_form_dict = managed_fields_entry.from_dict(managed_fields_entry_dict)
```
