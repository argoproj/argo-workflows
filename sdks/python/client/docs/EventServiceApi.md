...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    api_instance = argo_workflows.EventServiceApi(api_client)
    ...
    try:
        ...
        print("The response of EventServiceApi->list_workflow_event_bindings:\n")
        pprint(api_response)
...
with argo_workflows.ApiClient(configuration) as api_client:
    ...
    try:
        ...
        print("The response of EventServiceApi->receive_event:\n")
        pprint(api_response)
    except Exception as e:
