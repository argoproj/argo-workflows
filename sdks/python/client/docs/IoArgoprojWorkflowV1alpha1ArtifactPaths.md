...
**from_multi** | **str** | FromMulti, if defined, allows an artifact to reference multi artifacts from a previous loop step | [optional] 
...
**path_multi** | **str** | PathMulti, if defined, is the container path template with {{index}} to the multi artifacts | [optional] 
