...
io_argoproj_workflow_v1alpha1_template_instance = IoArgoprojWorkflowV1alpha1Template.from_json(json)
# print the JSON string representation of the object
print(IoArgoprojWorkflowV1alpha1Template.to_json())

# convert the object into a dict
io_argoproj_workflow_v1alpha1_template_dict = io_argoproj_workflow_v1alpha1_template_instance.to_dict()
# create an instance of IoArgoprojWorkflowV1alpha1Template from a dict
io_argoproj_workflow_v1alpha1_template_form_dict = io_argoproj_workflow_v1alpha1_template.from_dict(io_argoproj_workflow_v1alpha1_template_dict)
```
