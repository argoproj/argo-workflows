...
**parallel_transfers** | **int** | ParallelTransfers is the number of parallel transfers to use for S3 operations. If not set, defaults to 1. Can be overridden by ARGO_S3_PARALLEL_TRANSFERS environment variable. | [optional] 
