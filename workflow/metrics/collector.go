...
func NewMetricsRegistry(metricsProvider MetricsProvider, informer cache.SharedIndexInformer, service MetricsProvider, disableLegacyMetrics bool) *prometheus.Registry {
