...
const (
	...
	// LabelKeyArchiveStrategy is a label applied to workflow to indicate the archive strategy.
	LabelKeyArchiveStrategy = workflow.WorkflowFullName + "/archive-strategy"
