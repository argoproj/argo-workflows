...
func (woc *wfOperationCtx) processCompletedArtifactGCTask(ctx, artifactGCTask *wfv1.WorkflowArtifactGCTaskSet, strategy wfv1.ArtifactGCStrategy) error {
...
func (woc *wfOperationCtx) createArtifactGCTask(ctx context.Context, taskSet *wfv1.WorkflowArtifactGCTaskSet) error {
