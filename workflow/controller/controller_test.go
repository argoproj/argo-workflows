...
const helloWorldWf = "@testdata/controller/hello-world.yaml"

const fromExrpessingWf = "@testdata/controller/from-expressing.yaml"

const helloDaemonWf = "@testdata/controller/hello-daemon.yaml"

const testDefaultWf = "@testdata/controller/test-default.yaml"

const testDefaultVolumeClaimTemplateWf = "@testdata/controller/test-default-volume-claim-template.yaml"

const testDefaultWfTTL = "@testdata/controller/test-default-ttl.yaml"

const testLongArgumentsWorkflow = "@testdata/controller/test-long-arguments.yaml"
...
const wfWithSema = "@testdata/controller/workflow-with-semaphore.yaml"
