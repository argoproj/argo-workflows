...
func (woc *wfOperationCtx) createWorkflowPod(ctx context.Context, nodeName string, podName string, mainCtrs []apiv1.Container, tmpl *wfv1.Template, opts *createWorkflowPodOpts) (*apiv1.Pod, error) {
