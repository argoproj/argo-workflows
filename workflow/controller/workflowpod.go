...
func createArchiveLocationSecret(tmpl *wfv1.Template, volMap map[string]apiv1.Volume, uniqueKeyMap map[string]bool) {
	...
	} else if httpArtRepo := tmpl.ArchiveLocation.HTTP; httpArtRepo != nil {
		createSecretVal(volMap, httpArtRepo.BasicAuth.UsernameSecret, uniqueKeyMap)
		createSecretVal(volMap, httpArtRepo.BasicAuth.PasswordSecret, uniqueKeyMap)
		createSecretVal(volMap, httpArtRepo.ClientCert.ClientCertSecret, uniqueKeyMap)
		createSecretVal(volMap, httpArtRepo.ClientCert.ClientKeySecret, uniqueKeyMap)
		createSecretVal(volMap, httpArtRepo.OAuth2.ClientIDSecret, uniqueKeyMap)
		createSecretVal(volMap, httpArtRepo.OAuth2.ClientSecretSecret, uniqueKeyMap)
		createSecretVal(volMap, httpArtRepo.OAuth2.TokenURLSecret, uniqueKeyMap)
	}
}
...
func createSecretVolume(volMap map[string]apiv1.Volume, art wfv1.Artifact, keyMap map[string]bool) {
	if art.S3 != nil {
		...
		createSecretVal(volMap, art.HTTP.BasicAuth.UsernameSecret, keyMap)
		createSecretVal(volMap, art.HTTP.BasicAuth.PasswordSecret, keyMap)
		createSecretVal(volMap, art.HTTP.ClientCert.ClientCertSecret, keyMap)
		createSecretVal(volMap, art.HTTP.ClientCert.ClientKeySecret, keyMap)
		createSecretVal(volMap, art.HTTP.OAuth2.ClientIDSecret, keyMap)
		createSecretVal(volMap, art.HTTP.OAuth2.ClientSecretSecret, keyMap)
		createSecretVal(volMap, art.HTTP.OAuth2.TokenURLSecret, keyMap)
	}
}
