...
func (woc *wfOperationCtx) createWorkflowPod(ctx context.Context, nodeName string, mainCtrs []apiv1.Container, tmpl *wfv1.Template, opts *createWorkflowPodOpts) (*apiv1.Pod, error) {
	...
	pod := &apiv1.Pod{
		ObjectMeta: metav1.ObjectMeta{
			...
			Finalizers: []string{common.Finalizer}, // be aware that other finalizers might be added by https://kubernetes.io/docs/reference/access-authn-authz/admission-controllers/#mutatingadmissionwebhook
		},
		Spec: apiv1.PodSpec{
