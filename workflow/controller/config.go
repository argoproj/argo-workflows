...
func (wfc *WorkflowController) updateConfig(v interface{}) error {
	...
	wfc.session = nil
	wfc.artifactRepositories = artifactrepositories.New(wfc.kubeclientset[v1alpha1.DefaultClusterName], wfc.namespace, &wfc.Config.ArtifactRepository)
	...
	if persistence != nil {
		...
		session, tableName, err := sqldb.CreateDBSession(wfc.kubeclientset[v1alpha1.DefaultClusterName], wfc.namespace, persistence)
		if err != nil {
			return err
		}
