...
// failedQuota is a string used to check for errors during pod creation that are the result of a resource quota.
const failedQuota string = "failed quota"
