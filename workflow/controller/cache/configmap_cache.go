...
func (c *configMapCache) Save(ctx context.Context, key string, nodeId string, value *wfv1.Outputs) error {
	...
	if err != nil {
		...
		return fmt.Errorf("error creating cache entry: %w. Please check out this page for help: https://argo-workflows.readthedocs.io/en/release-3.5.2/memoization/#faqs", err)
	}
	return nil
}
