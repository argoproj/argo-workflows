...
func TestNewDurationEstimatorFactory(t *testing.T) {
...
metadata:
  name: my-archived-wftmpl-baseline`),
	...
	f := NewDurationEstimatorFactory(informer, hydratorfake.Always, wfArchive)
	t.Run("None", func(t *testing.T) {
		p, err := f.NewDurationEstimator(&wfv1.Workflow{})
