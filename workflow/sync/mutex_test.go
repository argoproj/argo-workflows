...
func TestMutexLock(t *testing.T) {
	...
	t.Run("WfLevelMutexAcquireAndRelease", func(t *testing.T) {
		...
		require.Equal(t, wf.Name, wf.Status.Synchronization.Mutex.Holding[0].Holder)
		...
		require.Equal(t, holderKey2, nextWorkflow)
		require.NotNil(t, wf.Status.Synchronization)
		require.Empty(t, wf.Status.Synchronization.Mutex.Holding)
		...
		require.Equal(t, wf2.Name, wf2.Status.Synchronization.Mutex.Holding[0].Holder)
...
func TestMutexTmplLevel(t *testing.T) {
	...
	t.Run("TemplateLevelAcquireAndRelease", func(t *testing.T) {
		...
		require.NotNil(t, wf.Status.Synchronization)
		require.NotNil(t, wf.Status.Synchronization.Mutex)
		require.Equal(t, "synchronization-tmpl-level-mutex-vjcdk-3941195474", wf.Status.Synchronization.Mutex.Holding[0].Holder)
		...
		require.NotNil(t, wf.Status.Synchronization)
		require.NotNil(t, wf.Status.Synchronization.Mutex)
		require.Equal(t, "synchronization-tmpl-level-mutex-vjcdk-2216915482", wf.Status.Synchronization.Mutex.Holding[0].Holder)

		require.NotEqual(t, "synchronization-tmpl-level-mutex-vjcdk-3941195474", wf.Status.Synchronization.Mutex.Holding[0].Holder)
		concurrenyMgr.Release(wf, "synchronization-tmpl-level-mutex-vjcdk-3941195474", tmpl.Synchronization)
		require.NotNil(t, wf.Status.Synchronization)
		require.NotNil(t, wf.Status.Synchronization.Mutex)
		require.NotEmpty(t, wf.Status.Synchronization.Mutex.Holding)
	})
}
