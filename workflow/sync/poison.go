...
func (p *poisonedLock) acquire(_ context.Context, _ string, _ *sqldb.SessionProxy) (bool, error) {
	return false, nil
}
...
func (p *poisonedLock) tryAcquire(_ context.Context, _ string, _ *sqldb.SessionProxy) (bool, string, error) {
