...
func (s *prioritySemaphore) acquire(_ context.Context, holderKey string, _ *transaction) (bool, error) {
...
func (s *prioritySemaphore) tryAcquire(ctx context.Context, holderKey string, tx *transaction) (bool, string, error) {
	logger := s.logger(ctx)
