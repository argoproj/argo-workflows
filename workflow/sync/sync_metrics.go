...
func (t *testMetricsRecorder) AddSemaphore(_ context.Context, name, _ string) {
	t.semaphoreAdds[name]++
}
func (t *testMetricsRecorder) RemoveSemaphore(_ context.Context, name, _ string) {
	t.semaphoreRemoves[name]++
}
