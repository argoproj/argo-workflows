...
func resetBoundaries(n *dagNode, resetFunc resetFn) (*dagNode, error) {
	...
	for {
		...
		if curr.parent != nil && isNonBoundaryParentNodeType(curr.parent.n.Type) {
...
func isNonBoundaryParentNodeType(nodeType wfv1.NodeType) bool {
	return nodeType == wfv1.NodeTypeStepGroup || nodeType == wfv1.NodeTypeRetry
}
