...
// GetMetrics provides a mock function with given fields: containerID
func (_m *ContainerRuntimeExecutor) GetMetrics(containerID string) (v1.ResourceList, error) {
	ret := _m.Called(containerID)

	var r0 v1.ResourceList
	if rf, ok := ret.Get(0).(func(string) v1.ResourceList); ok {
		r0 = rf(containerID)
	} else {
		if ret.Get(0) != nil {
