...
// Kill provides a mock function with given fields: ctx, containerIDs, terminationGracePeriodDuration
func (_m *ContainerRuntimeExecutor) Kill(ctx context.Context, containerIDs []string, terminationGracePeriodDuration time.Duration) error {
	ret := _m.Called(ctx, containerIDs, terminationGracePeriodDuration)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, time.Duration) error); ok {
		r0 = rf(ctx, containerIDs, terminationGracePeriodDuration)
	} else {
		r0 = ret.Error(0)
	}
