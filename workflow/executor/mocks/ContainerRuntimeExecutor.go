...
// Init provides a mock function with given fields: tmpl
func (_m *ContainerRuntimeExecutor) Init(tmpl v1alpha1.Template) error {
	ret := _m.Called(tmpl)

	var r0 error
	if rf, ok := ret.Get(0).(func(v1alpha1.Template) error); ok {
		r0 = rf(tmpl)
	} else {
		r0 = ret.Error(0)
	}
