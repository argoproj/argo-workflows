...
func (c *k8sAPIClient) KillContainer(container *corev1.ContainerStatus, sig syscall.Signal) error {
	return common.SignalContainer(c.config, c.namespace, c.podName, container.Name, sig)
}
