...
Check the [upgrading guide](https://argo-workflows.readthedocs.io/en/v3.5.2/upgrading/) and search for [existing issues on GitHub](https://github.com/argoproj/argo-workflows/issues).
