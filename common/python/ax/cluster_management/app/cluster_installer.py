...
from .options import ClusterInstallConfig, PlatformOnlyInstallConfig
...
class PlatformOnlyInstaller(ClusterOperationBase):
    def __init__(self, cfg):
        assert isinstance(cfg, PlatformOnlyInstallConfig)
        self._cfg = cfg
    ...
    def run(self):
        self._ci_installer.update_and_save_config(cluster_bucket=self._cfg.get_cluster_bucket(), bucket_endpoint=self._cfg.bucket_endpoint)
