...
class VersionInfo(object):
    ...
    """
    def __init__(self, major=None, minor=None, git_version=None, git_commit=None, git_tree_state=None, build_date=None, go_version=None, compiler=None, platform=None):
        """
