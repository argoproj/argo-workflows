...
class Apisstoragek8siov1beta1Api(object):
    """
    ...
    def watch_storage_class_with_http_info(self, name, **kwargs):
        ...
        resource_path = '/apis/storage.k8s.io/v1beta1/watch/storageclasses/{name}'.replace('{format}', 'json')
        path_params = {}
        if 'name' in params:
            path_params['name'] = params['name']
    ...
    def watch_storage_class_list_with_http_info(self, **kwargs):
        ...
        resource_path = '/apis/storage.k8s.io/v1beta1/watch/storageclasses'.replace('{format}', 'json')
        path_params = {}
