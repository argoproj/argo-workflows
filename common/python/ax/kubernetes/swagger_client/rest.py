...
# TODO: config it from outside after revising AX log level
# Because currently there are a lot of Argo components running under debug mode and we
# turn on every thing under "ax" to have level DEBUG. Since kubernetes swagger is also under
# ax, there are a lot of unnecessary things printed out from this client
