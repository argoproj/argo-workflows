...
type WorkflowAgent struct {
	...
	Status            WorkflowAgentStatus `json:"status" protobuf:"bytes,3,opt,name=status"`
}
...
type WorkflowAgentStatus struct {
	Nodes Nodes `json:"nodes,omitempty" protobuf:"bytes,1,rep,name=nodes,casttype=Nodes"`
}
