...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ClusterWorkflowSpecs) DeepCopyInto(out *ClusterWorkflowSpecs) {
	{
		in := &in
		*out = make(ClusterWorkflowSpecs, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterWorkflowSpecs.
func (in ClusterWorkflowSpecs) DeepCopy() ClusterWorkflowSpecs {
	if in == nil {
		return nil
	}
	out := new(ClusterWorkflowSpecs)
	in.DeepCopyInto(out)
	return *out
}
...
func (in *WorkflowSpec) DeepCopyInto(out *WorkflowSpec) {
	*out = *in
	...
	if in.ClusterWorkflowSpecs != nil {
		in, out := &in.ClusterWorkflowSpecs, &out.ClusterWorkflowSpecs
		*out = make(ClusterWorkflowSpecs, len(*in))
		copy(*out, *in)
	}
	return
