...
func (in *DAGTask) DeepCopyInto(out *DAGTask) {
	*out = *in
	...
	if in.ExitTemplate != nil {
		in, out := &in.ExitTemplate, &out.ExitTemplate
		*out = new(ExitTemplate)
		(*in).DeepCopyInto(*out)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExitTemplate) DeepCopyInto(out *ExitTemplate) {
	*out = *in
	in.Arguments.DeepCopyInto(&out.Arguments)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExitTemplate.
func (in *ExitTemplate) DeepCopy() *ExitTemplate {
	if in == nil {
		return nil
	}
	out := new(ExitTemplate)
