...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ArtifactStuff) DeepCopyInto(out *ArtifactStuff) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArtifactStuff.
func (in *ArtifactStuff) DeepCopy() *ArtifactStuff {
	if in == nil {
		return nil
	}
	out := new(ArtifactStuff)
	in.DeepCopyInto(out)
	return out
}
