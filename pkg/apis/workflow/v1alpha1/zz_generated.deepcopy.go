...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ArtifactGCStrategies) DeepCopyInto(out *ArtifactGCStrategies) {
	{
		in := &in
		*out = make(ArtifactGCStrategies, len(*in))
		copy(*out, *in)
		return
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ArtifactGCStrategies.
func (in ArtifactGCStrategies) DeepCopy() ArtifactGCStrategies {
	if in == nil {
		return nil
	}
	out := new(ArtifactGCStrategies)
	in.DeepCopyInto(out)
	return *out
}
