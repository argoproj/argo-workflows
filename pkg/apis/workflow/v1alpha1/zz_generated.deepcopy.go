...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in LabelsFrom) DeepCopyInto(out *LabelsFrom) {
	{
		in := &in
		*out = make(LabelsFrom, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LabelsFrom.
func (in LabelsFrom) DeepCopy() LabelsFrom {
	if in == nil {
		return nil
	}
	out := new(LabelsFrom)
