...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConcurrencyRef) DeepCopyInto(out *ConcurrencyRef) {
	*out = *in
	if in.Semaphore != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConcurrencyRef.
func (in *ConcurrencyRef) DeepCopy() *ConcurrencyRef {
	if in == nil {
		return nil
	}
	out := new(ConcurrencyRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SemaphoreStatus) DeepCopyInto(out *SemaphoreStatus) {
	*out = *in
	if in.Holding != nil {
		...
		*out = make(map[string]HolderNames, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.Waiting != nil {
		...
		*out = make(map[string]WaitingStatus, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
