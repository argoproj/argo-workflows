...
func (in *DAGTask) DeepCopyInto(out *DAGTask) {
	*out = *in
	...
	if in.WithItemsFrom != nil {
		in, out := &in.WithItemsFrom, &out.WithItemsFrom
		*out = new(WithItemsFrom)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WithItemsFrom) DeepCopyInto(out *WithItemsFrom) {
	*out = *in
	if in.ConfigMapKeyRef != nil {
		in, out := &in.ConfigMapKeyRef, &out.ConfigMapKeyRef
		*out = new(v1.ConfigMapKeySelector)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WithItemsFrom.
func (in *WithItemsFrom) DeepCopy() *WithItemsFrom {
	if in == nil {
		return nil
	}
	out := new(WithItemsFrom)
