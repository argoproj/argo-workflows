...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ConcurrencyLockStatus) DeepCopyInto(out *ConcurrencyLockStatus) {
	*out = *in
	if in.SemaphoreHolders != nil {
		in, out := &in.SemaphoreHolders, &out.SemaphoreHolders
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ConcurrencyLockStatus.
func (in *ConcurrencyLockStatus) DeepCopy() *ConcurrencyLockStatus {
	if in == nil {
		return nil
	}
	out := new(ConcurrencyLockStatus)
	in.DeepCopyInto(out)
	return out
}
...
func (in *WorkflowStatus) DeepCopyInto(out *WorkflowStatus) {
	*out = *in
	...
	if in.ConcurrencyLockStatus != nil {
		in, out := &in.ConcurrencyLockStatus, &out.ConcurrencyLockStatus
		*out = new(ConcurrencyLockStatus)
		(*in).DeepCopyInto(*out)
	}
	return
