...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RawValueFrom) DeepCopyInto(out *RawValueFrom) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RawValueFrom.
func (in *RawValueFrom) DeepCopy() *RawValueFrom {
	if in == nil {
		return nil
	}
	out := new(RawValueFrom)
	in.DeepCopyInto(out)
	return out
}
