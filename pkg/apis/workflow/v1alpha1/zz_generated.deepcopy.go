...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExitHook) DeepCopyInto(out *ExitHook) {
	*out = *in
	in.Arguments.DeepCopyInto(&out.Arguments)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExitHook.
func (in *ExitHook) DeepCopy() *ExitHook {
	if in == nil {
		return nil
	}
	out := new(ExitHook)
