...
func (in *LifecycleRule) DeepCopyInto(out *LifecycleRule) {
	*out = *in
	if in.MarkInfrequentAccessAfterDays != nil {
		in, out := &in.MarkInfrequentAccessAfterDays, &out.MarkInfrequentAccessAfterDays
		*out = new(int32)
		**out = **in
	}
	if in.MarkDeletionAfterDays != nil {
		in, out := &in.MarkDeletionAfterDays, &out.MarkDeletionAfterDays
		*out = new(int32)
		**out = **in
	}
	return
