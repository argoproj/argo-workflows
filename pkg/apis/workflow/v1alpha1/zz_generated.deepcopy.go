...
func (in *TTLStrategy) DeepCopyInto(out *TTLStrategy) {
	*out = *in
<<<<<<< HEAD
	if in.SecondsAfterCompleted != nil {
		in, out := &in.SecondsAfterCompleted, &out.SecondsAfterCompleted
=======
	if in.SecondsAfterCompletion != nil {
		in, out := &in.SecondsAfterCompletion, &out.SecondsAfterCompletion
>>>>>>> ef1bd3a32c434c565defc7b325463e8d831262f2
		*out = new(int32)
		**out = **in
	}
...
<<<<<<< HEAD
	if in.SecondsAfterFailed != nil {
		in, out := &in.SecondsAfterFailed, &out.SecondsAfterFailed
=======
