...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EmitMetrics) DeepCopyInto(out *EmitMetrics) {
	*out = *in
	if in.Metrics != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EmitMetrics.
func (in *EmitMetrics) DeepCopy() *EmitMetrics {
	if in == nil {
		return nil
	}
	out := new(EmitMetrics)
