...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventConsumerTemplate) DeepCopyInto(out *EventConsumerTemplate) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventConsumerTemplate.
func (in *EventConsumerTemplate) DeepCopy() *EventConsumerTemplate {
	if in == nil {
		return nil
	}
	out := new(EventConsumerTemplate)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EventProducerTemplate) DeepCopyInto(out *EventProducerTemplate) {
	*out = *in
	if in.HTTP != nil {
		in, out := &in.HTTP, &out.HTTP
		*out = new(HTTPArtifact)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EventProducerTemplate.
func (in *EventProducerTemplate) DeepCopy() *EventProducerTemplate {
	if in == nil {
		return nil
	}
	out := new(EventProducerTemplate)
	in.DeepCopyInto(out)
	return out
}
...
func (in *Template) DeepCopyInto(out *Template) {
	*out = *in
	...
	if in.EventConsumer != nil {
		in, out := &in.EventConsumer, &out.EventConsumer
		*out = new(EventConsumerTemplate)
		**out = **in
	}
	if in.EventProducer != nil {
		in, out := &in.EventProducer, &out.EventProducer
		*out = new(EventProducerTemplate)
		(*in).DeepCopyInto(*out)
	}
	if in.Resource != nil {
