...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CronWorkflowOptions) DeepCopyInto(out *CronWorkflowOptions) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CronWorkflowOptions.
func (in *CronWorkflowOptions) DeepCopy() *CronWorkflowOptions {
	if in == nil {
		return nil
	}
	out := new(CronWorkflowOptions)
	in.DeepCopyInto(out)
	return out
}
