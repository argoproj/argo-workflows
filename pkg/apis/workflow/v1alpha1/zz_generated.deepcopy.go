...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AutoResume) DeepCopyInto(out *AutoResume) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AutoResume.
func (in *AutoResume) DeepCopy() *AutoResume {
	if in == nil {
		return nil
	}
	out := new(AutoResume)
