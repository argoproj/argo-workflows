...
func (in *DAGTask) DeepCopyInto(out *DAGTask) {
	*out = *in
	...
	if in.WhenBindings != nil {
		in, out := &in.WhenBindings, &out.WhenBindings
		*out = make([]WhenBinding, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WhenBinding) DeepCopyInto(out *WhenBinding) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WhenBinding.
func (in *WhenBinding) DeepCopy() *WhenBinding {
	if in == nil {
		return nil
	}
	out := new(WhenBinding)
