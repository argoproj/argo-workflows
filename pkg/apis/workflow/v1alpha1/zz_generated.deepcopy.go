...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Depends) DeepCopyInto(out *Depends) {
	*out = *in
	if in.And != nil {
		in, out := &in.And, &out.And
		*out = make([]Depends, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Depends.
func (in *Depends) DeepCopy() *Depends {
	if in == nil {
		return nil
	}
	out := new(Depends)
