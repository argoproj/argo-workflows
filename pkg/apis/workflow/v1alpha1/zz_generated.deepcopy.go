...
func (in *NodeStatus) DeepCopyInto(out *NodeStatus) {
	*out = *in
	...
	if in.UsageIndicator != nil {
		in, out := &in.UsageIndicator, &out.UsageIndicator
		*out = make(UsageIndicator, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in UsageIndicator) DeepCopyInto(out *UsageIndicator) {
	{
		in := &in
		*out = make(UsageIndicator, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UsageIndicator.
func (in UsageIndicator) DeepCopy() UsageIndicator {
	if in == nil {
		return nil
	}
	out := new(UsageIndicator)
	in.DeepCopyInto(out)
	return *out
}
