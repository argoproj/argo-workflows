...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.ArtifactRepository":            schema_pkg_apis_workflow_v1alpha1_ArtifactRepository(ref),
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.ArtifactoryArtifactRepository": schema_pkg_apis_workflow_v1alpha1_ArtifactoryArtifactRepository(ref),
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.GCSArtifactRepository":         schema_pkg_apis_workflow_v1alpha1_GCSArtifactRepository(ref),
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.HDFSArtifactRepository":        schema_pkg_apis_workflow_v1alpha1_HDFSArtifactRepository(ref),
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.OSSArtifactRepository":         schema_pkg_apis_workflow_v1alpha1_OSSArtifactRepository(ref),
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.S3ArtifactRepository":          schema_pkg_apis_workflow_v1alpha1_S3ArtifactRepository(ref),
...
func schema_pkg_apis_workflow_v1alpha1_ArtifactRepository(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Description: "ArtifactRepository represents a artifact repository in which a controller will store its artifacts",
				Type:        []string{"object"},
				Properties: map[string]spec.Schema{
					"archiveLogs": {
						SchemaProps: spec.SchemaProps{
					...
					"s3": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.S3ArtifactRepository"),
						},
					},
					"artifactory": {
						SchemaProps: spec.SchemaProps{
							Description: "Artifactory stores artifacts to JFrog Artifactory",
							Ref:         ref("github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.ArtifactoryArtifactRepository"),
						},
					},
					"hdfs": {
						SchemaProps: spec.SchemaProps{
							Description: "HDFS stores artifacts in HDFS",
							Ref:         ref("github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.HDFSArtifactRepository"),
						},
					},
					"oss": {
						SchemaProps: spec.SchemaProps{
							Description: "OSS stores artifact in a OSS-compliant object store",
							Ref:         ref("github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.OSSArtifactRepository"),
						},
					},
					"gcs": {
						SchemaProps: spec.SchemaProps{
							Description: "GCS stores artifact in a GCS object store",
							Ref:         ref("github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.GCSArtifactRepository"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.ArtifactoryArtifactRepository", "github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.GCSArtifactRepository", "github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.HDFSArtifactRepository", "github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.OSSArtifactRepository", "github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.S3ArtifactRepository"},
	}
}
