...
func schema_pkg_apis_workflow_v1alpha1_NodeStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/argoproj/argo/v3/pkg/apis/workflow/v1alpha1.Inputs", "github.com/argoproj/argo/v3/pkg/apis/workflow/v1alpha1.MemoizationStatus", "github.com/argoproj/argo/v3/pkg/apis/workflow/v1alpha1.Outputs", "github.com/argoproj/argo/v3/pkg/apis/workflow/v1alpha1.TemplateRef", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
