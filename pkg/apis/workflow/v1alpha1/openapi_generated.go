...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.Script": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					...
					Required: []string{"image", "command", "source"},
				},
			},
			Dependencies: []string{},
		},
		...
		"github.com/argoproj/argo/pkg/apis/workflow/v1alpha1.SidecarOptions": {
			Schema: spec.Schema{
				SchemaProps: spec.SchemaProps{
					Description: "SidecarOptions provide a way to customize the behavior of a sidecar and how it affects the main container.",
					Properties: map[string]spec.Schema{
						"mirrorVolumeMounts": {
							SchemaProps: spec.SchemaProps{
								Description: "MirrorVolumeMounts will mount the same volumes specified in the main container to the sidecar (including artifacts), at the same mountPaths. This enables dind daemon to partially see the same filesystem as the main container in order to use features such as docker volume binding",
