...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.Job":                           schema_pkg_apis_workflow_v1alpha1_Job(ref),
		"github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.JobStep":                       schema_pkg_apis_workflow_v1alpha1_JobStep(ref),
...
func schema_pkg_apis_workflow_v1alpha1_Job(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.JobStep"),
									},
								},
							},
						},
				...
				Required: []string{"image", "steps"},
			},
		},
		Dependencies: []string{
			"github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.JobStep"},
	}
}

func schema_pkg_apis_workflow_v1alpha1_JobStep(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_pkg_apis_workflow_v1alpha1_NodeResult(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.Outputs", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"job": {
						SchemaProps: spec.SchemaProps{
							Description: "Job is a job template",
							Ref:         ref("github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.Job"),
						},
					},
					"volumes": {
						VendorExtensible: spec.VendorExtensible{
...
func schema_pkg_apis_workflow_v1alpha1_WorkflowTaskResult(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		...
		Dependencies: []string{
			"github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.Outputs", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
