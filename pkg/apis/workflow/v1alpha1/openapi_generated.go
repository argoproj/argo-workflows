...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		...
		"github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.PluginTemplate":              schema_pkg_apis_workflow_v1alpha1_PluginTemplate(ref),
		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"plugin": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/argoproj/argo-workflows/v3/pkg/apis/workflow/v1alpha1.PluginTemplate"),
						},
					},
					"volumes": {
						VendorExtensible: spec.VendorExtensible{
