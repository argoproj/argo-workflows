		...
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					"strategy": {
						SchemaProps: spec.SchemaProps{
							Description: "Strategy is the strategy to use. \"\" - do nothing WorkflowCompletion - delete the artifact on completion of the workflow WorkflowDeletion - delete the artifact when the workflow is deleted",
							Type:        []string{"string"},
							Format:      "",
						},
					},
