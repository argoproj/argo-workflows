...
func TestArtifactLocation_Get(t *testing.T) {
	...
	assert.Nil(t, v)
	assert.EqualError(t, err, "You need to configure artifact storage. More information on how to do this can be found in the docs: https://argo-workflows.readthedocs.io/en/v3.5.2/configure-artifact-repository/")
