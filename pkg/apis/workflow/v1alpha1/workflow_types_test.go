...
func TestArtifactRepositoryRef_GetNamespaceOr(t *testing.T) {
	var r *ArtifactRepositoryRef
	assert.Equal(t, "or-ns", r.GetNamespaceOr("or-ns"))
	assert.Equal(t, "or-ns", (&ArtifactRepositoryRef{}).GetNamespaceOr("or-ns"))
