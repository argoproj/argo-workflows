...
type SuspendTemplate struct {
	// ResumeAfterSeconds is the seconds to wait before resuming a template
	ResumeAfterSeconds *int32 `json:"resumeAfterSeconds,omitempty" protobuf:"bytes,1,opt,name=resumeAfterSeconds"`
}
