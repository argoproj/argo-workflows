...
type ArtifactGCTaskSet struct {
	metav1.TypeMeta   `json:",inline"`
	metav1.ObjectMeta `json:"metadata" protobuf:"bytes,1,opt,name=metadata"`
	Spec              ArtifactGCTaskSetSpec   `json:"spec" protobuf:"bytes,2,opt,name=spec"`
	Status            ArtifactGCTaskSetStatus `json:"status,omitempty" protobuf:"bytes,3,opt,name=status"`
}

type ArtifactGCTaskSetSpec struct {
...
type ArtifactGCTaskSetStatus struct {
