	...
	for !in.IsDelim('}') {
		...
		case "valueFrom":
			if in.IsNull() {
				...
				easyjsonDc809a28DecodeGithubComArgoprojArgoPkgApisWorkflowV1alpha120(in, out.ValueFrom)
			}
		case "globalName":
			out.GlobalName = string(in.String())
		default:
...
func easyjsonDc809a28EncodeGithubComArgoprojArgoPkgApisWorkflowV1alpha16(out *jwriter.Writer, in Parameter) {
	...
	if in.ValueFrom != nil {
		...
		out.RawString(prefix)
		easyjsonDc809a28EncodeGithubComArgoprojArgoPkgApisWorkflowV1alpha120(out, *in.ValueFrom)
	}
	if in.GlobalName != "" {
		const prefix string = ",\"globalName\":"
		out.RawString(prefix)
...
func easyjsonDc809a28DecodeGithubComArgoprojArgoPkgApisWorkflowV1alpha120(in *jlexer.Lexer, out *ValueFrom) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "supplied":
			if in.IsNull() {
				...
				easyjsonDc809a28DecodeGithubComArgoprojArgoPkgApisWorkflowV1alpha121(in, out.Supplied)
			}
		case "default":
			if in.IsNull() {
				in.Skip()
...
func easyjsonDc809a28EncodeGithubComArgoprojArgoPkgApisWorkflowV1alpha120(out *jwriter.Writer, in ValueFrom) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Path != "" {
	...
	if in.Supplied != nil {
		...
		easyjsonDc809a28EncodeGithubComArgoprojArgoPkgApisWorkflowV1alpha121(out, *in.Supplied)
	}
	if in.Default != nil {
		const prefix string = ",\"default\":"
		if first {
...
func easyjsonDc809a28DecodeGithubComArgoprojArgoPkgApisWorkflowV1alpha121(in *jlexer.Lexer, out *SuppliedValueFrom) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDc809a28EncodeGithubComArgoprojArgoPkgApisWorkflowV1alpha121(out *jwriter.Writer, in SuppliedValueFrom) {
	out.RawByte('{')
	first := true
	_ = first
	out.RawByte('}')
...
func easyjsonDc809a28DecodeGithubComArgoprojArgoPkgApisWorkflowV1alpha122(in *jlexer.Lexer, out *Event) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonDc809a28EncodeGithubComArgoprojArgoPkgApisWorkflowV1alpha122(out *jwriter.Writer, in Event) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Event) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDc809a28EncodeGithubComArgoprojArgoPkgApisWorkflowV1alpha122(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Event) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjsonDc809a28DecodeGithubComArgoprojArgoPkgApisWorkflowV1alpha122(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Event) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDc809a28DecodeGithubComArgoprojArgoPkgApisWorkflowV1alpha122(l, v)
}
