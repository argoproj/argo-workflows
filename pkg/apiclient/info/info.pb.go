...
type GetSettingsResponse struct {
	UiCssURL             string   `protobuf:"bytes,1,opt,name=uiCssURL,proto3" json:"uiCssURL,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *GetSettingsResponse) GetUiCssURL() string {
	if m != nil {
		return m.UiCssURL
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*GetSettingsRequest)(nil), "info.GetSettingsRequest")
	proto.RegisterType((*GetSettingsResponse)(nil), "info.GetSettingsResponse")
}
...
var fileDescriptor_96940c93018255fa = []byte{
	...
	,
}
...
func (c *infoServiceClient) GetSettings(ctx context.Context, in *GetSettingsRequest, opts ...grpc.CallOption) (*GetSettingsResponse, error) {
	out := new(GetSettingsResponse)
	err := c.cc.Invoke(ctx, "/info.InfoService/GetSettings", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedInfoServiceServer) GetSettings(ctx context.Context, req *GetSettingsRequest) (*GetSettingsResponse, error) {
...
func _InfoService_GetSettings_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSettingsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InfoServiceServer).GetSettings(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/info.InfoService/GetSettings",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InfoServiceServer).GetSettings(ctx, req.(*GetSettingsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _InfoService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _InfoService_GetSettings_Handler,
		},
	},
...
func (m *GetSettingsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.UiCssURL) > 0 {
		...
		i = encodeVarintInfo(dAtA, i, uint64(len(m.UiCssURL)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
