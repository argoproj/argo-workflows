...
type WorkflowListRequest struct {
	...
	NamePattern string          `protobuf:"bytes,3,opt,name=namePattern,proto3" json:"namePattern,omitempty"`
	ListOptions *v1.ListOptions `protobuf:"bytes,4,opt,name=listOptions,proto3" json:"listOptions,omitempty"`
...
func (m *WorkflowListRequest) GetNamePrefix() string {
	if m != nil {
		return m.NamePrefix
	}
	return ""
...
func (m *WorkflowListRequest) GetNamePattern() string {
	if m != nil {
...
var fileDescriptor_1f6bb75f9e833cb6 = []byte{
	...
	,
}
...
func (m *WorkflowListRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NamePattern) > 0 {
		...
		i = encodeVarintWorkflow(dAtA, i, uint64(len(m.NamePattern)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.NamePrefix) > 0 {
		...
		i = encodeVarintWorkflow(dAtA, i, uint64(len(m.NamePrefix)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.Namespace) > 0 {
