...
func (m *WorkflowGetRequest) GetUid() string {
	if m != nil {
		return m.Uid
	}
	return ""
...
type WorkflowListRequest struct {
	...
	Archived             []bool   `protobuf:"varint,7,rep,packed,name=archived,proto3" json:"archived,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *WorkflowListRequest) GetArchived() []bool {
	if m != nil {
		return m.Archived
	}
	return nil
...
var fileDescriptor_1f6bb75f9e833cb6 = []byte{
	...
	,
}
...
func (m *WorkflowListRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Archived) > 0 {
		for iNdEx := len(m.Archived) - 1; iNdEx >= 0; iNdEx-- {
			i--
			if m.Archived[iNdEx] {
				dAtA[i] = 1
			} else {
		...
		i = encodeVarintWorkflow(dAtA, i, uint64(len(m.Archived)))
		i--
		dAtA[i] = 0x3a
	}
...
func (m *WorkflowListRequest) Size() (n int) {
	...
	if len(m.Archived) > 0 {
		n += 1 + sovWorkflow(uint64(len(m.Archived))) + len(m.Archived)*1
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 7:
			if wireType == 0 {
				...
				m.Archived = append(m.Archived, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.Archived) == 0 {
					m.Archived = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
