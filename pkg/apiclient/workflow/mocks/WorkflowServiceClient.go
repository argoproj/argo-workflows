...
// ListWorkflowsV2 provides a mock function with given fields: ctx, in, opts
func (_m *WorkflowServiceClient) ListWorkflowsV2(ctx context.Context, in *workflow.WorkflowListRequest, opts ...grpc.CallOption) (*v1alpha1.WorkflowList, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
