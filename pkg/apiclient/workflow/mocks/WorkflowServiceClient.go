...
func (_m *WorkflowServiceClient) SetNode(ctx context.Context, in *workflow.SetNodeRequest, opts ...grpc.CallOption) (*workflow.SetNodeResponse, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *workflow.SetNodeResponse
	if rf, ok := ret.Get(0).(func(context.Context, *workflow.SetNodeRequest, ...grpc.CallOption) *workflow.SetNodeResponse); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*workflow.SetNodeResponse)
		}
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *workflow.SetNodeRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
