...
func (c argoKubeWorkflowServiceClient) SubmitFromResource(ctx context.Context, req *workflowpkg.WorkflowSubmitRequest, opts ...grpc.CallOption) (*v1alpha1.Workflow, error) {
