...
func (c argoKubeWorkflowServiceClient) SubmitFromResource(ctx context.Context, req *workflowpkg.WorkflowSubmitFromRequest, opts ...grpc.CallOption) (*v1alpha1.Workflow, error) {
	return c.delegate.SubmitFromResource(ctx, req)
}
