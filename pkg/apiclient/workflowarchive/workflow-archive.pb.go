...
func (m *ListArchivedWorkflowsRequest) GetCluster() string {
	if m != nil {
		return m.Cluster
	}
	return ""
...
func (m *GetArchivedWorkflowRequest) GetCluster() string {
	if m != nil {
		return m.Cluster
	}
	return ""
...
func (m *DeleteArchivedWorkflowRequest) GetCluster() string {
	if m != nil {
		return m.Cluster
	}
	return ""
...
func (m *RetryArchivedWorkflowRequest) GetCluster() string {
	if m != nil {
		return m.Cluster
	}
	return ""
...
func (m *ResubmitArchivedWorkflowRequest) GetCluster() string {
	if m != nil {
		return m.Cluster
	}
	return ""
...
var fileDescriptor_95ca9a2d33e8bb19 = []byte{
	...
	,
}
...
func (m *ListArchivedWorkflowsRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Cluster) > 0 {
		...
		i = encodeVarintWorkflowArchive(dAtA, i, uint64(len(m.Cluster)))
		i--
		dAtA[i] = 0x1a
	}
