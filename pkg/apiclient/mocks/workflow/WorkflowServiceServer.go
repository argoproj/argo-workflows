...
// SetWorkflow provides a mock function with given fields: _a0, _a1
func (_m *WorkflowServiceServer) SetWorkflow(_a0 context.Context, _a1 *workflow.WorkflowSetRequest) (*v1alpha1.Workflow, error) {
	ret := _m.Called(_a0, _a1)

	var r0 *v1alpha1.Workflow
	if rf, ok := ret.Get(0).(func(context.Context, *workflow.WorkflowSetRequest) *v1alpha1.Workflow); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.Workflow)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *workflow.WorkflowSetRequest) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
