...
// SubmitFrom provides a mock function with given fields: ctx, in, opts
func (_m *WorkflowServiceClient) SubmitFrom(ctx context.Context, in *workflow.WorkflowSubmitFromRequest, opts ...grpc.CallOption) (*v1alpha1.Workflow, error) {
	_va := make([]interface{}, len(opts))
	for _i := range opts {
		_va[_i] = opts[_i]
	}
	...
	var r0 *v1alpha1.Workflow
	if rf, ok := ret.Get(0).(func(context.Context, *workflow.WorkflowSubmitFromRequest, ...grpc.CallOption) *v1alpha1.Workflow); ok {
		r0 = rf(ctx, in, opts...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*v1alpha1.Workflow)
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, *workflow.WorkflowSubmitFromRequest, ...grpc.CallOption) error); ok {
		r1 = rf(ctx, in, opts...)
	} else {
		r1 = ret.Error(1)
	}
