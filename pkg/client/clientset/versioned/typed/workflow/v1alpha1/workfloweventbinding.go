...
type WorkflowEventBindingInterface interface {
	Create(context.Context, *v1alpha1.WorkflowEventBinding) (*v1alpha1.WorkflowEventBinding, error)
	Update(context.Context, *v1alpha1.WorkflowEventBinding) (*v1alpha1.WorkflowEventBinding, error)
	Delete(ctx context.Context, name string, options *v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(ctx context.Context, name string, options v1.GetOptions) (*v1alpha1.WorkflowEventBinding, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.WorkflowEventBindingList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.WorkflowEventBinding, err error)
...
func (c *workflowEventBindings) Create(ctx context.Context, workflowEventBinding *v1alpha1.WorkflowEventBinding) (result *v1alpha1.WorkflowEventBinding, err error) {
	result = &v1alpha1.WorkflowEventBinding{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("workfloweventbindings").
...
func (c *workflowEventBindings) Update(ctx context.Context, workflowEventBinding *v1alpha1.WorkflowEventBinding) (result *v1alpha1.WorkflowEventBinding, err error) {
	result = &v1alpha1.WorkflowEventBinding{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workfloweventbindings").
...
func (c *workflowEventBindings) Delete(ctx context.Context, name string, options *v1.DeleteOptions) error {
...
func (c *workflowEventBindings) DeleteCollection(ctx context.Context, options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	var timeout time.Duration
...
func (c *workflowEventBindings) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.WorkflowEventBinding, err error) {
	result = &v1alpha1.WorkflowEventBinding{}
