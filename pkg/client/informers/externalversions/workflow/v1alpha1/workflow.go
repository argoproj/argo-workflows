...
import (
	...
	workflow_v1alpha1 "github.com/argoproj/argo/pkg/apis/workflow/v1alpha1"
...
func (f *workflowInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&workflow_v1alpha1.Workflow{}, f.defaultInformer)
}
