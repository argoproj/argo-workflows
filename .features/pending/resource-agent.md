...
The resource agent runs under a dedicated `<workflow service account>-resource-agent` service account and requires permissions to create and watch the resource kinds used by the workflow.
See `docs/resource-template.md` for configuration details, required RBAC, and examples.
