Description: Support for rootPath parameter to enable subpath deployments without requiring reverse proxy rewrites, ensuring consistent path configuration across UI and API.
Author: [jiwlee97](https://github.com/jiwlee97)
Issue: [#7767](https://github.com/argoproj/argo-workflows/issues/7767)
