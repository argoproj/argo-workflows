...
The feature will allow setting the number of threads and part size with env var WAIT_CONTAINER_S3_UPLOAD_THREADS and WAIT_CONTAINER_S3_UPLOAD_PART_SIZE_MIB.
