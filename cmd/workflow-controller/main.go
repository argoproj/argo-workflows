...
func NewRootCommand() *cobra.Command {
	...
	command.Flags().BoolVar(&forceNamespaceIsolation, "force-name-isolation", os.Getenv("FORCE_NAMESPACE_ISOLATION") == "true", "Only watch own namespace (overrides value in configmap)")
