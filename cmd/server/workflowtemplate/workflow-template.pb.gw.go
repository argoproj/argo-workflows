...
func request_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0(ctx context.Context, marshaler runtime.Marshaler, client WorkflowTemplateServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq WorkflowTemplateSpecUpdateRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdateWorkflowTemplateSpec(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0(ctx context.Context, marshaler runtime.Marshaler, server WorkflowTemplateServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq WorkflowTemplateSpecUpdateRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdateWorkflowTemplateSpec(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterWorkflowTemplateServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server WorkflowTemplateServiceServer) error {
	...
	mux.Handle("PUT", pattern_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		rctx, err := runtime.AnnotateIncomingContext(ctx, mux, req)
		...
		resp, md, err := local_request_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0(rctx, inboundMarshaler, server, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterWorkflowTemplateServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client WorkflowTemplateServiceClient) error {
	...
	mux.Handle("PUT", pattern_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	forward_WorkflowTemplateService_UpdateWorkflowTemplateSpec_0 = runtime.ForwardResponseMessage
