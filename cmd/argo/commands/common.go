...
func GetWFApiServerGRPCClient(conn *grpc.ClientConn, cmd *cobra.Command) (wfApiServer.WorkflowServiceClient, context.Context) {
	return wfApiServer.NewWorkflowServiceClient(conn), client.GetContext(cmd)
}
