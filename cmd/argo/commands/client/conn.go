...
func AddAPIClientFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().BoolVar(&argoServerOpts.HTTP, "argo-http1", os.Getenv("ARGO_HTTP1") == "true", "If true, use the HTTP client. Defaults to the ARGO_HTTP1 environment variable.")
