...
See %s`, help.ArgoServer),
	...
	command.Flags().IntVar(&apiRateLimit, "api-rate-limit", 1000, "Set limit for api ratelimiter")
	command.Flags().IntVar(&apiRateBurst, "api-rate-burst", 100, "Set burst for api ratelimiter")
