...
var VerifyEmailSubject = "Argo Email Confirmation"
...
<p>Click this link to confirm your account and start using Argo:</p>
...
var ResetPasswordSubject = "Argo Password Reset"
...
var UserOnboardSubject = "Welcome to Argo"
...
<p>Build and run containerized apps NOW in the Argo Playground - an interactive demo environment.</p>
<p>
<!--[if mso]>
  <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{.SignupURL}}" style="height:40px;v-text-anchor:middle;width:300px;" arcsize="125%" strokecolor="#00BDCE" fillcolor="#7fdee6">
    <w:anchorlock/>
    <center style="color:#333;font-family:arial;font-size:14px;font-weight:bold;">Get Started with Argo Playground</center>
  </v:roundrect>
