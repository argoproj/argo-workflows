...
func migrate(ctx context.Context, sessionProxy *sqldb.SessionProxy, config *Config) (err error) {
	return sqldb.Migrate(ctx, sessionProxy.Session(), sessionProxy.DBType(), versionTable, []sqldb.Change{
