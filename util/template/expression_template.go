...
func expressionReplaceStrict(w io.Writer, expression string, env map[string]any, strictRegex *regexp.Regexp) (int, error) {
...
func expressionReplaceCore(w io.Writer, expression string, env map[string]interface{}, allowUnresolved bool) (int, error) {
