...
func TestUpdator(t *testing.T) {
	wf := &wfv1.Workflow{
		Status: wfv1.WorkflowStatus{
			Nodes: wfv1.Nodes{
				"my-wf-pod-1": wfv1.NodeStatus{Phase: wfv1.NodeSucceeded, ResourcesDuration: wfv1.ResourcesDuration{"my-resource": 1}},
				"my-wf-pod-2": wfv1.NodeStatus{Phase: wfv1.NodeSucceeded, ResourcesDuration: wfv1.ResourcesDuration{"my-resource": 2}},
				"my-wf":       wfv1.NodeStatus{Phase: wfv1.NodeSucceeded, Children: []string{"my-wf-pod-1", "my-wf-pod-2"}},
			},
		},
	}
	u := NewUpdator(wf)
