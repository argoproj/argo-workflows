...
const (
	...
	AttribMutexName              string = `name`
	AttribMutexNamespace         string = `mutex_namespace`
	...
	AttribSemaphoreConfigMapName string = `configmap_name`
	AttribSemaphoreName          string = `name`
	AttribSemaphoreNamespace     string = `namespace`
